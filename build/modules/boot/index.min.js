var fl=Object.create;var Vc=Object.defineProperty;var Rl=Object.getOwnPropertyDescriptor;var vl=Object.getOwnPropertyNames;var Ll=Object.getPrototypeOf,xl=Object.prototype.hasOwnProperty;var N=(t,c)=>()=>(c||t((c={exports:{}}).exports,c),c.exports),Nc=(t,c)=>{for(var e in c)Vc(t,e,{get:c[e],enumerable:!0})},Yl=(t,c,e,o)=>{if(c&&typeof c=="object"||typeof c=="function")for(let a of vl(c))!xl.call(t,a)&&a!==e&&Vc(t,a,{get:()=>c[a],enumerable:!(o=Rl(c,a))||o.enumerable});return t};var Z=(t,c,e)=>(e=t!=null?fl(Ll(t)):{},Yl(c||!t||!t.__esModule?Vc(e,"default",{value:t,enumerable:!0}):e,t));var mt=N((Hr,$o)=>{$o.exports=window.wp.element});var Xt=N((Cr,ta)=>{ta.exports=window.wp.data});var y=N((_d,wa)=>{wa.exports=window.ReactJSXRuntime});var U=N((Pd,Ha)=>{Ha.exports=window.React});var Na=N(Va=>{"use strict";var ee=U();function Xs(t,c){return t===c&&(t!==0||1/t===1/c)||t!==t&&c!==c}var hs=typeof Object.is=="function"?Object.is:Xs,Ws=ee.useState,ys=ee.useEffect,Is=ee.useLayoutEffect,Bs=ee.useDebugValue;function fs(t,c){var e=c(),o=Ws({inst:{value:e,getSnapshot:c}}),a=o[0].inst,i=o[1];return Is(function(){a.value=e,a.getSnapshot=c,eo(a)&&i({inst:a})},[t,e,c]),ys(function(){return eo(a)&&i({inst:a}),t(function(){eo(a)&&i({inst:a})})},[t]),Bs(e),e}function eo(t){var c=t.getSnapshot;t=t.value;try{var e=c();return!hs(t,e)}catch{return!0}}function Rs(t,c){return c()}var vs=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?Rs:fs;Va.useSyncExternalStore=ee.useSyncExternalStore!==void 0?ee.useSyncExternalStore:vs});var Qa=N((cn,Ja)=>{"use strict";Ja.exports=Na()});var Ma=N(ka=>{"use strict";var cc=U(),Ls=Qa();function xs(t,c){return t===c&&(t!==0||1/t===1/c)||t!==t&&c!==c}var Ys=typeof Object.is=="function"?Object.is:xs,Fs=Ls.useSyncExternalStore,ws=cc.useRef,Hs=cc.useEffect,Cs=cc.useMemo,Vs=cc.useDebugValue;ka.useSyncExternalStoreWithSelector=function(t,c,e,o,a){var i=ws(null);if(i.current===null){var l={hasValue:!1,value:null};i.current=l}else l=i.current;i=Cs(function(){function s(m){if(!n){if(n=!0,d=m,m=o(m),a!==void 0&&l.hasValue){var G=l.value;if(a(G,m))return b=G}return b=m}if(G=b,Ys(d,m))return G;var p=o(m);return a!==void 0&&a(G,p)?(d=m,G):(d=m,b=p)}var n=!1,d,b,u=e===void 0?null:e;return[function(){return s(c())},u===null?void 0:function(){return s(u())}]},[c,e,o,a]);var r=Fs(t,i[0],i[1]);return Hs(function(){l.hasValue=!0,l.value=r},[r]),Vs(r),r}});var za=N((an,Ua)=>{"use strict";Ua.exports=Ma()});var Pa=N((wn,_a)=>{_a.exports=window.ReactDOM});var kt=N((yu,ui)=>{ui.exports=window.wp.i18n});var pt=N((Ru,Xi)=>{Xi.exports=window.wp.components});var ho=N((Cu,Wi)=>{Wi.exports=window.wp.commands});var Ii=N((Vu,yi)=>{yi.exports=window.wp.theme});var Wo=N((Nu,Bi)=>{Bi.exports=window.wp.coreData});var Ri=N((Ju,fi)=>{fi.exports=window.wp.htmlEntities});var gt=N((ku,vi)=>{vi.exports=window.wp.primitives});var xi=N((om,Li)=>{Li.exports=window.wp.keycodes});var Fi=N((am,Yi)=>{Yi.exports=window.wp.url});var Uo=N((xm,Pi)=>{Pi.exports=window.wp.compose});var dl=N((qm,rl)=>{rl.exports=window.wp.privateApis});var wc=Z(mt()),ze=Z(Xt());var Te=new WeakMap,ea=new WeakMap,me={current:[]},Jc=!1,ue=0,be=new Set,je=new Map;function ca(t){for(let c of t){if(me.current.includes(c))continue;me.current.push(c),c.recompute();let e=ea.get(c);if(e)for(let o of e){let a=Te.get(o);a?.length&&ca(a)}}}function Fl(t){let c={prevVal:t.prevState,currentVal:t.state};for(let e of t.listeners)e(c)}function wl(t){let c={prevVal:t.prevState,currentVal:t.state};for(let e of t.listeners)e(c)}function Ee(t){if(ue>0&&!je.has(t)&&je.set(t,t.prevState),be.add(t),!(ue>0)&&!Jc)try{for(Jc=!0;be.size>0;){let c=Array.from(be);be.clear();for(let e of c){let o=je.get(e)??e.prevState;e.prevState=o,Fl(e)}for(let e of c){let o=Te.get(e);o&&(me.current.push(e),ca(o))}for(let e of c){let o=Te.get(e);if(o)for(let a of o)wl(a)}}}finally{Jc=!1,me.current=[],je.clear()}}function ht(t){ue++;try{t()}finally{if(ue--,ue===0){let c=be.values().next().value;c&&Ee(c)}}}function oa(t){return typeof t=="function"}var Ge=class{constructor(c,e){this.listeners=new Set,this.subscribe=o=>{var a,i;this.listeners.add(o);let l=(i=(a=this.options)==null?void 0:a.onSubscribe)==null?void 0:i.call(a,o,this);return()=>{this.listeners.delete(o),l?.()}},this.prevState=c,this.state=c,this.options=e}setState(c){var e,o,a;this.prevState=this.state,(e=this.options)!=null&&e.updateFn?this.state=this.options.updateFn(this.prevState)(c):oa(c)?this.state=c(this.prevState):this.state=c,(a=(o=this.options)==null?void 0:o.onUpdate)==null||a.call(o),Ee(this)}};var Wt="__TSR_index",aa="popstate",ia="beforeunload";function sa(t){let c=t.getLocation(),e=new Set,o=l=>{c=t.getLocation(),e.forEach(r=>r({location:c,action:l}))},a=l=>{t.notifyOnIndexChange??!0?o(l):c=t.getLocation()},i=async({task:l,navigateOpts:r,...s})=>{if(r?.ignoreBlocker??!1){l();return}let d=t.getBlockers?.()??[],b=s.type==="PUSH"||s.type==="REPLACE";if(typeof document<"u"&&d.length&&b)for(let u of d){let m=Ht(s.path,s.state);if(await u.blockerFn({currentLocation:c,nextLocation:m,action:s.type})){t.onBlocked?.();return}}l()};return{get location(){return c},get length(){return t.getLength()},subscribers:e,subscribe:l=>(e.add(l),()=>{e.delete(l)}),push:(l,r,s)=>{let n=c.state[Wt];r=la(n+1,r),i({task:()=>{t.pushState(l,r),o({type:"PUSH"})},navigateOpts:s,type:"PUSH",path:l,state:r})},replace:(l,r,s)=>{let n=c.state[Wt];r=la(n,r),i({task:()=>{t.replaceState(l,r),o({type:"REPLACE"})},navigateOpts:s,type:"REPLACE",path:l,state:r})},go:(l,r)=>{i({task:()=>{t.go(l),a({type:"GO",index:l})},navigateOpts:r,type:"GO"})},back:l=>{i({task:()=>{t.back(l?.ignoreBlocker??!1),a({type:"BACK"})},navigateOpts:l,type:"BACK"})},forward:l=>{i({task:()=>{t.forward(l?.ignoreBlocker??!1),a({type:"FORWARD"})},navigateOpts:l,type:"FORWARD"})},canGoBack:()=>c.state[Wt]!==0,createHref:l=>t.createHref(l),block:l=>{if(!t.setBlockers)return()=>{};let r=t.getBlockers?.()??[];return t.setBlockers([...r,l]),()=>{let s=t.getBlockers?.()??[];t.setBlockers?.(s.filter(n=>n!==l))}},flush:()=>t.flush?.(),destroy:()=>t.destroy?.(),notify:o}}function la(t,c){c||(c={});let e=Qc();return{...c,key:e,__TSR_key:e,[Wt]:t}}function Ze(t){let c=t?.window??(typeof document<"u"?window:void 0),e=c.history.pushState,o=c.history.replaceState,a=[],i=()=>a,l=g=>a=g,r=t?.createHref??(g=>g),s=t?.parseLocation??(()=>Ht(`${c.location.pathname}${c.location.search}${c.location.hash}`,c.history.state));if(!c.history.state?.__TSR_key&&!c.history.state?.key){let g=Qc();c.history.replaceState({[Wt]:0,key:g,__TSR_key:g},"")}let n=s(),d,b=!1,u=!1,m=!1,G=!1,p=()=>n,X,h,R=()=>{X&&(W._ignoreSubscribers=!0,(X.isPush?c.history.pushState:c.history.replaceState)(X.state,"",X.href),W._ignoreSubscribers=!1,X=void 0,h=void 0,d=void 0)},I=(g,B,f)=>{let C=r(B);h||(d=n),n=Ht(B,f),X={href:C,state:f,isPush:X?.isPush||g==="push"},h||(h=Promise.resolve().then(()=>R()))},v=g=>{n=s(),W.notify({type:g})},H=async()=>{if(u){u=!1;return}let g=s(),B=g.state[Wt]-n.state[Wt],f=B===1,C=B===-1,V=!f&&!C||b;b=!1;let bt=V?"GO":C?"BACK":"FORWARD",P=V?{type:"GO",index:B}:{type:C?"BACK":"FORWARD"};if(m)m=!1;else{let Ft=i();if(typeof document<"u"&&Ft.length){for(let jo of Ft)if(await jo.blockerFn({currentLocation:n,nextLocation:g,action:bt})){u=!0,c.history.go(1),W.notify(P);return}}}n=s(),W.notify(P)},L=g=>{if(G){G=!1;return}let B=!1,f=i();if(typeof document<"u"&&f.length)for(let C of f){let V=C.enableBeforeUnload??!0;if(V===!0){B=!0;break}if(typeof V=="function"&&V()===!0){B=!0;break}}if(B)return g.preventDefault(),g.returnValue=""},W=sa({getLocation:p,getLength:()=>c.history.length,pushState:(g,B)=>I("push",g,B),replaceState:(g,B)=>I("replace",g,B),back:g=>(g&&(m=!0),G=!0,c.history.back()),forward:g=>{g&&(m=!0),G=!0,c.history.forward()},go:g=>{b=!0,c.history.go(g)},createHref:g=>r(g),flush:R,destroy:()=>{c.history.pushState=e,c.history.replaceState=o,c.removeEventListener(ia,L,{capture:!0}),c.removeEventListener(aa,H)},onBlocked:()=>{d&&n!==d&&(n=d)},getBlockers:i,setBlockers:l,notifyOnIndexChange:!1});return c.addEventListener(ia,L,{capture:!0}),c.addEventListener(aa,H),c.history.pushState=function(...g){let B=e.apply(c.history,g);return W._ignoreSubscribers||v("PUSH"),B},c.history.replaceState=function(...g){let B=o.apply(c.history,g);return W._ignoreSubscribers||v("REPLACE"),B},W}function Ht(t,c){let e=t.indexOf("#"),o=t.indexOf("?"),a=Qc();return{href:t,pathname:t.substring(0,e>0?o>0?Math.min(e,o):e:o>0?o:t.length),hash:e>-1?t.substring(e):"",search:o>-1?t.slice(o,e===-1?void 0:e):"",state:c||{[Wt]:0,key:a,__TSR_key:a}}}function Qc(){return(Math.random()+1).toString(36).substring(7)}function At(t){return t[t.length-1]}function Hl(t){return typeof t=="function"}function $(t,c){return Hl(t)?t(c):t}var Cl=Object.prototype.hasOwnProperty;function O(t,c){if(t===c)return t;let e=c,o=kc(t)&&kc(e);if(!o&&!(pe(t)&&pe(e)))return e;let a=o?t:ra(t);if(!a)return e;let i=o?e:ra(e);if(!i)return e;let l=a.length,r=i.length,s=o?new Array(r):{},n=0;for(let d=0;d<r;d++){let b=o?d:i[d],u=t[b],m=e[b];if(u===m){s[b]=u,(o?d<l:Cl.call(t,b))&&n++;continue}if(u===null||m===null||typeof u!="object"||typeof m!="object"){s[b]=m;continue}let G=O(u,m);s[b]=G,G===u&&n++}return l===r&&n===l?t:s}function ra(t){let c=[],e=Object.getOwnPropertyNames(t);for(let a of e){if(!Object.prototype.propertyIsEnumerable.call(t,a))return!1;c.push(a)}let o=Object.getOwnPropertySymbols(t);for(let a of o){if(!Object.prototype.propertyIsEnumerable.call(t,a))return!1;c.push(a)}return c}function pe(t){if(!da(t))return!1;let c=t.constructor;if(typeof c>"u")return!0;let e=c.prototype;return!(!da(e)||!e.hasOwnProperty("isPrototypeOf"))}function da(t){return Object.prototype.toString.call(t)==="[object Object]"}function kc(t){return Array.isArray(t)&&t.length===Object.keys(t).length}function ot(t,c,e){if(t===c)return!0;if(typeof t!=typeof c)return!1;if(Array.isArray(t)&&Array.isArray(c)){if(t.length!==c.length)return!1;for(let o=0,a=t.length;o<a;o++)if(!ot(t[o],c[o],e))return!1;return!0}if(pe(t)&&pe(c)){let o=e?.ignoreUndefined??!0;if(e?.partial){for(let l in c)if((!o||c[l]!==void 0)&&!ot(t[l],c[l],e))return!1;return!0}let a=0;if(!o)a=Object.keys(t).length;else for(let l in t)t[l]!==void 0&&a++;let i=0;for(let l in c)if((!o||c[l]!==void 0)&&(i++,i>a||!ot(t[l],c[l],e)))return!1;return a===i}return!1}function at(t){let c,e,o=new Promise((a,i)=>{c=a,e=i});return o.status="pending",o.resolve=a=>{o.status="resolved",o.value=a,c(a),t?.(a)},o.reject=a=>{o.status="rejected",e(a)},o}function Gt(t){return!!(t&&typeof t=="object"&&typeof t.then=="function")}var Vl=Array.from(new Map([["%","%25"],["\\","%5C"],["/","%2F"],[";","%3B"],[":","%3A"],["@","%40"],["&","%26"],["=","%3D"],["+","%2B"],["$","%24"],[",","%2C"]]).values());function ge(t,c=Vl,e=0){function o(a){try{return decodeURIComponent(a)}catch{return a.replaceAll(/%[0-9A-Fa-f]{2}/g,i=>{try{return decodeURIComponent(i)}catch{return i}})}}if(t===""||!t.match(/%[0-9A-Fa-f]{2}/g))return t;for(let a=e;a<c.length;a++){let i=c[a];if(i&&t.includes(i)){let l=t.split(i),r=[];for(let s of l)r.push(ge(s,c,a+1));return r.join(i)}}return o(t)}var Nl=!0,Mc="Invariant failed";function A(t,c){if(!t){if(Nl)throw new Error(Mc);var e=typeof c=="function"?c():c,o=e?"".concat(Mc,": ").concat(e):Mc;throw new Error(o)}}var tt=0,yt=1,jt=2,Ct=3;function E(t){return Xe(t.filter(c=>c!==void 0).join("/"))}function Xe(t){return t.replace(/\/{2,}/g,"/")}function Et(t){return t==="/"?t:t.replace(/^\/{1,}/,"")}function K(t){return t==="/"?t:t.replace(/\/{1,}$/,"")}function Vt(t){return K(Et(t))}function Tt(t,c){return t?.endsWith("/")&&t!=="/"&&t!==`${c}/`?t.slice(0,-1):t}function Uc(t,c,e){return Tt(t,e)===Tt(c,e)}function Jl(t){let{type:c,value:e}=t;if(c===tt)return e;let{prefixSegment:o,suffixSegment:a}=t;if(c===yt){let i=e.substring(1);if(o&&a)return`${o}{$${i}}${a}`;if(o)return`${o}{$${i}}`;if(a)return`{$${i}}${a}`}if(c===Ct){let i=e.substring(1);return o&&a?`${o}{-$${i}}${a}`:o?`${o}{-$${i}}`:a?`{-$${i}}${a}`:`{-$${i}}`}if(c===jt){if(o&&a)return`${o}{$}${a}`;if(o)return`${o}{$}`;if(a)return`{$}${a}`}return e}function zc({base:t,to:c,trailingSlash:e="never",parseCache:o}){let a=It(t,o).slice(),i=It(c,o);a.length>1&&At(a)?.value==="/"&&a.pop();for(let s=0,n=i.length;s<n;s++){let d=i[s],b=d.value;b==="/"?s?s===n-1&&a.push(d):a=[d]:b===".."?a.pop():b==="."||a.push(d)}a.length>1&&(At(a).value==="/"?e==="never"&&a.pop():e==="always"&&a.push({type:tt,value:"/"}));let l=a.map(Jl);return E(l)}var It=(t,c)=>{if(!t)return[];let e=c?.get(t);if(e)return e;let o=Sl(t);return c?.set(t,o),o},Ql=/^\$.{1,}$/,kl=/^(.*?)\{(\$[a-zA-Z_$][a-zA-Z0-9_$]*)\}(.*)$/,Ml=/^(.*?)\{-(\$[a-zA-Z_$][a-zA-Z0-9_$]*)\}(.*)$/,Ul=/^\$$/,zl=/^(.*?)\{\$\}(.*)$/;function Sl(t){t=Xe(t);let c=[];if(t.slice(0,1)==="/"&&(t=t.substring(1),c.push({type:tt,value:"/"})),!t)return c;let e=t.split("/").filter(Boolean);return c.push(...e.map(o=>{let a=o.match(zl);if(a){let r=a[1],s=a[2];return{type:jt,value:"$",prefixSegment:r||void 0,suffixSegment:s||void 0}}let i=o.match(Ml);if(i){let r=i[1],s=i[2],n=i[3];return{type:Ct,value:s,prefixSegment:r||void 0,suffixSegment:n||void 0}}let l=o.match(kl);if(l){let r=l[1],s=l[2],n=l[3];return{type:yt,value:""+s,prefixSegment:r||void 0,suffixSegment:n||void 0}}if(Ql.test(o)){let r=o.substring(1);return{type:yt,value:"$"+r,prefixSegment:void 0,suffixSegment:void 0}}return Ul.test(o)?{type:jt,value:"$",prefixSegment:void 0,suffixSegment:void 0}:{type:tt,value:ge(o)}})),t.slice(-1)==="/"&&(t=t.substring(1),c.push({type:tt,value:"/"})),c}function Kt({path:t,params:c,leaveWildcards:e,leaveParams:o,decodeCharMap:a,parseCache:i}){let l=It(t,i);function r(b){let u=c[b],m=typeof u=="string";return b==="*"||b==="_splat"?m?encodeURI(u):u:m?Ol(u,a):u}let s=!1,n={},d=E(l.map(b=>{if(b.type===tt)return b.value;if(b.type===jt){n._splat=c._splat,n["*"]=c._splat;let u=b.prefixSegment||"",m=b.suffixSegment||"";if(!c._splat)return s=!0,e?`${u}${b.value}${m}`:u||m?`${u}${m}`:void 0;let G=r("_splat");return e?`${u}${b.value}${G??""}${m}`:`${u}${G}${m}`}if(b.type===yt){let u=b.value.substring(1);!s&&!(u in c)&&(s=!0),n[u]=c[u];let m=b.prefixSegment||"",G=b.suffixSegment||"";if(o){let p=r(b.value);return`${m}${b.value}${p??""}${G}`}return`${m}${r(u)??"undefined"}${G}`}if(b.type===Ct){let u=b.value.substring(1),m=b.prefixSegment||"",G=b.suffixSegment||"";if(!(u in c)||c[u]==null)return e?`${m}${u}${G}`:m||G?`${m}${G}`:void 0;if(n[u]=c[u],o){let p=r(b.value);return`${m}${b.value}${p??""}${G}`}return e?`${m}${u}${r(u)??""}${G}`:`${m}${r(u)??""}${G}`}return b.value}));return{usedParams:n,interpolatedPath:d,isMissingParams:s}}function Ol(t,c){let e=encodeURIComponent(t);if(c)for(let[o,a]of c)e=e.replaceAll(o,a);return e}function he(t,c,e){let o=na(t,c,e);if(!(c.to&&!o))return o??{}}function na(t,{to:c,fuzzy:e,caseSensitive:o},a){let i=c,l=It(t.startsWith("/")?t:`/${t}`,a),r=It(i.startsWith("/")?i:`/${i}`,a),s={};return Dl(l,r,s,e,o)?s:void 0}function Dl(t,c,e,o,a){let i=0,l=0;for(;i<t.length||l<c.length;){let r=t[i],s=c[l];if(s){if(s.type===jt){let n=t.slice(i),d;if(s.prefixSegment||s.suffixSegment){if(!r)return!1;let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if("prefixSegment"in s&&!m.startsWith(b)||"suffixSegment"in s&&!t[t.length-1]?.value.endsWith(u))return!1;let G=decodeURI(E(n.map(p=>p.value)));b&&G.startsWith(b)&&(G=G.slice(b.length)),u&&G.endsWith(u)&&(G=G.slice(0,G.length-u.length)),d=G}else d=decodeURI(E(n.map(b=>b.value)));return e["*"]=d,e._splat=d,!0}if(s.type===tt){if(s.value==="/"&&!r?.value){l++;continue}if(r){if(a){if(s.value!==r.value)return!1}else if(s.value.toLowerCase()!==r.value.toLowerCase())return!1;i++,l++;continue}else return!1}if(s.type===yt){if(!r||r.value==="/")return!1;let n="",d=!1;if(s.prefixSegment||s.suffixSegment){let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if(b&&!m.startsWith(b)||u&&!m.endsWith(u))return!1;let G=m;b&&G.startsWith(b)&&(G=G.slice(b.length)),u&&G.endsWith(u)&&(G=G.slice(0,G.length-u.length)),n=decodeURIComponent(G),d=!0}else n=decodeURIComponent(r.value),d=!0;d&&(e[s.value.substring(1)]=n,i++),l++;continue}if(s.type===Ct){if(!r){l++;continue}if(r.value==="/"){l++;continue}let n="",d=!1;if(s.prefixSegment||s.suffixSegment){let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if((!b||m.startsWith(b))&&(!u||m.endsWith(u))){let G=m;b&&G.startsWith(b)&&(G=G.slice(b.length)),u&&G.endsWith(u)&&(G=G.slice(0,G.length-u.length)),n=decodeURIComponent(G),d=!0}}else{let b=!0;for(let u=l+1;u<c.length;u++){let m=c[u];if(m?.type===tt&&m.value===r.value){b=!1;break}if(m?.type===yt||m?.type===jt){t.length<c.length&&(b=!1);break}}b&&(n=decodeURIComponent(r.value),d=!0)}d&&(e[s.value.substring(1)]=n,i++),l++;continue}}if(i<t.length&&l>=c.length)return e["**"]=E(t.slice(i).map(n=>n.value)),!!o&&c[c.length-1]?.value!=="/";if(l<c.length&&i>=t.length){for(let n=l;n<c.length;n++)if(c[n]?.type!==Ct)return!1;break}break}return!0}var Al=.75,jl=1,Tl=.5,El=.4,Kl=.25,_l=.2,Pl=.05,ql=.02,$l=.01,ba=2e-4,ua=1e-4;function ma(t,c){return t.prefixSegment&&t.suffixSegment?c+Pl+ba*t.prefixSegment.length+ua*t.suffixSegment.length:t.prefixSegment?c+ql+ba*t.prefixSegment.length:t.suffixSegment?c+$l+ua*t.suffixSegment.length:c}function ts(t){let c=[];return t.forEach((o,a)=>{if(o.isRoot||!o.path)return;let i=Et(o.fullPath),l=It(i),r=0;for(;l.length>r+1&&l[r]?.value==="/";)r++;r>0&&(l=l.slice(r));let s=0,n=!1,d=l.map((b,u)=>{if(b.value==="/")return Al;if(b.type===tt)return jl;let m;b.type===yt?m=Tl:b.type===Ct?(m=El,s++):m=Kl;for(let G=u+1;G<l.length;G++){let p=l[G];if(p.type===tt&&p.value!=="/")return n=!0,ma(b,m+_l)}return ma(b,m)});c.push({child:o,trimmed:i,parsed:l,index:a,scores:d,optionalParamCount:s,hasStaticAfter:n})}),c.sort((o,a)=>{let i=Math.min(o.scores.length,a.scores.length);for(let l=0;l<i;l++)if(o.scores[l]!==a.scores[l])return a.scores[l]-o.scores[l];if(o.scores.length!==a.scores.length){if(o.optionalParamCount!==a.optionalParamCount){if(o.hasStaticAfter===a.hasStaticAfter)return o.optionalParamCount-a.optionalParamCount;if(o.hasStaticAfter&&!a.hasStaticAfter)return-1;if(!o.hasStaticAfter&&a.hasStaticAfter)return 1}return a.scores.length-o.scores.length}for(let l=0;l<i;l++)if(o.parsed[l].value!==a.parsed[l].value)return o.parsed[l].value>a.parsed[l].value?1:-1;return o.index-a.index}).map((o,a)=>(o.child.rank=a,o.child))}function Ga({routeTree:t,initRoute:c}){let e={},o={},a=l=>{l.forEach((r,s)=>{c?.(r,s);let n=e[r.id];if(A(!n,`Duplicate routes found with id: ${String(r.id)}`),e[r.id]=r,!r.isRoot&&r.path){let b=K(r.fullPath);(!o[b]||r.fullPath.endsWith("/"))&&(o[b]=r)}let d=r.children;d?.length&&a(d)})};a([t]);let i=ts(Object.values(e));return{routesById:e,routesByPath:o,flatRoutes:i}}function z(t){return!!t?.isNotFound}function es(){try{if(typeof window<"u"&&typeof window.sessionStorage=="object")return window.sessionStorage}catch{}}var _t="tsr-scroll-restoration-v1_3",cs=(t,c)=>{let e;return(...o)=>{e||(e=setTimeout(()=>{t(...o),e=null},c))}};function os(){let t=es();if(!t)return null;let c=t.getItem(_t),e=c?JSON.parse(c):{};return{state:e,set:o=>(e=$(o,e)||e,t.setItem(_t,JSON.stringify(e)))}}var We=os(),ye=t=>t.state.__TSR_key||t.href;function Za(t){let c=[],e;for(;e=t.parentNode;)c.push(`${t.tagName}:nth-child(${Array.prototype.indexOf.call(e.children,t)+1})`),t=e;return`${c.reverse().join(" > ")}`.toLowerCase()}var Ke=!1;function _e({storageKey:t,key:c,behavior:e,shouldScrollRestoration:o,scrollToTopSelectors:a,location:i}){let l;try{l=JSON.parse(sessionStorage.getItem(t)||"{}")}catch(n){console.error(n);return}let r=c||window.history.state?.__TSR_key,s=l[r];Ke=!0;t:{if(o&&s&&Object.keys(s).length>0){for(let b in s){let u=s[b];if(b==="window")window.scrollTo({top:u.scrollY,left:u.scrollX,behavior:e});else if(b){let m=document.querySelector(b);m&&(m.scrollLeft=u.scrollX,m.scrollTop=u.scrollY)}}break t}let n=(i??window.location).hash.split("#",2)[1];if(n){let b=window.history.state?.__hashScrollIntoViewOptions??!0;if(b){let u=document.getElementById(n);u&&u.scrollIntoView(b)}break t}let d={top:0,left:0,behavior:e};if(window.scrollTo(d),a)for(let b of a){if(b==="window")continue;let u=typeof b=="function"?b():document.querySelector(b);u&&u.scrollTo(d)}}Ke=!1}function Sc(t,c){if(!We&&!t.isServer||((c??t.options.scrollRestoration??!1)&&(t.isScrollRestoring=!0),t.isServer||t.isScrollRestorationSetup||!We))return;t.isScrollRestorationSetup=!0,Ke=!1;let o=t.options.getScrollRestorationKey||ye;window.history.scrollRestoration="manual";let a=i=>{if(Ke||!t.isScrollRestoring)return;let l="";if(i.target===document||i.target===window)l="window";else{let s=i.target.getAttribute("data-scroll-restoration-id");s?l=`[data-scroll-restoration-id="${s}"]`:l=Za(i.target)}let r=o(t.state.location);We.set(s=>{let n=s[r]||={},d=n[l]||={};if(l==="window")d.scrollX=window.scrollX||0,d.scrollY=window.scrollY||0;else if(l){let b=document.querySelector(l);b&&(d.scrollX=b.scrollLeft||0,d.scrollY=b.scrollTop||0)}return s})};typeof document<"u"&&document.addEventListener("scroll",cs(a,100),!0),t.subscribe("onRendered",i=>{let l=o(i.toLocation);if(!t.resetNextScroll){t.resetNextScroll=!0;return}typeof t.options.scrollRestoration=="function"&&!t.options.scrollRestoration({location:t.latestLocation})||(_e({storageKey:_t,key:l,behavior:t.options.scrollRestorationBehavior,shouldScrollRestoration:t.isScrollRestoring,scrollToTopSelectors:t.options.scrollToTopSelectors,location:t.history.location}),t.isScrollRestoring&&We.set(r=>(r[l]||={},r)))})}function Oc(t){if(typeof document<"u"&&document.querySelector){let c=t.state.location.state.__hashScrollIntoViewOptions??!0;if(c&&t.state.location.hash!==""){let e=document.getElementById(t.state.location.hash);e&&e.scrollIntoView(c)}}}function pa(t,c=String){let e=new URLSearchParams;for(let o in t){let a=t[o];a!==void 0&&e.set(o,c(a))}return e.toString()}function Dc(t){return t?t==="false"?!1:t==="true"?!0:+t*0===0&&+t+""===t?+t:t:""}function ga(t){let c=new URLSearchParams(t),e={};for(let[o,a]of c.entries()){let i=e[o];i==null?e[o]=Dc(a):Array.isArray(i)?i.push(Dc(a)):e[o]=[i,Dc(a)]}return e}var Xa=as(JSON.parse),ha=is(JSON.stringify,JSON.parse);function as(t){return c=>{c[0]==="?"&&(c=c.substring(1));let e=ga(c);for(let o in e){let a=e[o];if(typeof a=="string")try{e[o]=t(a)}catch{}}return e}}function is(t,c){let e=typeof c=="function";function o(a){if(typeof a=="object"&&a!==null)try{return t(a)}catch{}else if(e&&typeof a=="string")try{return c(a),t(a)}catch{}return a}return a=>{let i=pa(a,o);return i?`?${i}`:""}}var J="__root__";function Ac(t){if(t.statusCode=t.statusCode||t.code||307,!t.reloadDocument&&typeof t.href=="string")try{new URL(t.href),t.reloadDocument=!0}catch{}let c=new Headers(t.headers);t.href&&c.get("Location")===null&&c.set("Location",t.href);let e=new Response(null,{status:t.statusCode,headers:c});if(e.options=t,t.throw)throw e;return e}function j(t){return t instanceof Response&&!!t.options}function Wa(t){let c=new Map,e,o,a=i=>{i.next&&(i.prev?(i.prev.next=i.next,i.next.prev=i.prev,i.next=void 0,o&&(o.next=i,i.prev=o)):(i.next.prev=void 0,e=i.next,i.next=void 0,o&&(i.prev=o,o.next=i)),o=i)};return{get(i){let l=c.get(i);if(l)return a(l),l.value},set(i,l){if(c.size>=t&&e){let s=e;c.delete(s.key),s.next&&(e=s.next,s.next.prev=void 0),s===o&&(o=void 0)}let r=c.get(i);if(r)r.value=l,a(r);else{let s={key:i,value:l,prev:o};o&&(o.next=s),o=s,e||(e=s),c.set(i,s)}}}}var qe=t=>{if(!t.rendered)return t.rendered=!0,t.onReady?.()},$e=(t,c)=>!!(t.preload&&!t.router.state.matches.some(e=>e.id===c)),Ia=(t,c)=>{let e=t.router.routesById[c.routeId??""]??t.router.routeTree;!e.options.notFoundComponent&&t.router.options?.defaultNotFoundComponent&&(e.options.notFoundComponent=t.router.options.defaultNotFoundComponent),A(e.options.notFoundComponent,"No notFoundComponent found. Please set a notFoundComponent on your route or provide a defaultNotFoundComponent to the router.");let o=t.matches.find(a=>a.routeId===e.id);A(o,"Could not find match for route: "+e.id),t.updateMatch(o.id,a=>({...a,status:"notFound",error:c,isFetching:!1})),c.routerCode==="BEFORE_LOAD"&&e.parentRoute&&(c.routeId=e.parentRoute.id,Ia(t,c))},Bt=(t,c,e)=>{if(!(!j(e)&&!z(e))){if(j(e)&&e.redirectHandled&&!e.options.reloadDocument)throw e;if(c){c._nonReactive.beforeLoadPromise?.resolve(),c._nonReactive.loaderPromise?.resolve(),c._nonReactive.beforeLoadPromise=void 0,c._nonReactive.loaderPromise=void 0;let o=j(e)?"redirected":"notFound";t.updateMatch(c.id,a=>({...a,status:o,isFetching:!1,error:e})),z(e)&&!e.routeId&&(e.routeId=c.routeId),c._nonReactive.loadPromise?.resolve()}throw j(e)?(t.rendered=!0,e.options._fromLocation=t.location,e.redirectHandled=!0,e=t.router.resolveRedirect(e),e):(Ia(t,e),e)}},Ba=(t,c)=>{let e=t.router.getMatch(c);return!!(!t.router.isServer&&e._nonReactive.dehydrated||t.router.isServer&&e.ssr===!1)},Ie=(t,c,e,o)=>{let{id:a,routeId:i}=t.matches[c],l=t.router.looseRoutesById[i];if(e instanceof Promise)throw e;e.routerCode=o,t.firstBadMatchIndex??=c,Bt(t,t.router.getMatch(a),e);try{l.options.onError?.(e)}catch(r){e=r,Bt(t,t.router.getMatch(a),e)}t.updateMatch(a,r=>(r._nonReactive.beforeLoadPromise?.resolve(),r._nonReactive.beforeLoadPromise=void 0,r._nonReactive.loadPromise?.resolve(),{...r,error:e,status:"error",isFetching:!1,updatedAt:Date.now(),abortController:new AbortController}))},ls=(t,c,e,o)=>{let a=t.router.getMatch(c),i=t.matches[e-1]?.id,l=i?t.router.getMatch(i):void 0;if(t.router.isShell()){a.ssr=c===J;return}if(l?.ssr===!1){a.ssr=!1;return}let r=m=>m===!0&&l?.ssr==="data-only"?"data-only":m,s=t.router.options.defaultSsr??!0;if(o.options.ssr===void 0){a.ssr=r(s);return}if(typeof o.options.ssr!="function"){a.ssr=r(o.options.ssr);return}let{search:n,params:d}=a,b={search:Pe(n,a.searchError),params:Pe(d,a.paramsError),location:t.location,matches:t.matches.map(m=>({index:m.index,pathname:m.pathname,fullPath:m.fullPath,staticData:m.staticData,id:m.id,routeId:m.routeId,search:Pe(m.search,m.searchError),params:Pe(m.params,m.paramsError),ssr:m.ssr}))},u=o.options.ssr(b);if(Gt(u))return u.then(m=>{a.ssr=r(m??s)});a.ssr=r(u??s)},fa=(t,c,e,o)=>{if(o._nonReactive.pendingTimeout!==void 0)return;let a=e.options.pendingMs??t.router.options.defaultPendingMs;if(!!(t.onReady&&!t.router.isServer&&!$e(t,c)&&(e.options.loader||e.options.beforeLoad||Ec(e))&&typeof a=="number"&&a!==1/0&&(e.options.pendingComponent??t.router.options?.defaultPendingComponent))){let l=setTimeout(()=>{qe(t)},a);o._nonReactive.pendingTimeout=l}},ss=(t,c,e)=>{let o=t.router.getMatch(c);if(!o._nonReactive.beforeLoadPromise&&!o._nonReactive.loaderPromise)return;fa(t,c,e,o);let a=()=>{let i=t.router.getMatch(c);i.preload&&(i.status==="redirected"||i.status==="notFound")&&Bt(t,i,i.error)};return o._nonReactive.beforeLoadPromise?o._nonReactive.beforeLoadPromise.then(a):a()},rs=(t,c,e,o)=>{let a=t.router.getMatch(c),i=a._nonReactive.loadPromise;a._nonReactive.loadPromise=at(()=>{i?.resolve()});let{paramsError:l,searchError:r}=a;l&&Ie(t,e,l,"PARSE_PARAMS"),r&&Ie(t,e,r,"VALIDATE_SEARCH"),fa(t,c,o,a);let s=new AbortController,n=t.matches[e-1]?.id,u={...(n?t.router.getMatch(n):void 0)?.context??t.router.options.context??void 0,...a.__routeContext},m=!1,G=()=>{m||(m=!0,t.updateMatch(c,W=>({...W,isFetching:"beforeLoad",fetchCount:W.fetchCount+1,abortController:s,context:u})))},p=()=>{a._nonReactive.beforeLoadPromise?.resolve(),a._nonReactive.beforeLoadPromise=void 0,t.updateMatch(c,W=>({...W,isFetching:!1}))};if(!o.options.beforeLoad){ht(()=>{G(),p()});return}a._nonReactive.beforeLoadPromise=at();let{search:X,params:h,cause:R}=a,I=$e(t,c),v={search:X,abortController:s,params:h,preload:I,context:u,location:t.location,navigate:W=>t.router.navigate({...W,_fromLocation:t.location}),buildLocation:t.router.buildLocation,cause:I?"preload":R,matches:t.matches,...t.router.options.additionalContext},H=W=>{if(W===void 0){ht(()=>{G(),p()});return}(j(W)||z(W))&&(G(),Ie(t,e,W,"BEFORE_LOAD")),ht(()=>{G(),t.updateMatch(c,g=>({...g,__beforeLoadContext:W,context:{...g.context,...W}})),p()})},L;try{if(L=o.options.beforeLoad(v),Gt(L))return G(),L.catch(W=>{Ie(t,e,W,"BEFORE_LOAD")}).then(H)}catch(W){G(),Ie(t,e,W,"BEFORE_LOAD")}H(L)},ds=(t,c)=>{let{id:e,routeId:o}=t.matches[c],a=t.router.looseRoutesById[o],i=()=>{if(t.router.isServer){let s=ls(t,e,c,a);if(Gt(s))return s.then(r)}return r()},l=()=>rs(t,e,c,a),r=()=>{if(Ba(t,e))return;let s=ss(t,e,a);return Gt(s)?s.then(l):l()};return i()},Be=(t,c,e)=>{let o=t.router.getMatch(c);if(!o||!e.options.head&&!e.options.scripts&&!e.options.headers)return;let a={matches:t.matches,match:o,params:o.params,loaderData:o.loaderData};return Promise.all([e.options.head?.(a),e.options.scripts?.(a),e.options.headers?.(a)]).then(([i,l,r])=>{let s=i?.meta,n=i?.links,d=i?.scripts,b=i?.styles;return{meta:s,links:n,headScripts:d,headers:r,scripts:l,styles:b}})},Ra=(t,c,e,o)=>{let a=t.matchPromises[e-1],{params:i,loaderDeps:l,abortController:r,context:s,cause:n}=t.router.getMatch(c),d=$e(t,c);return{params:i,deps:l,preload:!!d,parentMatchPromise:a,abortController:r,context:s,location:t.location,navigate:b=>t.router.navigate({...b,_fromLocation:t.location}),cause:d?"preload":n,route:o,...t.router.options.additionalContext}},ya=async(t,c,e,o)=>{try{let a=t.router.getMatch(c);try{(!t.router.isServer||a.ssr===!0)&&Tc(o);let i=o.options.loader?.(Ra(t,c,e,o)),l=o.options.loader&&Gt(i);if(!!(l||o._lazyPromise||o._componentsPromise||o.options.head||o.options.scripts||o.options.headers||a._nonReactive.minPendingPromise)&&t.updateMatch(c,b=>({...b,isFetching:"loader"})),o.options.loader){let b=l?await i:i;Bt(t,t.router.getMatch(c),b),b!==void 0&&t.updateMatch(c,u=>({...u,loaderData:b}))}o._lazyPromise&&await o._lazyPromise;let s=Be(t,c,o),n=s?await s:void 0,d=a._nonReactive.minPendingPromise;d&&await d,o._componentsPromise&&await o._componentsPromise,t.updateMatch(c,b=>({...b,error:void 0,status:"success",isFetching:!1,updatedAt:Date.now(),...n}))}catch(i){let l=i,r=a._nonReactive.minPendingPromise;r&&await r,z(i)&&await o.options.notFoundComponent?.preload?.(),Bt(t,t.router.getMatch(c),i);try{o.options.onError?.(i)}catch(d){l=d,Bt(t,t.router.getMatch(c),d)}let s=Be(t,c,o),n=s?await s:void 0;t.updateMatch(c,d=>({...d,error:l,status:"error",isFetching:!1,...n}))}}catch(a){let i=t.router.getMatch(c);if(i){let l=Be(t,c,o);if(l){let r=await l;t.updateMatch(c,s=>({...s,...r}))}i._nonReactive.loaderPromise=void 0}Bt(t,i,a)}},ns=async(t,c)=>{let{id:e,routeId:o}=t.matches[c],a=!1,i=!1,l=t.router.looseRoutesById[o];if(Ba(t,e)){if(t.router.isServer){let n=Be(t,e,l);if(n){let d=await n;t.updateMatch(e,b=>({...b,...d}))}return t.router.getMatch(e)}}else{let n=t.router.getMatch(e);if(n._nonReactive.loaderPromise){if(n.status==="success"&&!t.sync&&!n.preload)return n;await n._nonReactive.loaderPromise;let d=t.router.getMatch(e);d.error&&Bt(t,d,d.error)}else{let d=Date.now()-n.updatedAt,b=$e(t,e),u=b?l.options.preloadStaleTime??t.router.options.defaultPreloadStaleTime??3e4:l.options.staleTime??t.router.options.defaultStaleTime??0,m=l.options.shouldReload,G=typeof m=="function"?m(Ra(t,e,c,l)):m,p=!!b&&!t.router.state.matches.some(I=>I.id===e),X=t.router.getMatch(e);X._nonReactive.loaderPromise=at(),p!==X.preload&&t.updateMatch(e,I=>({...I,preload:p}));let{status:h,invalid:R}=X;if(a=h==="success"&&(R||(G??d>u)),!(b&&l.options.preload===!1))if(a&&!t.sync)i=!0,(async()=>{try{await ya(t,e,c,l);let I=t.router.getMatch(e);I._nonReactive.loaderPromise?.resolve(),I._nonReactive.loadPromise?.resolve(),I._nonReactive.loaderPromise=void 0}catch(I){j(I)&&await t.router.navigate(I.options)}})();else if(h!=="success"||a&&t.sync)await ya(t,e,c,l);else{let I=Be(t,e,l);if(I){let v=await I;t.updateMatch(e,H=>({...H,...v}))}}}}let r=t.router.getMatch(e);i||(r._nonReactive.loaderPromise?.resolve(),r._nonReactive.loadPromise?.resolve()),clearTimeout(r._nonReactive.pendingTimeout),r._nonReactive.pendingTimeout=void 0,i||(r._nonReactive.loaderPromise=void 0),r._nonReactive.dehydrated=void 0;let s=i?r.isFetching:!1;return s!==r.isFetching||r.invalid!==!1?(t.updateMatch(e,n=>({...n,isFetching:s,invalid:!1})),t.router.getMatch(e)):r};async function jc(t){let c=Object.assign(t,{matchPromises:[]});!c.router.isServer&&c.router.state.matches.some(e=>e._forcePending)&&qe(c);try{for(let a=0;a<c.matches.length;a++){let i=ds(c,a);Gt(i)&&await i}let e=c.firstBadMatchIndex??c.matches.length;for(let a=0;a<e;a++)c.matchPromises.push(ns(c,a));await Promise.all(c.matchPromises);let o=qe(c);Gt(o)&&await o}catch(e){if(z(e)&&!c.preload){let o=qe(c);throw Gt(o)&&await o,e}if(j(e))throw e}return c.matches}async function Tc(t){if(!t._lazyLoaded&&t._lazyPromise===void 0&&(t.lazyFn?t._lazyPromise=t.lazyFn().then(c=>{let{id:e,...o}=c.options;Object.assign(t.options,o),t._lazyLoaded=!0,t._lazyPromise=void 0}):t._lazyLoaded=!0),!t._componentsLoaded&&t._componentsPromise===void 0){let c=()=>{let e=[];for(let o of va){let a=t.options[o]?.preload;a&&e.push(a())}if(e.length)return Promise.all(e).then(()=>{t._componentsLoaded=!0,t._componentsPromise=void 0});t._componentsLoaded=!0,t._componentsPromise=void 0};t._componentsPromise=t._lazyPromise?t._lazyPromise.then(c):c()}return t._componentsPromise}function Pe(t,c){return c?{status:"error",error:c}:{status:"success",value:t}}function Ec(t){for(let c of va)if(t.options[c]?.preload)return!0;return!1}var va=["component","errorComponent","pendingComponent","notFoundComponent"];function La(t){return{input:({url:c})=>{for(let e of t)c=Kc(e,c);return c},output:({url:c})=>{for(let e=t.length-1;e>=0;e--)c=_c(t[e],c);return c}}}function xa(t){let c=Vt(t.basepath),e=`/${c}`,o=`${e}/`,a=t.caseSensitive?e:e.toLowerCase(),i=t.caseSensitive?o:o.toLowerCase();return{input:({url:l})=>{let r=t.caseSensitive?l.pathname:l.pathname.toLowerCase();return r===a?l.pathname="/":r.startsWith(i)&&(l.pathname=l.pathname.slice(e.length)),l},output:({url:l})=>(l.pathname=E(["/",c,l.pathname]),l)}}function Kc(t,c){let e=t?.input?.({url:c});if(e){if(typeof e=="string")return new URL(e);if(e instanceof URL)return e}return c}function _c(t,c){let e=t?.output?.({url:c});if(e){if(typeof e=="string")return new URL(e);if(e instanceof URL)return e}return c}function it(t){let c=t.resolvedLocation,e=t.location,o=c?.pathname!==e.pathname,a=c?.href!==e.href,i=c?.hash!==e.hash;return{fromLocation:c,toLocation:e,pathChanged:o,hrefChanged:a,hashChanged:i}}var fe=class{constructor(c){this.tempLocationKey=`${Math.round(Math.random()*1e7)}`,this.resetNextScroll=!0,this.shouldViewTransition=void 0,this.isViewTransitionTypesSupported=void 0,this.subscribers=new Set,this.isScrollRestoring=!1,this.isScrollRestorationSetup=!1,this.startTransition=e=>e(),this.update=e=>{e.notFoundRoute&&console.warn("The notFoundRoute API is deprecated and will be removed in the next major version. See https://tanstack.com/router/v1/docs/framework/react/guide/not-found-errors#migrating-from-notfoundroute for more info.");let o=this.options,a=this.basepath??o?.basepath??"/",i=this.basepath===void 0,l=o?.rewrite;this.options={...o,...e},this.isServer=this.options.isServer??typeof document>"u",this.pathParamsDecodeCharMap=this.options.pathParamsAllowedCharacters?new Map(this.options.pathParamsAllowedCharacters.map(u=>[encodeURIComponent(u),u])):void 0,(!this.history||this.options.history&&this.options.history!==this.history)&&(this.options.history?this.history=this.options.history:this.isServer||(this.history=Ze())),this.origin=this.options.origin,this.origin||(!this.isServer&&window?.origin&&window.origin!=="null"?this.origin=window.origin:this.origin="http://localhost"),this.history&&this.updateLatestLocation(),this.options.routeTree!==this.routeTree&&(this.routeTree=this.options.routeTree,this.buildRouteTree()),!this.__store&&this.latestLocation&&(this.__store=new Ge(Ya(this.latestLocation),{onUpdate:()=>{this.__store.state={...this.state,cachedMatches:this.state.cachedMatches.filter(u=>!["redirected"].includes(u.status))}}}),Sc(this));let r=!1,s=this.options.basepath??"/",n=this.options.rewrite;if(i||a!==s||l!==n){this.basepath=s;let u=[];Vt(s)!==""&&u.push(xa({basepath:s})),n&&u.push(n),this.rewrite=u.length===0?void 0:u.length===1?u[0]:La(u),this.history&&this.updateLatestLocation(),r=!0}r&&this.__store&&(this.__store.state={...this.state,location:this.latestLocation}),typeof window<"u"&&"CSS"in window&&typeof window.CSS?.supports=="function"&&(this.isViewTransitionTypesSupported=window.CSS.supports("selector(:active-view-transition-type(a)"))},this.updateLatestLocation=()=>{this.latestLocation=this.parseLocation(this.history.location,this.latestLocation)},this.buildRouteTree=()=>{let{routesById:e,routesByPath:o,flatRoutes:a}=Ga({routeTree:this.routeTree,initRoute:(l,r)=>{l.init({originalIndex:r})}});this.routesById=e,this.routesByPath=o,this.flatRoutes=a;let i=this.options.notFoundRoute;i&&(i.init({originalIndex:99999999999}),this.routesById[i.id]=i)},this.subscribe=(e,o)=>{let a={eventType:e,fn:o};return this.subscribers.add(a),()=>{this.subscribers.delete(a)}},this.emit=e=>{this.subscribers.forEach(o=>{o.eventType===e.type&&o.fn(e)})},this.parseLocation=(e,o)=>{let a=({href:s,state:n})=>{let d=new URL(s,this.origin),b=Kc(this.rewrite,d),u=this.options.parseSearch(b.search),m=this.options.stringifySearch(u);b.search=m;let G=b.href.replace(b.origin,""),{pathname:p,hash:X}=b;return{href:G,publicHref:s,url:b.href,pathname:p,searchStr:m,search:O(o?.search,u),hash:X.split("#").reverse()[0]??"",state:O(o?.state,n)}},i=a(e),{__tempLocation:l,__tempKey:r}=i.state;if(l&&(!r||r===this.tempLocationKey)){let s=a(l);return s.state.key=i.state.key,s.state.__TSR_key=i.state.__TSR_key,delete s.state.__tempLocation,{...s,maskedLocation:i}}return i},this.resolvePathWithBase=(e,o)=>zc({base:e,to:Xe(o),trailingSlash:this.options.trailingSlash,parseCache:this.parsePathnameCache}),this.matchRoutes=(e,o,a)=>typeof e=="string"?this.matchRoutesInternal({pathname:e,search:o},a):this.matchRoutesInternal(e,o),this.parsePathnameCache=Wa(1e3),this.getMatchedRoutes=(e,o)=>Fa({pathname:e,routePathname:o,caseSensitive:this.options.caseSensitive,routesByPath:this.routesByPath,routesById:this.routesById,flatRoutes:this.flatRoutes,parseCache:this.parsePathnameCache}),this.cancelMatch=e=>{let o=this.getMatch(e);o&&(o.abortController.abort(),clearTimeout(o._nonReactive.pendingTimeout),o._nonReactive.pendingTimeout=void 0)},this.cancelMatches=()=>{this.state.pendingMatches?.forEach(e=>{this.cancelMatch(e.id)})},this.buildLocation=e=>{let o=(i={})=>{let l=i._fromLocation||this.latestLocation,r=this.matchRoutes(l,{_buildLocation:!0}),s=At(r);i.from;let n=i.unsafeRelative==="path"?l.pathname:i.from??s.fullPath,d=this.resolvePathWithBase(n,"."),b=s.search,u={...s.params},m=i.to?this.resolvePathWithBase(d,`${i.to}`):this.resolvePathWithBase(d,"."),G=i.params===!1||i.params===null?{}:(i.params??!0)===!0?u:Object.assign(u,$(i.params,u)),p=Kt({path:m,params:G,parseCache:this.parsePathnameCache}).interpolatedPath,X=this.matchRoutes(p,void 0,{_buildLocation:!0}).map(f=>this.looseRoutesById[f.routeId]);if(Object.keys(G).length>0)for(let f of X){let C=f.options.params?.stringify??f.options.stringifyParams;C&&Object.assign(G,C(G))}let h=ge(Kt({path:m,params:G,leaveWildcards:!1,leaveParams:e.leaveParams,decodeCharMap:this.pathParamsDecodeCharMap,parseCache:this.parsePathnameCache}).interpolatedPath),R=b;if(e._includeValidateSearch&&this.options.search?.strict){let f={};X.forEach(C=>{if(C.options.validateSearch)try{Object.assign(f,Pc(C.options.validateSearch,{...f,...R}))}catch{}}),R=f}R=bs({search:R,dest:i,destRoutes:X,_includeValidateSearch:e._includeValidateSearch}),R=O(b,R);let I=this.options.stringifySearch(R),v=i.hash===!0?l.hash:i.hash?$(i.hash,l.hash):void 0,H=v?`#${v}`:"",L=i.state===!0?l.state:i.state?$(i.state,l.state):{};L=O(l.state,L);let W=`${h}${I}${H}`,g=new URL(W,this.origin),B=_c(this.rewrite,g);return{publicHref:B.pathname+B.search+B.hash,href:W,url:B.href,pathname:h,search:R,searchStr:I,state:L,hash:v??"",unmaskOnReload:i.unmaskOnReload}},a=(i={},l)=>{let r=o(i),s=l?o(l):void 0;if(!s){let n={},d=this.options.routeMasks?.find(b=>{let u=he(r.pathname,{to:b.from,caseSensitive:!1,fuzzy:!1},this.parsePathnameCache);return u?(n=u,!0):!1});if(d){let{from:b,...u}=d;l={from:e.from,...u,params:n},s=o(l)}}return s&&(r.maskedLocation=s),r};return e.mask?a(e,{from:e.from,...e.mask}):a(e)},this.commitLocation=({viewTransition:e,ignoreBlocker:o,...a})=>{let i=()=>{let s=["key","__TSR_key","__TSR_index","__hashScrollIntoViewOptions"];s.forEach(d=>{a.state[d]=this.latestLocation.state[d]});let n=ot(a.state,this.latestLocation.state);return s.forEach(d=>{delete a.state[d]}),n},l=K(this.latestLocation.href)===K(a.href),r=this.commitLocationPromise;if(this.commitLocationPromise=at(()=>{r?.resolve()}),l&&i())this.load();else{let{maskedLocation:s,hashScrollIntoView:n,...d}=a;s&&(d={...s,state:{...s.state,__tempKey:void 0,__tempLocation:{...d,search:d.searchStr,state:{...d.state,__tempKey:void 0,__tempLocation:void 0,__TSR_key:void 0,key:void 0}}}},(d.unmaskOnReload??this.options.unmaskOnReload??!1)&&(d.state.__tempKey=this.tempLocationKey)),d.state.__hashScrollIntoViewOptions=n??this.options.defaultHashScrollIntoView??!0,this.shouldViewTransition=e,this.history[a.replace?"replace":"push"](d.publicHref,d.state,{ignoreBlocker:o})}return this.resetNextScroll=a.resetScroll??!0,this.history.subscribers.size||this.load(),this.commitLocationPromise},this.buildAndCommitLocation=({replace:e,resetScroll:o,hashScrollIntoView:a,viewTransition:i,ignoreBlocker:l,href:r,...s}={})=>{if(r){let d=this.history.location.state.__TSR_index,b=Ht(r,{__TSR_index:e?d:d+1});s.to=b.pathname,s.search=this.options.parseSearch(b.search),s.hash=b.hash.slice(1)}let n=this.buildLocation({...s,_includeValidateSearch:!0});return this.commitLocation({...n,viewTransition:i,replace:e,resetScroll:o,hashScrollIntoView:a,ignoreBlocker:l})},this.navigate=({to:e,reloadDocument:o,href:a,...i})=>{if(!o&&a)try{new URL(`${a}`),o=!0}catch{}return o?(a||(a=this.buildLocation({to:e,...i}).url),i.replace?window.location.replace(a):window.location.href=a,Promise.resolve()):this.buildAndCommitLocation({...i,href:a,to:e,_isNavigate:!0})},this.beforeLoad=()=>{if(this.cancelMatches(),this.updateLatestLocation(),this.isServer){let o=this.buildLocation({to:this.latestLocation.pathname,search:!0,params:!0,hash:!0,state:!0,_includeValidateSearch:!0}),a=i=>{try{return encodeURI(decodeURI(i))}catch{return i}};if(Vt(a(this.latestLocation.href))!==Vt(a(o.href))){let i=o.url;throw this.origin&&i.startsWith(this.origin)&&(i=i.replace(this.origin,"")||"/"),Ac({href:i})}}let e=this.matchRoutes(this.latestLocation);this.__store.setState(o=>({...o,status:"pending",statusCode:200,isLoading:!0,location:this.latestLocation,pendingMatches:e,cachedMatches:o.cachedMatches.filter(a=>!e.some(i=>i.id===a.id))}))},this.load=async e=>{let o,a,i;for(i=new Promise(r=>{this.startTransition(async()=>{try{this.beforeLoad();let s=this.latestLocation,n=this.state.resolvedLocation;this.state.redirect||this.emit({type:"onBeforeNavigate",...it({resolvedLocation:n,location:s})}),this.emit({type:"onBeforeLoad",...it({resolvedLocation:n,location:s})}),await jc({router:this,sync:e?.sync,matches:this.state.pendingMatches,location:s,updateMatch:this.updateMatch,onReady:async()=>{this.startViewTransition(async()=>{let d,b,u;ht(()=>{this.__store.setState(m=>{let G=m.matches,p=m.pendingMatches||m.matches;return d=G.filter(X=>!p.some(h=>h.id===X.id)),b=p.filter(X=>!G.some(h=>h.id===X.id)),u=G.filter(X=>p.some(h=>h.id===X.id)),{...m,isLoading:!1,loadedAt:Date.now(),matches:p,pendingMatches:void 0,cachedMatches:[...m.cachedMatches,...d.filter(X=>X.status!=="error")]}}),this.clearExpiredCache()}),[[d,"onLeave"],[b,"onEnter"],[u,"onStay"]].forEach(([m,G])=>{m.forEach(p=>{this.looseRoutesById[p.routeId].options[G]?.(p)})})})}})}catch(s){j(s)?(o=s,this.isServer||this.navigate({...o.options,replace:!0,ignoreBlocker:!0})):z(s)&&(a=s),this.__store.setState(n=>({...n,statusCode:o?o.status:a?404:n.matches.some(d=>d.status==="error")?500:200,redirect:o}))}this.latestLoadPromise===i&&(this.commitLocationPromise?.resolve(),this.latestLoadPromise=void 0,this.commitLocationPromise=void 0),r()})}),this.latestLoadPromise=i,await i;this.latestLoadPromise&&i!==this.latestLoadPromise;)await this.latestLoadPromise;let l;this.hasNotFoundMatch()?l=404:this.__store.state.matches.some(r=>r.status==="error")&&(l=500),l!==void 0&&this.__store.setState(r=>({...r,statusCode:l}))},this.startViewTransition=e=>{let o=this.shouldViewTransition??this.options.defaultViewTransition;if(delete this.shouldViewTransition,o&&typeof document<"u"&&"startViewTransition"in document&&typeof document.startViewTransition=="function"){let a;if(typeof o=="object"&&this.isViewTransitionTypesSupported){let i=this.latestLocation,l=this.state.resolvedLocation,r=typeof o.types=="function"?o.types(it({resolvedLocation:l,location:i})):o.types;if(r===!1){e();return}a={update:e,types:r}}else a=e;document.startViewTransition(a)}else e()},this.updateMatch=(e,o)=>{let a=this.state.pendingMatches?.some(i=>i.id===e)?"pendingMatches":this.state.matches.some(i=>i.id===e)?"matches":this.state.cachedMatches.some(i=>i.id===e)?"cachedMatches":"";a&&this.__store.setState(i=>({...i,[a]:i[a]?.map(l=>l.id===e?o(l):l)}))},this.getMatch=e=>{let o=a=>a.id===e;return this.state.cachedMatches.find(o)??this.state.pendingMatches?.find(o)??this.state.matches.find(o)},this.invalidate=e=>{let o=a=>e?.filter?.(a)??!0?{...a,invalid:!0,...e?.forcePending||a.status==="error"?{status:"pending",error:void 0}:void 0}:a;return this.__store.setState(a=>({...a,matches:a.matches.map(o),cachedMatches:a.cachedMatches.map(o),pendingMatches:a.pendingMatches?.map(o)})),this.shouldViewTransition=!1,this.load({sync:e?.sync})},this.resolveRedirect=e=>{if(!e.options.href){let o=this.buildLocation(e.options),a=o.url;this.origin&&a.startsWith(this.origin)&&(a=a.replace(this.origin,"")||"/"),e.options.href=o.href,e.headers.set("Location",a)}return e.headers.get("Location")||e.headers.set("Location",e.options.href),e},this.clearCache=e=>{let o=e?.filter;o!==void 0?this.__store.setState(a=>({...a,cachedMatches:a.cachedMatches.filter(i=>!o(i))})):this.__store.setState(a=>({...a,cachedMatches:[]}))},this.clearExpiredCache=()=>{let e=o=>{let a=this.looseRoutesById[o.routeId];if(!a.options.loader)return!0;let i=(o.preload?a.options.preloadGcTime??this.options.defaultPreloadGcTime:a.options.gcTime??this.options.defaultGcTime)??300*1e3;return o.status==="error"?!0:Date.now()-o.updatedAt>=i};this.clearCache({filter:e})},this.loadRouteChunk=Tc,this.preloadRoute=async e=>{let o=this.buildLocation(e),a=this.matchRoutes(o,{throwOnError:!0,preload:!0,dest:e}),i=new Set([...this.state.matches,...this.state.pendingMatches??[]].map(r=>r.id)),l=new Set([...i,...this.state.cachedMatches.map(r=>r.id)]);ht(()=>{a.forEach(r=>{l.has(r.id)||this.__store.setState(s=>({...s,cachedMatches:[...s.cachedMatches,r]}))})});try{return a=await jc({router:this,matches:a,location:o,preload:!0,updateMatch:(r,s)=>{i.has(r)?a=a.map(n=>n.id===r?s(n):n):this.updateMatch(r,s)}}),a}catch(r){if(j(r))return r.options.reloadDocument?void 0:await this.preloadRoute({...r.options,_fromLocation:o});z(r)||console.error(r);return}},this.matchRoute=(e,o)=>{let a={...e,to:e.to?this.resolvePathWithBase(e.from||"",e.to):void 0,params:e.params||{},leaveParams:!0},i=this.buildLocation(a);if(o?.pending&&this.state.status!=="pending")return!1;let r=(o?.pending===void 0?!this.state.isLoading:o.pending)?this.latestLocation:this.state.resolvedLocation||this.state.location,s=he(r.pathname,{...o,to:i.pathname},this.parsePathnameCache);return!s||e.params&&!ot(s,e.params,{partial:!0})?!1:s&&(o?.includeSearch??!0)?ot(r.search,i.search,{partial:!0})?s:!1:s},this.hasNotFoundMatch=()=>this.__store.state.matches.some(e=>e.status==="notFound"||e.globalNotFound),this.update({defaultPreloadDelay:50,defaultPendingMs:1e3,defaultPendingMinMs:500,context:void 0,...c,caseSensitive:c.caseSensitive??!1,notFoundMode:c.notFoundMode??"fuzzy",stringifySearch:c.stringifySearch??ha,parseSearch:c.parseSearch??Xa}),typeof document<"u"&&(self.__TSR_ROUTER__=this)}isShell(){return!!this.options.isShell}isPrerendering(){return!!this.options.isPrerendering}get state(){return this.__store.state}get looseRoutesById(){return this.routesById}matchRoutesInternal(c,e){let{foundRoute:o,matchedRoutes:a,routeParams:i}=this.getMatchedRoutes(c.pathname,e?.dest?.to),l=!1;(o?o.path!=="/"&&i["**"]:K(c.pathname))&&(this.options.notFoundRoute?a.push(this.options.notFoundRoute):l=!0);let r=(()=>{if(l){if(this.options.notFoundMode!=="root")for(let d=a.length-1;d>=0;d--){let b=a[d];if(b.children)return b.id}return J}})(),s=[],n=d=>d?.id?d.context??this.options.context??void 0:this.options.context??void 0;return a.forEach((d,b)=>{let u=s[b-1],[m,G,p]=(()=>{let V=u?.search??c.search,bt=u?._strictSearch??void 0;try{let P=Pc(d.options.validateSearch,{...V})??void 0;return[{...V,...P},{...bt,...P},void 0]}catch(P){let Ft=P;if(P instanceof Nt||(Ft=new Nt(P.message,{cause:P})),e?.throwOnError)throw Ft;return[V,{},Ft]}})(),X=d.options.loaderDeps?.({search:m})??"",h=X?JSON.stringify(X):"",{interpolatedPath:R,usedParams:I}=Kt({path:d.fullPath,params:i,decodeCharMap:this.pathParamsDecodeCharMap}),v=Kt({path:d.id,params:i,leaveWildcards:!0,decodeCharMap:this.pathParamsDecodeCharMap,parseCache:this.parsePathnameCache}).interpolatedPath+h,H=this.getMatch(v),L=this.state.matches.find(V=>V.routeId===d.id),W=H?._strictParams??I,g;if(!H){let V=d.options.params?.parse??d.options.parseParams;if(V)try{Object.assign(W,V(W))}catch(bt){if(g=new tc(bt.message,{cause:bt}),e?.throwOnError)throw g}}Object.assign(i,W);let B=L?"stay":"enter",f;if(H)f={...H,cause:B,params:L?O(L.params,i):i,_strictParams:W,search:L?O(L.search,m):O(H.search,m),_strictSearch:G};else{let V=d.options.loader||d.options.beforeLoad||d.lazyFn||Ec(d)?"pending":"success";f={id:v,index:b,routeId:d.id,params:L?O(L.params,i):i,_strictParams:W,pathname:R,updatedAt:Date.now(),search:L?O(L.search,m):m,_strictSearch:G,searchError:void 0,status:V,isFetching:!1,error:void 0,paramsError:g,__routeContext:void 0,_nonReactive:{loadPromise:at()},__beforeLoadContext:void 0,context:{},abortController:new AbortController,fetchCount:0,cause:B,loaderDeps:L?O(L.loaderDeps,X):X,invalid:!1,preload:!1,links:void 0,scripts:void 0,headScripts:void 0,meta:void 0,staticData:d.options.staticData||{},fullPath:d.fullPath}}e?.preload||(f.globalNotFound=r===d.id),f.searchError=p;let C=n(u);f.context={...C,...f.__routeContext,...f.__beforeLoadContext},s.push(f)}),s.forEach((d,b)=>{let u=this.looseRoutesById[d.routeId];if(!this.getMatch(d.id)&&e?._buildLocation!==!0){let G=s[b-1],p=n(G);if(u.options.context){let X={deps:d.loaderDeps,params:d.params,context:p??{},location:c,navigate:h=>this.navigate({...h,_fromLocation:c}),buildLocation:this.buildLocation,cause:d.cause,abortController:d.abortController,preload:!!d.preload,matches:s};d.__routeContext=u.options.context(X)??void 0}d.context={...p,...d.__routeContext,...d.__beforeLoadContext}}}),s}},Nt=class extends Error{},tc=class extends Error{};function Ya(t){return{loadedAt:0,isLoading:!1,isTransitioning:!1,status:"idle",resolvedLocation:void 0,location:t,matches:[],pendingMatches:[],cachedMatches:[],statusCode:200}}function Pc(t,c){if(t==null)return{};if("~standard"in t){let e=t["~standard"].validate(c);if(e instanceof Promise)throw new Nt("Async validation not supported");if(e.issues)throw new Nt(JSON.stringify(e.issues,void 0,2),{cause:e});return e.value}return"parse"in t?t.parse(c):typeof t=="function"?t(c):{}}function Fa({pathname:t,routePathname:c,caseSensitive:e,routesByPath:o,routesById:a,flatRoutes:i,parseCache:l}){let r={},s=K(t),n=m=>he(s,{to:m.fullPath,caseSensitive:m.options?.caseSensitive??e,fuzzy:!0},l),d=c!==void 0?o[c]:void 0;if(d)r=n(d);else{let m;for(let G of i){let p=n(G);if(p)if(G.path!=="/"&&p["**"])m||(m={foundRoute:G,routeParams:p});else{d=G,r=p;break}}!d&&m&&(d=m.foundRoute,r=m.routeParams)}let b=d||a[J],u=[b];for(;b.parentRoute;)b=b.parentRoute,u.push(b);return u.reverse(),{matchedRoutes:u,routeParams:r,foundRoute:d}}function bs({search:t,dest:c,destRoutes:e,_includeValidateSearch:o}){let a=e.reduce((r,s)=>{let n=[];if("search"in s.options)s.options.search?.middlewares&&n.push(...s.options.search.middlewares);else if(s.options.preSearchFilters||s.options.postSearchFilters){let d=({search:b,next:u})=>{let m=b;"preSearchFilters"in s.options&&s.options.preSearchFilters&&(m=s.options.preSearchFilters.reduce((p,X)=>X(p),b));let G=u(m);return"postSearchFilters"in s.options&&s.options.postSearchFilters?s.options.postSearchFilters.reduce((p,X)=>X(p),G):G};n.push(d)}if(o&&s.options.validateSearch){let d=({search:b,next:u})=>{let m=u(b);try{return{...m,...Pc(s.options.validateSearch,m)??void 0}}catch{return m}};n.push(d)}return r.concat(n)},[])??[],i=({search:r})=>c.search?c.search===!0?r:$(c.search,r):{};a.push(i);let l=(r,s)=>{if(r>=a.length)return s;let n=a[r];return n({search:s,next:b=>l(r+1,b)})};return l(0,t)}var qc="Error preloading route! \u261D\uFE0F";var Pt=class{constructor(c){if(this.init=e=>{this.originalIndex=e.originalIndex;let o=this.options,a=!o?.path&&!o?.id;this.parentRoute=this.options.getParentRoute?.(),a?this._path=J:this.parentRoute||A(!1,"Child Route instances must pass a 'getParentRoute: () => ParentRoute' option that returns a Route instance.");let i=a?J:o?.path;i&&i!=="/"&&(i=Et(i));let l=o?.id||i,r=a?J:E([this.parentRoute.id===J?"":this.parentRoute.id,l]);i===J&&(i="/"),r!==J&&(r=E(["/",r]));let s=r===J?"/":E([this.parentRoute.fullPath,i]);this._path=i,this._id=r,this._fullPath=s,this._to=s},this.clone=e=>{this._path=e._path,this._id=e._id,this._fullPath=e._fullPath,this._to=e._to,this.options.getParentRoute=e.options.getParentRoute,this.children=e.children},this.addChildren=e=>this._addFileChildren(e),this._addFileChildren=e=>(Array.isArray(e)&&(this.children=e),typeof e=="object"&&e!==null&&(this.children=Object.values(e)),this),this._addFileTypes=()=>this,this.updateLoader=e=>(Object.assign(this.options,e),this),this.update=e=>(Object.assign(this.options,e),this),this.lazy=e=>(this.lazyFn=e,this),this.options=c||{},this.isRoot=!c?.getParentRoute,c?.id&&c?.path)throw new Error("Route cannot have both an 'id' and a 'path' option.")}get to(){return this._to}get id(){return this._id}get path(){return this._path}get fullPath(){return this._fullPath}};var Re=class extends Pt{constructor(c){super(c)}};var et=Z(y(),1),qt=Z(U(),1);function $t(t){let c=t.errorComponent??te;return(0,et.jsx)($c,{getResetKey:t.getResetKey,onCatch:t.onCatch,children:({error:e,reset:o})=>e?qt.createElement(c,{error:e,reset:o}):t.children})}var $c=class extends qt.Component{constructor(){super(...arguments),this.state={error:null}}static getDerivedStateFromProps(c){return{resetKey:c.getResetKey()}}static getDerivedStateFromError(c){return{error:c}}reset(){this.setState({error:null})}componentDidUpdate(c,e){e.error&&e.resetKey!==this.state.resetKey&&this.reset()}componentDidCatch(c,e){this.props.onCatch&&this.props.onCatch(c,e)}render(){return this.props.children({error:this.state.resetKey!==this.props.getResetKey()?null:this.state.error,reset:()=>{this.reset()}})}};function te({error:t}){let[c,e]=qt.useState(!1);return(0,et.jsxs)("div",{style:{padding:".5rem",maxWidth:"100%"},children:[(0,et.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:".5rem"},children:[(0,et.jsx)("strong",{style:{fontSize:"1rem"},children:"Something went wrong!"}),(0,et.jsx)("button",{style:{appearance:"none",fontSize:".6em",border:"1px solid currentColor",padding:".1rem .2rem",fontWeight:"bold",borderRadius:".25rem"},onClick:()=>e(o=>!o),children:c?"Hide Error":"Show Error"})]}),(0,et.jsx)("div",{style:{height:".25rem"}}),c?(0,et.jsx)("div",{children:(0,et.jsx)("pre",{style:{fontSize:".7em",border:"1px solid red",borderRadius:".25rem",padding:".3rem",color:"red",overflow:"auto"},children:t.message?(0,et.jsx)("code",{children:t.message}):null})}):null]})}var to=Z(y(),1),ec=Z(U(),1);function Ca({children:t,fallback:c=null}){return Gs()?(0,to.jsx)(ec.default.Fragment,{children:t}):(0,to.jsx)(ec.default.Fragment,{children:c})}function Gs(){return ec.default.useSyncExternalStore(Zs,()=>!0,()=>!1)}function Zs(){return()=>{}}var ps=!0;function gs(t,c){if(!ps){if(t)return;var e="Warning: "+c;typeof console<"u"&&console.warn(e);try{throw Error(e)}catch{}}}var Zt=gs;var lo=Z(y(),1);var so=Z(U(),1);var Ka=Z(U(),1);var Oa=Z(za(),1);function Da(t,c=o=>o,e={}){let o=e.equal??Ns;return(0,Oa.useSyncExternalStoreWithSelector)(t.subscribe,()=>t.state,()=>t.state,c,o)}function Ns(t,c){if(Object.is(t,c))return!0;if(typeof t!="object"||t===null||typeof c!="object"||c===null)return!1;if(t instanceof Map&&c instanceof Map){if(t.size!==c.size)return!1;for(let[o,a]of t)if(!c.has(o)||!Object.is(a,c.get(o)))return!1;return!0}if(t instanceof Set&&c instanceof Set){if(t.size!==c.size)return!1;for(let o of t)if(!c.has(o))return!1;return!0}if(t instanceof Date&&c instanceof Date)return t.getTime()===c.getTime();let e=Sa(t);if(e.length!==Sa(c).length)return!1;for(let o=0;o<e.length;o++)if(!Object.prototype.hasOwnProperty.call(c,e[o])||!Object.is(t[e[o]],c[e[o]]))return!1;return!0}function Sa(t){return Object.keys(t).concat(Object.getOwnPropertySymbols(t))}var Ta=Z(U(),1);var ja=Z(U(),1);var Aa=Z(U(),1),co=Aa.createContext(null);function oc(){return typeof document>"u"?co:window.__TSR_ROUTER_CONTEXT__?window.__TSR_ROUTER_CONTEXT__:(window.__TSR_ROUTER_CONTEXT__=co,co)}function x(t){let c=ja.useContext(oc());return Zt(!((t?.warn??!0)&&!c),"useRouter must be used inside a <RouterProvider> component!"),c}function F(t){let c=x({warn:t?.router===void 0}),e=t?.router||c,o=(0,Ta.useRef)(void 0);return Da(e.__store,a=>{if(t?.select){if(t.structuralSharing??e.options.defaultStructuralSharing){let i=O(o.current,t.select(a));return o.current=i,i}return t.select(a)}return a})}var oo=Z(U(),1),Jt=oo.createContext(void 0),Ea=oo.createContext(void 0);function S(t){let c=Ka.useContext(t.from?Ea:Jt);return F({select:o=>{let a=o.matches.find(i=>t.from?t.from===i.routeId:i.id===c);if(A(!((t.shouldThrow??!0)&&!a),`Could not find ${t.from?`an active match from "${t.from}"`:"a nearest match!"}`),a!==void 0)return t.select?t.select(a):a},structuralSharing:t.structuralSharing})}function ve(t){return S({from:t.from,strict:t.strict,structuralSharing:t.structuralSharing,select:c=>t.select?t.select(c.loaderData):c.loaderData})}function Le(t){let{select:c,...e}=t;return S({...e,select:o=>c?c(o.loaderDeps):o.loaderDeps})}function xe(t){return S({from:t.from,shouldThrow:t.shouldThrow,structuralSharing:t.structuralSharing,strict:t.strict,select:c=>{let e=t.strict===!1?c.params:c._strictParams;return t.select?t.select(e):e}})}function Ye(t){return S({from:t.from,strict:t.strict,shouldThrow:t.shouldThrow,structuralSharing:t.structuralSharing,select:c=>t.select?t.select(c.search):c.search})}var ac=Z(U(),1);function Fe(t){let c=x();return ac.useCallback(e=>c.navigate({...e,from:e.from??t?.from}),[t?.from,c])}var ti=Z(y(),1),Q=Z(U(),1),ei=Z(Pa(),1);var lt=Z(U(),1);var we=typeof window<"u"?lt.useLayoutEffect:lt.useEffect;function ic(t){let c=lt.useRef({value:t,prev:null}),e=c.current.value;return t!==e&&(c.current={value:t,prev:e}),c.current.prev}function qa(t,c,e={},o={}){lt.useEffect(()=>{if(!t.current||o.disabled||typeof IntersectionObserver!="function")return;let a=new IntersectionObserver(([i])=>{c(i)},e);return a.observe(t.current),()=>{a.disconnect()}},[c,e,o.disabled,t])}function $a(t){let c=lt.useRef(null);return lt.useImperativeHandle(t,()=>c.current,[]),c}function ci(t,c){let e=x(),[o,a]=Q.useState(!1),i=Q.useRef(!1),l=$a(c),{activeProps:r,inactiveProps:s,activeOptions:n,to:d,preload:b,preloadDelay:u,hashScrollIntoView:m,replace:G,startTransition:p,resetScroll:X,viewTransition:h,children:R,target:I,disabled:v,style:H,className:L,onClick:W,onFocus:g,onMouseEnter:B,onMouseLeave:f,onTouchStart:C,ignoreBlocker:V,params:bt,search:P,hash:Ft,state:jo,mask:gl,reloadDocument:Lr,unsafeRelative:xr,from:Yr,_fromLocation:Fr,...To}=t,Xl=F({select:Y=>Y.location.search,structuralSharing:!0}),Eo=t.from,ne=Q.useMemo(()=>({...t,from:Eo}),[e,Xl,Eo,t._fromLocation,t.hash,t.to,t.search,t.params,t.state,t.mask,t.unsafeRelative]),ut=Q.useMemo(()=>e.buildLocation({...ne}),[e,ne]),Se=Q.useMemo(()=>{if(v)return;let Y=ut.maskedLocation?ut.maskedLocation.url:ut.url,M=!1;return e.origin&&(Y.startsWith(e.origin)?Y=e.history.createHref(Y.replace(e.origin,""))||"/":M=!0),{href:Y,external:M}},[v,ut.maskedLocation,ut.url,e.origin,e.history]),Oe=Q.useMemo(()=>{if(Se?.external)return Se.href;try{return new URL(d),d}catch{}},[d,Se]),Dt=t.reloadDocument||Oe?!1:b??e.options.defaultPreload,Hc=u??e.options.defaultPreloadDelay??0,Cc=F({select:Y=>{if(Oe)return!1;if(n?.exact){if(!Uc(Y.location.pathname,ut.pathname,e.basepath))return!1}else{let M=Tt(Y.location.pathname,e.basepath),q=Tt(ut.pathname,e.basepath);if(!(M.startsWith(q)&&(M.length===q.length||M[q.length]==="/")))return!1}return(n?.includeSearch??!0)&&!ot(Y.location.search,ut.search,{partial:!n?.exact,ignoreUndefined:!n?.explicitUndefined})?!1:n?.includeHash?Y.location.hash===ut.hash:!0}}),wt=Q.useCallback(()=>{e.preloadRoute({...ne}).catch(Y=>{console.warn(Y),console.warn(qc)})},[e,ne]),hl=Q.useCallback(Y=>{Y?.isIntersecting&&wt()},[wt]);qa(l,hl,Us,{disabled:!!v||Dt!=="viewport"}),Q.useEffect(()=>{i.current||!v&&Dt==="render"&&(wt(),i.current=!0)},[v,wt,Dt]);let Wl=Y=>{let M=Y.currentTarget.getAttribute("target"),q=I!==void 0?I:M;if(!v&&!zs(Y)&&!Y.defaultPrevented&&(!q||q==="_self")&&Y.button===0){Y.preventDefault(),(0,ei.flushSync)(()=>{a(!0)});let qo=e.subscribe("onResolved",()=>{qo(),a(!1)});e.navigate({...ne,replace:G,resetScroll:X,hashScrollIntoView:m,startTransition:p,viewTransition:h,ignoreBlocker:V})}};if(Oe)return{...To,ref:l,href:Oe,...R&&{children:R},...I&&{target:I},...v&&{disabled:v},...H&&{style:H},...L&&{className:L},...W&&{onClick:W},...g&&{onFocus:g},...B&&{onMouseEnter:B},...f&&{onMouseLeave:f},...C&&{onTouchStart:C}};let Ko=Y=>{v||Dt&&wt()},yl=Ko,Il=Y=>{if(!(v||!Dt))if(!Hc)wt();else{let M=Y.target;if(He.has(M))return;let q=setTimeout(()=>{He.delete(M),wt()},Hc);He.set(M,q)}},Bl=Y=>{if(v||!Dt||!Hc)return;let M=Y.target,q=He.get(M);q&&(clearTimeout(q),He.delete(M))},De=Cc?$(r,{})??Js:ao,Ae=Cc?ao:$(s,{})??ao,_o=[L,De.className,Ae.className].filter(Boolean).join(" "),Po=(H||De.style||Ae.style)&&{...H,...De.style,...Ae.style};return{...To,...De,...Ae,href:Se?.href,ref:l,onClick:Ce([W,Wl]),onFocus:Ce([g,Ko]),onMouseEnter:Ce([B,Il]),onMouseLeave:Ce([f,Bl]),onTouchStart:Ce([C,yl]),disabled:!!v,target:I,...Po&&{style:Po},..._o&&{className:_o},...v&&Qs,...Cc&&ks,...o&&Ms}}var ao={},Js={className:"active"},Qs={role:"link","aria-disabled":!0},ks={"data-status":"active","aria-current":"page"},Ms={"data-transitioning":"transitioning"},He=new WeakMap,Us={rootMargin:"100px"},Ce=t=>c=>{for(let e of t)if(e){if(c.defaultPrevented)return;e(c)}};function io(t){return Q.forwardRef(function(e,o){return(0,ti.jsx)(Qt,{...e,_asChild:t,ref:o})})}var Qt=Q.forwardRef((t,c)=>{let{_asChild:e,...o}=t,{type:a,ref:i,...l}=ci(o,c),r=typeof o.children=="function"?o.children({isActive:l["data-status"]==="active"}):o.children;return e===void 0&&delete l.disabled,Q.createElement(e||"a",{...l,ref:i},r)});function zs(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}var lc=class extends Pt{constructor(c){super(c),this.useMatch=e=>S({select:e?.select,from:this.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>S({...e,from:this.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>Ye({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useParams=e=>xe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useLoaderDeps=e=>Le({...e,from:this.id}),this.useLoaderData=e=>ve({...e,from:this.id}),this.useNavigate=()=>Fe({from:this.fullPath}),this.Link=so.default.forwardRef((e,o)=>(0,lo.jsx)(Qt,{ref:o,from:this.fullPath,...e})),this.$$typeof=Symbol.for("react.memo")}};function Ve(t){return new lc(t)}var sc=class extends Re{constructor(c){super(c),this.useMatch=e=>S({select:e?.select,from:this.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>S({...e,from:this.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>Ye({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useParams=e=>xe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useLoaderDeps=e=>Le({...e,from:this.id}),this.useLoaderData=e=>ve({...e,from:this.id}),this.useNavigate=()=>Fe({from:this.fullPath}),this.Link=so.default.forwardRef((e,o)=>(0,lo.jsx)(Qt,{ref:o,from:this.fullPath,...e})),this.$$typeof=Symbol.for("react.memo")}};function ro(t){return new sc(t)}function no(t){return typeof t=="object"?new rc(t,{silent:!0}).createRoute(t):new rc(t,{silent:!0}).createRoute}var rc=class{constructor(c,e){this.path=c,this.createRoute=o=>{Zt(this.silent,"FileRoute is deprecated and will be removed in the next major version. Use the createFileRoute(path)(options) function instead.");let a=Ve(o);return a.isRoot=!1,a},this.silent=e?.silent}};var dc=class{constructor(c){this.useMatch=e=>S({select:e?.select,from:this.options.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>S({from:this.options.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>Ye({select:e?.select,structuralSharing:e?.structuralSharing,from:this.options.id}),this.useParams=e=>xe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.options.id}),this.useLoaderDeps=e=>Le({...e,from:this.options.id}),this.useLoaderData=e=>ve({...e,from:this.options.id}),this.useNavigate=()=>{let e=x();return Fe({from:e.routesById[this.options.id].fullPath})},this.options=c,this.$$typeof=Symbol.for("react.memo")}};function bo(t){return typeof t=="object"?new dc(t):c=>new dc({id:t,...c})}var st=Z(y(),1),Gc=Z(U(),1);var ft=Z(U(),1);function oi(){let t=x(),c=ft.useRef({router:t,mounted:!1}),[e,o]=ft.useState(!1),{hasPendingMatches:a,isLoading:i}=F({select:b=>({isLoading:b.isLoading,hasPendingMatches:b.matches.some(u=>u.status==="pending")}),structuralSharing:!0}),l=ic(i),r=i||e||a,s=ic(r),n=i||a,d=ic(n);return t.startTransition=b=>{o(!0),ft.startTransition(()=>{b(),o(!1)})},ft.useEffect(()=>{let b=t.history.subscribe(t.load),u=t.buildLocation({to:t.latestLocation.pathname,search:!0,params:!0,hash:!0,state:!0,_includeValidateSearch:!0});return K(t.latestLocation.href)!==K(u.href)&&t.commitLocation({...u,replace:!0}),()=>{b()}},[t,t.history]),we(()=>{if(typeof window<"u"&&t.ssr||c.current.router===t&&c.current.mounted)return;c.current={router:t,mounted:!0},(async()=>{try{await t.load()}catch(u){console.error(u)}})()},[t]),we(()=>{l&&!i&&t.emit({type:"onLoad",...it(t.state)})},[l,t,i]),we(()=>{d&&!n&&t.emit({type:"onBeforeRouteMount",...it(t.state)})},[n,d,t]),we(()=>{s&&!r&&(t.emit({type:"onResolved",...it(t.state)}),t.__store.setState(b=>({...b,status:"idle",resolvedLocation:b.location})),Oc(t))},[r,s,t]),null}var w=Z(y(),1),D=Z(U(),1);var uo=Z(y(),1);function ai(t){let c=F({select:e=>`not-found-${e.location.pathname}-${e.status}`});return(0,uo.jsx)($t,{getResetKey:()=>c,onCatch:(e,o)=>{if(z(e))t.onCatch?.(e,o);else throw e},errorComponent:({error:e})=>{if(z(e))return t.fallback?.(e);throw e},children:t.children})}function ii(){return(0,uo.jsx)("p",{children:"Not Found"})}var nc=Z(y(),1);function Rt(t){return(0,nc.jsx)(nc.Fragment,{children:t.children})}var bc=Z(y(),1);function mo(t,c,e){return c.options.notFoundComponent?(0,bc.jsx)(c.options.notFoundComponent,{data:e}):t.options.defaultNotFoundComponent?(0,bc.jsx)(t.options.defaultNotFoundComponent,{data:e}):(0,bc.jsx)(ii,{})}var ri=Z(y(),1);var li=Z(y(),1);function si({children:t}){let c=x();return c.isServer?(0,li.jsx)("script",{nonce:c.options.ssr?.nonce,className:"$tsr",dangerouslySetInnerHTML:{__html:[t].filter(Boolean).join(`
`)+";$_TSR.c()"}}):null}function di(){let t=x();if(!t.isScrollRestoring||!t.isServer||typeof t.options.scrollRestoration=="function"&&!t.options.scrollRestoration({location:t.latestLocation}))return null;let e=(t.options.getScrollRestorationKey||ye)(t.latestLocation),o=e!==ye(t.latestLocation)?e:void 0,a={storageKey:_t,shouldScrollRestoration:!0};return o&&(a.key=o),(0,ri.jsx)(si,{children:`(${_e.toString()})(${JSON.stringify(a)})`})}var uc=D.memo(function({matchId:c}){let e=x(),o=F({select:h=>{let R=h.matches.find(I=>I.id===c);return A(R,`Could not find match for matchId "${c}". Please file an issue!`),{routeId:R.routeId,ssr:R.ssr,_displayPending:R._displayPending}},structuralSharing:!0}),a=e.routesById[o.routeId],i=a.options.pendingComponent??e.options.defaultPendingComponent,l=i?(0,w.jsx)(i,{}):null,r=a.options.errorComponent??e.options.defaultErrorComponent,s=a.options.onCatch??e.options.defaultOnCatch,n=a.isRoot?a.options.notFoundComponent??e.options.notFoundRoute?.options.component:a.options.notFoundComponent,d=o.ssr===!1||o.ssr==="data-only",b=(!a.isRoot||a.options.wrapInSuspense||d)&&(a.options.wrapInSuspense??i??(a.options.errorComponent?.preload||d))?D.Suspense:Rt,u=r?$t:Rt,m=n?ai:Rt,G=F({select:h=>h.loadedAt}),p=F({select:h=>{let R=h.matches.findIndex(I=>I.id===c);return h.matches[R-1]?.routeId}}),X=a.isRoot?a.options.shellComponent??Rt:Rt;return(0,w.jsxs)(X,{children:[(0,w.jsx)(Jt.Provider,{value:c,children:(0,w.jsx)(b,{fallback:l,children:(0,w.jsx)(u,{getResetKey:()=>G,errorComponent:r||te,onCatch:(h,R)=>{if(z(h))throw h;Zt(!1,`Error in route match: ${c}`),s?.(h,R)},children:(0,w.jsx)(m,{fallback:h=>{if(!n||h.routeId&&h.routeId!==o.routeId||!h.routeId&&!a.isRoot)throw h;return D.createElement(n,h)},children:d||o._displayPending?(0,w.jsx)(Ca,{fallback:l,children:(0,w.jsx)(ni,{matchId:c})}):(0,w.jsx)(ni,{matchId:c})})})})}),p===J&&e.options.scrollRestoration?(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(Ss,{}),(0,w.jsx)(di,{})]}):null]})});function Ss(){let t=x(),c=D.useRef(void 0);return(0,w.jsx)("script",{suppressHydrationWarning:!0,ref:e=>{e&&(c.current===void 0||c.current.href!==t.latestLocation.href)&&(t.emit({type:"onRendered",...it(t.state)}),c.current=t.latestLocation)}},t.latestLocation.state.__TSR_key)}var ni=D.memo(function({matchId:c}){let e=x(),{match:o,key:a,routeId:i}=F({select:s=>{let n=s.matches.find(G=>G.id===c),d=n.routeId,u=(e.routesById[d].options.remountDeps??e.options.defaultRemountDeps)?.({routeId:d,loaderDeps:n.loaderDeps,params:n._strictParams,search:n._strictSearch});return{key:u?JSON.stringify(u):void 0,routeId:d,match:{id:n.id,status:n.status,error:n.error,_forcePending:n._forcePending,_displayPending:n._displayPending}}},structuralSharing:!0}),l=e.routesById[i],r=D.useMemo(()=>{let s=l.options.component??e.options.defaultComponent;return s?(0,w.jsx)(s,{},a):(0,w.jsx)(mc,{})},[a,l.options.component,e.options.defaultComponent]);if(o._displayPending)throw e.getMatch(o.id)?._nonReactive.displayPendingPromise;if(o._forcePending)throw e.getMatch(o.id)?._nonReactive.minPendingPromise;if(o.status==="pending"){let s=l.options.pendingMinMs??e.options.defaultPendingMinMs;if(s){let n=e.getMatch(o.id);if(n&&!n._nonReactive.minPendingPromise&&!e.isServer){let d=at();n._nonReactive.minPendingPromise=d,setTimeout(()=>{d.resolve(),n._nonReactive.minPendingPromise=void 0},s)}}throw e.getMatch(o.id)?._nonReactive.loadPromise}if(o.status==="notFound")return A(z(o.error),"Expected a notFound error"),mo(e,l,o.error);if(o.status==="redirected")throw A(j(o.error),"Expected a redirect error"),e.getMatch(o.id)?._nonReactive.loadPromise;if(o.status==="error"){if(e.isServer){let s=(l.options.errorComponent??e.options.defaultErrorComponent)||te;return(0,w.jsx)(s,{error:o.error,reset:void 0,info:{componentStack:""}})}throw o.error}return r}),mc=D.memo(function(){let c=x(),e=D.useContext(Jt),o=F({select:n=>n.matches.find(d=>d.id===e)?.routeId}),a=c.routesById[o],i=F({select:n=>{let b=n.matches.find(u=>u.id===e);return A(b,`Could not find parent match for matchId "${e}"`),b.globalNotFound}}),l=F({select:n=>{let d=n.matches,b=d.findIndex(u=>u.id===e);return d[b+1]?.id}}),r=c.options.defaultPendingComponent?(0,w.jsx)(c.options.defaultPendingComponent,{}):null;if(i)return mo(c,a,void 0);if(!l)return null;let s=(0,w.jsx)(uc,{matchId:l});return e===J?(0,w.jsx)(D.Suspense,{fallback:r,children:s}):s});function Go(){let t=x(),e=t.routesById[J].options.pendingComponent??t.options.defaultPendingComponent,o=e?(0,st.jsx)(e,{}):null,a=t.isServer||typeof document<"u"&&t.ssr?Rt:Gc.Suspense,i=(0,st.jsxs)(a,{fallback:o,children:[!t.isServer&&(0,st.jsx)(oi,{}),(0,st.jsx)(Os,{})]});return t.options.InnerWrap?(0,st.jsx)(t.options.InnerWrap,{children:i}):i}function Os(){let t=x(),c=F({select:a=>a.matches[0]?.id}),e=F({select:a=>a.loadedAt}),o=c?(0,st.jsx)(uc,{matchId:c}):null;return(0,st.jsx)(Jt.Provider,{value:c,children:t.options.disableGlobalCatchBoundary?o:(0,st.jsx)($t,{getResetKey:()=>e,errorComponent:te,onCatch:a=>{Zt(!1,"The following error wasn't caught by any route! At the very least, consider setting an 'errorComponent' in your RootRoute!"),Zt(!1,a.message||a.toString())},children:o})})}function Zo(t){return F({select:c=>{let e=c.matches;return t?.select?t.select(e):e},structuralSharing:t?.structuralSharing})}var po=t=>new Zc(t),Zc=class extends fe{constructor(c){super(c)}};typeof globalThis<"u"?(globalThis.createFileRoute=no,globalThis.createLazyFileRoute=bo):typeof window<"u"&&(window.createFileRoute=no,window.createLazyFileRoute=bo);var Ne=Z(y(),1);function bi({router:t,children:c,...e}){Object.keys(e).length>0&&t.update({...t.options,...e,context:{...t.options.context,...e.context}});let o=oc(),a=(0,Ne.jsx)(o.Provider,{value:t,children:c});return t.options.Wrap?(0,Ne.jsx)(t.options.Wrap,{children:a}):a}function go({router:t,...c}){return(0,Ne.jsx)(bi,{router:t,...c,children:(0,Ne.jsx)(Go,{})})}function Xo(){return F({select:t=>t.location.state.__TSR_index!==0})}var Ao=Z(kt()),Ot=Z(mt());function mi(t){var c,e,o="";if(typeof t=="string"||typeof t=="number")o+=t;else if(typeof t=="object")if(Array.isArray(t)){var a=t.length;for(c=0;c<a;c++)t[c]&&(e=mi(t[c]))&&(o&&(o+=" "),o+=e)}else for(e in t)t[e]&&(o&&(o+=" "),o+=e);return o}function Ds(){for(var t,c,e=0,o="",a=arguments.length;e<a;e++)(t=arguments[e])&&(c=mi(t))&&(o&&(o+=" "),o+=c);return o}var T=Ds;var Gi=Z(mt()),Zi=Z(y()),pi=(0,Gi.forwardRef)(({children:t,className:c,ariaLabel:e,as:o="div",...a},i)=>(0,Zi.jsx)(o,{ref:i,className:T("admin-ui-navigable-region",c),"aria-label":e,role:"region",tabIndex:"-1",...a,children:t}));pi.displayName="NavigableRegion";var gi=pi;var vt=Z(pt()),Lt=Z(y());function hi({breadcrumbs:t,badges:c,title:e,subTitle:o,actions:a}){return(0,Lt.jsxs)(vt.__experimentalVStack,{className:"admin-ui-page__header",as:"header",children:[(0,Lt.jsxs)(vt.__experimentalHStack,{className:"admin-ui-page__header-title",justify:"space-between",spacing:2,children:[(0,Lt.jsxs)(vt.__experimentalHStack,{spacing:2,children:[e&&(0,Lt.jsx)(vt.__experimentalHeading,{as:"h2",level:3,weight:500,truncate:!0,children:e}),t,c]}),(0,Lt.jsx)(vt.__experimentalHStack,{style:{width:"auto",flexShrink:0},spacing:2,className:"admin-ui-page__header-actions",children:a})]}),o&&(0,Lt.jsx)("p",{className:"admin-ui-page__header-subtitle",children:o})]})}var Je=Z(y());function As({breadcrumbs:t,badges:c,title:e,subTitle:o,children:a,className:i,actions:l,hasPadding:r=!1}){let s=T("admin-ui-page",i);return(0,Je.jsxs)(gi,{className:s,ariaLabel:e,children:[(e||t||c)&&(0,Je.jsx)(hi,{breadcrumbs:t,badges:c,title:e,subTitle:o,actions:l}),r?(0,Je.jsx)("div",{className:"admin-ui-page__content has-padding",children:a}):a]})}var ce=As;var ul=Z(ho()),ml=Z(Ii());var fc=Z(Xt()),oe=Z(pt()),Qo=Z(kt()),Ji=Z(Wo()),Qi=Z(Ri());var pc=Z(mt()),yo=(0,pc.forwardRef)(({icon:t,size:c=24,...e},o)=>(0,pc.cloneElement)(t,{width:c,height:c,...e,ref:o}));var gc=Z(gt()),Io=Z(y()),Bo=(0,Io.jsx)(gc.SVG,{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:(0,Io.jsx)(gc.Path,{d:"m15.99 10.889-3.988 3.418-3.988-3.418.976-1.14 3.012 2.582 3.012-2.581.976 1.139Z"})});var Xc=Z(gt()),fo=Z(y()),Ro=(0,fo.jsx)(Xc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,fo.jsx)(Xc.Path,{d:"m13.1 16-3.4-4 3.4-4 1.1 1-2.6 3 2.6 3-1.1 1z"})});var hc=Z(gt()),vo=Z(y()),Lo=(0,vo.jsx)(hc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,vo.jsx)(hc.Path,{d:"M14.6 7l-1.2-1L8 12l5.4 6 1.2-1-4.6-5z"})});var Wc=Z(gt()),xo=Z(y()),Yo=(0,xo.jsx)(Wc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,xo.jsx)(Wc.Path,{d:"M10.8622 8.04053L14.2805 12.0286L10.8622 16.0167L9.72327 15.0405L12.3049 12.0286L9.72327 9.01672L10.8622 8.04053Z"})});var yc=Z(gt()),Fo=Z(y()),wo=(0,Fo.jsx)(yc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,Fo.jsx)(yc.Path,{d:"M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z"})});var Ic=Z(gt()),Ho=Z(y()),Co=(0,Ho.jsx)(Ic.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,Ho.jsx)(Ic.Path,{d:"M13 5c-3.3 0-6 2.7-6 6 0 1.4.5 2.7 1.3 3.7l-3.8 3.8 1.1 1.1 3.8-3.8c1 .8 2.3 1.3 3.7 1.3 3.3 0 6-2.7 6-6S16.3 5 13 5zm0 10.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z"})});var Bc=Z(gt()),Vo=Z(y()),No=(0,Vo.jsx)(Bc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"-2 -2 24 24",children:(0,Vo.jsx)(Bc.Path,{d:"M20 10c0-5.51-4.49-10-10-10C4.48 0 0 4.49 0 10c0 5.52 4.48 10 10 10 5.51 0 10-4.48 10-10zM7.78 15.37L4.37 6.22c.55-.02 1.17-.08 1.17-.08.5-.06.44-1.13-.06-1.11 0 0-1.45.11-2.37.11-.18 0-.37 0-.58-.01C4.12 2.69 6.87 1.11 10 1.11c2.33 0 4.45.87 6.05 2.34-.68-.11-1.65.39-1.65 1.58 0 .74.45 1.36.9 2.1.35.61.55 1.36.55 2.46 0 1.49-1.4 5-1.4 5l-3.03-8.37c.54-.02.82-.17.82-.17.5-.05.44-1.25-.06-1.22 0 0-1.44.12-2.38.12-.87 0-2.33-.12-2.33-.12-.5-.03-.56 1.2-.06 1.22l.92.08 1.26 3.41zM17.41 10c.24-.64.74-1.87.43-4.25.7 1.29 1.05 2.71 1.05 4.25 0 3.29-1.73 6.24-4.4 7.78.97-2.59 1.94-5.2 2.92-7.78zM6.1 18.09C3.12 16.65 1.11 13.53 1.11 10c0-1.3.23-2.48.72-3.59C3.25 10.3 4.67 14.2 6.1 18.09zm4.03-6.63l2.58 6.98c-.86.29-1.76.45-2.71.45-.79 0-1.57-.11-2.29-.33.81-2.38 1.62-4.74 2.42-7.1z"})});var ki=Z(xi()),Mi=Z(ho()),Ui=Z(Fi());var wi=Z(Xt());var Hi=Z(kt()),Ci=Z(Wo()),Qe=Z(y()),js=`/**
 * SCSS Variables.
 *
