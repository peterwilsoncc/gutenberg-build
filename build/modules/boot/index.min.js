var Bl=Object.create;var xc=Object.defineProperty;var Il=Object.getOwnPropertyDescriptor;var fl=Object.getOwnPropertyNames;var Rl=Object.getPrototypeOf,vl=Object.prototype.hasOwnProperty;var N=(t,c)=>()=>(c||t((c={exports:{}}).exports,c),c.exports),To=(t,c)=>{for(var e in c)xc(t,e,{get:c[e],enumerable:!0})},Ll=(t,c,e,o)=>{if(c&&typeof c=="object"||typeof c=="function")for(let a of fl(c))!vl.call(t,a)&&a!==e&&xc(t,a,{get:()=>c[a],enumerable:!(o=Il(c,a))||o.enumerable});return t};var G=(t,c,e)=>(e=t!=null?Bl(Rl(t)):{},Ll(c||!t||!t.__esModule?xc(e,"default",{value:t,enumerable:!0}):e,t));var gt=N((Lr,Eo)=>{Eo.exports=window.wp.element});var Xt=N((xr,Ko)=>{Ko.exports=window.wp.data});var y=N((Ad,va)=>{va.exports=window.ReactJSXRuntime});var M=N((jd,La)=>{La.exports=window.React});var Fa=N(Ya=>{"use strict";var qt=M();function ps(t,c){return t===c&&(t!==0||1/t===1/c)||t!==t&&c!==c}var gs=typeof Object.is=="function"?Object.is:ps,Xs=qt.useState,hs=qt.useEffect,Ws=qt.useLayoutEffect,ys=qt.useDebugValue;function Bs(t,c){var e=c(),o=Xs({inst:{value:e,getSnapshot:c}}),a=o[0].inst,i=o[1];return Ws(function(){a.value=e,a.getSnapshot=c,Ec(a)&&i({inst:a})},[t,e,c]),hs(function(){return Ec(a)&&i({inst:a}),t(function(){Ec(a)&&i({inst:a})})},[t]),ys(e),e}function Ec(t){var c=t.getSnapshot;t=t.value;try{var e=c();return!gs(t,e)}catch{return!0}}function Is(t,c){return c()}var fs=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?Is:Bs;Ya.useSyncExternalStore=qt.useSyncExternalStore!==void 0?qt.useSyncExternalStore:fs});var Ha=N((Pd,wa)=>{"use strict";wa.exports=Fa()});var Va=N(Ca=>{"use strict";var Ke=M(),Rs=Ha();function vs(t,c){return t===c&&(t!==0||1/t===1/c)||t!==t&&c!==c}var Ls=typeof Object.is=="function"?Object.is:vs,xs=Rs.useSyncExternalStore,Ys=Ke.useRef,Fs=Ke.useEffect,ws=Ke.useMemo,Hs=Ke.useDebugValue;Ca.useSyncExternalStoreWithSelector=function(t,c,e,o,a){var i=Ys(null);if(i.current===null){var l={hasValue:!1,value:null};i.current=l}else l=i.current;i=ws(function(){function s(m){if(!n){if(n=!0,d=m,m=o(m),a!==void 0&&l.hasValue){var Z=l.value;if(a(Z,m))return b=Z}return b=m}if(Z=b,Ls(d,m))return Z;var p=o(m);return a!==void 0&&a(Z,p)?(d=m,Z):(d=m,b=p)}var n=!1,d,b,u=e===void 0?null:e;return[function(){return s(c())},u===null?void 0:function(){return s(u())}]},[c,e,o,a]);var r=xs(t,i[0],i[1]);return Fs(function(){l.hasValue=!0,l.value=r},[r]),Hs(r),r}});var Ja=N(($d,Na)=>{"use strict";Na.exports=Va()});var ja=N((vn,Aa)=>{Aa.exports=window.ReactDOM});var kt=N((pu,si)=>{si.exports=window.wp.i18n});var uo=N((gu,ri)=>{ri.exports=window.wp.commands});var ni=N((Xu,di)=>{di.exports=window.wp.theme});var Zt=N((hu,bi)=>{bi.exports=window.wp.components});var mo=N((Wu,ui)=>{ui.exports=window.wp.coreData});var Zi=N((yu,mi)=>{mi.exports=window.wp.htmlEntities});var Gt=N((Iu,Gi)=>{Gi.exports=window.wp.primitives});var gi=N((Su,pi)=>{pi.exports=window.wp.keycodes});var hi=N((Ou,Xi)=>{Xi.exports=window.wp.url});var Co=N((Zm,zi)=>{zi.exports=window.wp.compose});var $i=N((km,qi)=>{qi.exports=window.wp.privateApis});var Rc=G(gt()),Zl=G(Xt());var Ue=new WeakMap,_o=new WeakMap,re={current:[]},Yc=!1,se=0,le=new Set,Me=new Map;function Po(t){for(let c of t){if(re.current.includes(c))continue;re.current.push(c),c.recompute();let e=_o.get(c);if(e)for(let o of e){let a=Ue.get(o);a?.length&&Po(a)}}}function xl(t){let c={prevVal:t.prevState,currentVal:t.state};for(let e of t.listeners)e(c)}function Yl(t){let c={prevVal:t.prevState,currentVal:t.state};for(let e of t.listeners)e(c)}function ze(t){if(se>0&&!Me.has(t)&&Me.set(t,t.prevState),le.add(t),!(se>0)&&!Yc)try{for(Yc=!0;le.size>0;){let c=Array.from(le);le.clear();for(let e of c){let o=Me.get(e)??e.prevState;e.prevState=o,xl(e)}for(let e of c){let o=Ue.get(e);o&&(re.current.push(e),Po(o))}for(let e of c){let o=Ue.get(e);if(o)for(let a of o)Yl(a)}}}finally{Yc=!1,re.current=[],Me.clear()}}function ht(t){se++;try{t()}finally{if(se--,se===0){let c=le.values().next().value;c&&ze(c)}}}function qo(t){return typeof t=="function"}var de=class{constructor(c,e){this.listeners=new Set,this.subscribe=o=>{var a,i;this.listeners.add(o);let l=(i=(a=this.options)==null?void 0:a.onSubscribe)==null?void 0:i.call(a,o,this);return()=>{this.listeners.delete(o),l?.()}},this.prevState=c,this.state=c,this.options=e}setState(c){var e,o,a;this.prevState=this.state,(e=this.options)!=null&&e.updateFn?this.state=this.options.updateFn(this.prevState)(c):qo(c)?this.state=c(this.prevState):this.state=c,(a=(o=this.options)==null?void 0:o.onUpdate)==null||a.call(o),ze(this)}};var Wt="__TSR_index",$o="popstate",ta="beforeunload";function ca(t){let c=t.getLocation(),e=new Set,o=l=>{c=t.getLocation(),e.forEach(r=>r({location:c,action:l}))},a=l=>{t.notifyOnIndexChange??!0?o(l):c=t.getLocation()},i=async({task:l,navigateOpts:r,...s})=>{if(r?.ignoreBlocker??!1){l();return}let d=t.getBlockers?.()??[],b=s.type==="PUSH"||s.type==="REPLACE";if(typeof document<"u"&&d.length&&b)for(let u of d){let m=Ht(s.path,s.state);if(await u.blockerFn({currentLocation:c,nextLocation:m,action:s.type})){t.onBlocked?.();return}}l()};return{get location(){return c},get length(){return t.getLength()},subscribers:e,subscribe:l=>(e.add(l),()=>{e.delete(l)}),push:(l,r,s)=>{let n=c.state[Wt];r=ea(n+1,r),i({task:()=>{t.pushState(l,r),o({type:"PUSH"})},navigateOpts:s,type:"PUSH",path:l,state:r})},replace:(l,r,s)=>{let n=c.state[Wt];r=ea(n,r),i({task:()=>{t.replaceState(l,r),o({type:"REPLACE"})},navigateOpts:s,type:"REPLACE",path:l,state:r})},go:(l,r)=>{i({task:()=>{t.go(l),a({type:"GO",index:l})},navigateOpts:r,type:"GO"})},back:l=>{i({task:()=>{t.back(l?.ignoreBlocker??!1),a({type:"BACK"})},navigateOpts:l,type:"BACK"})},forward:l=>{i({task:()=>{t.forward(l?.ignoreBlocker??!1),a({type:"FORWARD"})},navigateOpts:l,type:"FORWARD"})},canGoBack:()=>c.state[Wt]!==0,createHref:l=>t.createHref(l),block:l=>{if(!t.setBlockers)return()=>{};let r=t.getBlockers?.()??[];return t.setBlockers([...r,l]),()=>{let s=t.getBlockers?.()??[];t.setBlockers?.(s.filter(n=>n!==l))}},flush:()=>t.flush?.(),destroy:()=>t.destroy?.(),notify:o}}function ea(t,c){c||(c={});let e=Fc();return{...c,key:e,__TSR_key:e,[Wt]:t}}function ne(t){let c=t?.window??(typeof document<"u"?window:void 0),e=c.history.pushState,o=c.history.replaceState,a=[],i=()=>a,l=g=>a=g,r=t?.createHref??(g=>g),s=t?.parseLocation??(()=>Ht(`${c.location.pathname}${c.location.search}${c.location.hash}`,c.history.state));if(!c.history.state?.__TSR_key&&!c.history.state?.key){let g=Fc();c.history.replaceState({[Wt]:0,key:g,__TSR_key:g},"")}let n=s(),d,b=!1,u=!1,m=!1,Z=!1,p=()=>n,X,h,R=()=>{X&&(W._ignoreSubscribers=!0,(X.isPush?c.history.pushState:c.history.replaceState)(X.state,"",X.href),W._ignoreSubscribers=!1,X=void 0,h=void 0,d=void 0)},B=(g,I,f)=>{let C=r(I);h||(d=n),n=Ht(I,f),X={href:C,state:f,isPush:X?.isPush||g==="push"},h||(h=Promise.resolve().then(()=>R()))},v=g=>{n=s(),W.notify({type:g})},H=async()=>{if(u){u=!1;return}let g=s(),I=g.state[Wt]-n.state[Wt],f=I===1,C=I===-1,V=!f&&!C||b;b=!1;let nt=V?"GO":C?"BACK":"FORWARD",P=V?{type:"GO",index:I}:{type:C?"BACK":"FORWARD"};if(m)m=!1;else{let Ft=i();if(typeof document<"u"&&Ft.length){for(let Uo of Ft)if(await Uo.blockerFn({currentLocation:n,nextLocation:g,action:nt})){u=!0,c.history.go(1),W.notify(P);return}}}n=s(),W.notify(P)},L=g=>{if(Z){Z=!1;return}let I=!1,f=i();if(typeof document<"u"&&f.length)for(let C of f){let V=C.enableBeforeUnload??!0;if(V===!0){I=!0;break}if(typeof V=="function"&&V()===!0){I=!0;break}}if(I)return g.preventDefault(),g.returnValue=""},W=ca({getLocation:p,getLength:()=>c.history.length,pushState:(g,I)=>B("push",g,I),replaceState:(g,I)=>B("replace",g,I),back:g=>(g&&(m=!0),Z=!0,c.history.back()),forward:g=>{g&&(m=!0),Z=!0,c.history.forward()},go:g=>{b=!0,c.history.go(g)},createHref:g=>r(g),flush:R,destroy:()=>{c.history.pushState=e,c.history.replaceState=o,c.removeEventListener(ta,L,{capture:!0}),c.removeEventListener($o,H)},onBlocked:()=>{d&&n!==d&&(n=d)},getBlockers:i,setBlockers:l,notifyOnIndexChange:!1});return c.addEventListener(ta,L,{capture:!0}),c.addEventListener($o,H),c.history.pushState=function(...g){let I=e.apply(c.history,g);return W._ignoreSubscribers||v("PUSH"),I},c.history.replaceState=function(...g){let I=o.apply(c.history,g);return W._ignoreSubscribers||v("REPLACE"),I},W}function Ht(t,c){let e=t.indexOf("#"),o=t.indexOf("?"),a=Fc();return{href:t,pathname:t.substring(0,e>0?o>0?Math.min(e,o):e:o>0?o:t.length),hash:e>-1?t.substring(e):"",search:o>-1?t.slice(o,e===-1?void 0:e):"",state:c||{[Wt]:0,key:a,__TSR_key:a}}}function Fc(){return(Math.random()+1).toString(36).substring(7)}function St(t){return t[t.length-1]}function Fl(t){return typeof t=="function"}function $(t,c){return Fl(t)?t(c):t}var wl=Object.prototype.hasOwnProperty;function S(t,c){if(t===c)return t;let e=c,o=wc(t)&&wc(e);if(!o&&!(be(t)&&be(e)))return e;let a=o?t:oa(t);if(!a)return e;let i=o?e:oa(e);if(!i)return e;let l=a.length,r=i.length,s=o?new Array(r):{},n=0;for(let d=0;d<r;d++){let b=o?d:i[d],u=t[b],m=e[b];if(u===m){s[b]=u,(o?d<l:wl.call(t,b))&&n++;continue}if(u===null||m===null||typeof u!="object"||typeof m!="object"){s[b]=m;continue}let Z=S(u,m);s[b]=Z,Z===u&&n++}return l===r&&n===l?t:s}function oa(t){let c=[],e=Object.getOwnPropertyNames(t);for(let a of e){if(!Object.prototype.propertyIsEnumerable.call(t,a))return!1;c.push(a)}let o=Object.getOwnPropertySymbols(t);for(let a of o){if(!Object.prototype.propertyIsEnumerable.call(t,a))return!1;c.push(a)}return c}function be(t){if(!aa(t))return!1;let c=t.constructor;if(typeof c>"u")return!0;let e=c.prototype;return!(!aa(e)||!e.hasOwnProperty("isPrototypeOf"))}function aa(t){return Object.prototype.toString.call(t)==="[object Object]"}function wc(t){return Array.isArray(t)&&t.length===Object.keys(t).length}function ct(t,c,e){if(t===c)return!0;if(typeof t!=typeof c)return!1;if(Array.isArray(t)&&Array.isArray(c)){if(t.length!==c.length)return!1;for(let o=0,a=t.length;o<a;o++)if(!ct(t[o],c[o],e))return!1;return!0}if(be(t)&&be(c)){let o=e?.ignoreUndefined??!0;if(e?.partial){for(let l in c)if((!o||c[l]!==void 0)&&!ct(t[l],c[l],e))return!1;return!0}let a=0;if(!o)a=Object.keys(t).length;else for(let l in t)t[l]!==void 0&&a++;let i=0;for(let l in c)if((!o||c[l]!==void 0)&&(i++,i>a||!ct(t[l],c[l],e)))return!1;return a===i}return!1}function ot(t){let c,e,o=new Promise((a,i)=>{c=a,e=i});return o.status="pending",o.resolve=a=>{o.status="resolved",o.value=a,c(a),t?.(a)},o.reject=a=>{o.status="rejected",e(a)},o}function ut(t){return!!(t&&typeof t=="object"&&typeof t.then=="function")}var Hl=Array.from(new Map([["%","%25"],["\\","%5C"],["/","%2F"],[";","%3B"],[":","%3A"],["@","%40"],["&","%26"],["=","%3D"],["+","%2B"],["$","%24"],[",","%2C"]]).values());function ue(t,c=Hl,e=0){function o(a){try{return decodeURIComponent(a)}catch{return a.replaceAll(/%[0-9A-Fa-f]{2}/g,i=>{try{return decodeURIComponent(i)}catch{return i}})}}if(t===""||!t.match(/%[0-9A-Fa-f]{2}/g))return t;for(let a=e;a<c.length;a++){let i=c[a];if(i&&t.includes(i)){let l=t.split(i),r=[];for(let s of l)r.push(ue(s,c,a+1));return r.join(i)}}return o(t)}var Cl=!0,Hc="Invariant failed";function D(t,c){if(!t){if(Cl)throw new Error(Hc);var e=typeof c=="function"?c():c,o=e?"".concat(Hc,": ").concat(e):Hc;throw new Error(o)}}var tt=0,yt=1,Ot=2,Ct=3;function E(t){return me(t.filter(c=>c!==void 0).join("/"))}function me(t){return t.replace(/\/{2,}/g,"/")}function At(t){return t==="/"?t:t.replace(/^\/{1,}/,"")}function K(t){return t==="/"?t:t.replace(/\/{1,}$/,"")}function Vt(t){return K(At(t))}function Dt(t,c){return t?.endsWith("/")&&t!=="/"&&t!==`${c}/`?t.slice(0,-1):t}function Cc(t,c,e){return Dt(t,e)===Dt(c,e)}function Vl(t){let{type:c,value:e}=t;if(c===tt)return e;let{prefixSegment:o,suffixSegment:a}=t;if(c===yt){let i=e.substring(1);if(o&&a)return`${o}{$${i}}${a}`;if(o)return`${o}{$${i}}`;if(a)return`{$${i}}${a}`}if(c===Ct){let i=e.substring(1);return o&&a?`${o}{-$${i}}${a}`:o?`${o}{-$${i}}`:a?`{-$${i}}${a}`:`{-$${i}}`}if(c===Ot){if(o&&a)return`${o}{$}${a}`;if(o)return`${o}{$}`;if(a)return`{$}${a}`}return e}function Vc({base:t,to:c,trailingSlash:e="never",parseCache:o}){let a=Bt(t,o).slice(),i=Bt(c,o);a.length>1&&St(a)?.value==="/"&&a.pop();for(let s=0,n=i.length;s<n;s++){let d=i[s],b=d.value;b==="/"?s?s===n-1&&a.push(d):a=[d]:b===".."?a.pop():b==="."||a.push(d)}a.length>1&&(St(a).value==="/"?e==="never"&&a.pop():e==="always"&&a.push({type:tt,value:"/"}));let l=a.map(Vl);return E(l)}var Bt=(t,c)=>{if(!t)return[];let e=c?.get(t);if(e)return e;let o=Ul(t);return c?.set(t,o),o},Nl=/^\$.{1,}$/,Jl=/^(.*?)\{(\$[a-zA-Z_$][a-zA-Z0-9_$]*)\}(.*)$/,Ql=/^(.*?)\{-(\$[a-zA-Z_$][a-zA-Z0-9_$]*)\}(.*)$/,kl=/^\$$/,Ml=/^(.*?)\{\$\}(.*)$/;function Ul(t){t=me(t);let c=[];if(t.slice(0,1)==="/"&&(t=t.substring(1),c.push({type:tt,value:"/"})),!t)return c;let e=t.split("/").filter(Boolean);return c.push(...e.map(o=>{let a=o.match(Ml);if(a){let r=a[1],s=a[2];return{type:Ot,value:"$",prefixSegment:r||void 0,suffixSegment:s||void 0}}let i=o.match(Ql);if(i){let r=i[1],s=i[2],n=i[3];return{type:Ct,value:s,prefixSegment:r||void 0,suffixSegment:n||void 0}}let l=o.match(Jl);if(l){let r=l[1],s=l[2],n=l[3];return{type:yt,value:""+s,prefixSegment:r||void 0,suffixSegment:n||void 0}}if(Nl.test(o)){let r=o.substring(1);return{type:yt,value:"$"+r,prefixSegment:void 0,suffixSegment:void 0}}return kl.test(o)?{type:Ot,value:"$",prefixSegment:void 0,suffixSegment:void 0}:{type:tt,value:ue(o)}})),t.slice(-1)==="/"&&(t=t.substring(1),c.push({type:tt,value:"/"})),c}function jt({path:t,params:c,leaveWildcards:e,leaveParams:o,decodeCharMap:a,parseCache:i}){let l=Bt(t,i);function r(b){let u=c[b],m=typeof u=="string";return b==="*"||b==="_splat"?m?encodeURI(u):u:m?zl(u,a):u}let s=!1,n={},d=E(l.map(b=>{if(b.type===tt)return b.value;if(b.type===Ot){n._splat=c._splat,n["*"]=c._splat;let u=b.prefixSegment||"",m=b.suffixSegment||"";if(!c._splat)return s=!0,e?`${u}${b.value}${m}`:u||m?`${u}${m}`:void 0;let Z=r("_splat");return e?`${u}${b.value}${Z??""}${m}`:`${u}${Z}${m}`}if(b.type===yt){let u=b.value.substring(1);!s&&!(u in c)&&(s=!0),n[u]=c[u];let m=b.prefixSegment||"",Z=b.suffixSegment||"";if(o){let p=r(b.value);return`${m}${b.value}${p??""}${Z}`}return`${m}${r(u)??"undefined"}${Z}`}if(b.type===Ct){let u=b.value.substring(1),m=b.prefixSegment||"",Z=b.suffixSegment||"";if(!(u in c)||c[u]==null)return e?`${m}${u}${Z}`:m||Z?`${m}${Z}`:void 0;if(n[u]=c[u],o){let p=r(b.value);return`${m}${b.value}${p??""}${Z}`}return e?`${m}${u}${r(u)??""}${Z}`:`${m}${r(u)??""}${Z}`}return b.value}));return{usedParams:n,interpolatedPath:d,isMissingParams:s}}function zl(t,c){let e=encodeURIComponent(t);if(c)for(let[o,a]of c)e=e.replaceAll(o,a);return e}function Ze(t,c,e){let o=ia(t,c,e);if(!(c.to&&!o))return o??{}}function ia(t,{to:c,fuzzy:e,caseSensitive:o},a){let i=c,l=Bt(t.startsWith("/")?t:`/${t}`,a),r=Bt(i.startsWith("/")?i:`/${i}`,a),s={};return Sl(l,r,s,e,o)?s:void 0}function Sl(t,c,e,o,a){let i=0,l=0;for(;i<t.length||l<c.length;){let r=t[i],s=c[l];if(s){if(s.type===Ot){let n=t.slice(i),d;if(s.prefixSegment||s.suffixSegment){if(!r)return!1;let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if("prefixSegment"in s&&!m.startsWith(b)||"suffixSegment"in s&&!t[t.length-1]?.value.endsWith(u))return!1;let Z=decodeURI(E(n.map(p=>p.value)));b&&Z.startsWith(b)&&(Z=Z.slice(b.length)),u&&Z.endsWith(u)&&(Z=Z.slice(0,Z.length-u.length)),d=Z}else d=decodeURI(E(n.map(b=>b.value)));return e["*"]=d,e._splat=d,!0}if(s.type===tt){if(s.value==="/"&&!r?.value){l++;continue}if(r){if(a){if(s.value!==r.value)return!1}else if(s.value.toLowerCase()!==r.value.toLowerCase())return!1;i++,l++;continue}else return!1}if(s.type===yt){if(!r||r.value==="/")return!1;let n="",d=!1;if(s.prefixSegment||s.suffixSegment){let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if(b&&!m.startsWith(b)||u&&!m.endsWith(u))return!1;let Z=m;b&&Z.startsWith(b)&&(Z=Z.slice(b.length)),u&&Z.endsWith(u)&&(Z=Z.slice(0,Z.length-u.length)),n=decodeURIComponent(Z),d=!0}else n=decodeURIComponent(r.value),d=!0;d&&(e[s.value.substring(1)]=n,i++),l++;continue}if(s.type===Ct){if(!r){l++;continue}if(r.value==="/"){l++;continue}let n="",d=!1;if(s.prefixSegment||s.suffixSegment){let b=s.prefixSegment||"",u=s.suffixSegment||"",m=r.value;if((!b||m.startsWith(b))&&(!u||m.endsWith(u))){let Z=m;b&&Z.startsWith(b)&&(Z=Z.slice(b.length)),u&&Z.endsWith(u)&&(Z=Z.slice(0,Z.length-u.length)),n=decodeURIComponent(Z),d=!0}}else{let b=!0;for(let u=l+1;u<c.length;u++){let m=c[u];if(m?.type===tt&&m.value===r.value){b=!1;break}if(m?.type===yt||m?.type===Ot){t.length<c.length&&(b=!1);break}}b&&(n=decodeURIComponent(r.value),d=!0)}d&&(e[s.value.substring(1)]=n,i++),l++;continue}}if(i<t.length&&l>=c.length)return e["**"]=E(t.slice(i).map(n=>n.value)),!!o&&c[c.length-1]?.value!=="/";if(l<c.length&&i>=t.length){for(let n=l;n<c.length;n++)if(c[n]?.type!==Ct)return!1;break}break}return!0}var Ol=.75,Dl=1,Al=.5,jl=.4,Tl=.25,El=.2,Kl=.05,_l=.02,Pl=.01,la=2e-4,sa=1e-4;function ra(t,c){return t.prefixSegment&&t.suffixSegment?c+Kl+la*t.prefixSegment.length+sa*t.suffixSegment.length:t.prefixSegment?c+_l+la*t.prefixSegment.length:t.suffixSegment?c+Pl+sa*t.suffixSegment.length:c}function ql(t){let c=[];return t.forEach((o,a)=>{if(o.isRoot||!o.path)return;let i=At(o.fullPath),l=Bt(i),r=0;for(;l.length>r+1&&l[r]?.value==="/";)r++;r>0&&(l=l.slice(r));let s=0,n=!1,d=l.map((b,u)=>{if(b.value==="/")return Ol;if(b.type===tt)return Dl;let m;b.type===yt?m=Al:b.type===Ct?(m=jl,s++):m=Tl;for(let Z=u+1;Z<l.length;Z++){let p=l[Z];if(p.type===tt&&p.value!=="/")return n=!0,ra(b,m+El)}return ra(b,m)});c.push({child:o,trimmed:i,parsed:l,index:a,scores:d,optionalParamCount:s,hasStaticAfter:n})}),c.sort((o,a)=>{let i=Math.min(o.scores.length,a.scores.length);for(let l=0;l<i;l++)if(o.scores[l]!==a.scores[l])return a.scores[l]-o.scores[l];if(o.scores.length!==a.scores.length){if(o.optionalParamCount!==a.optionalParamCount){if(o.hasStaticAfter===a.hasStaticAfter)return o.optionalParamCount-a.optionalParamCount;if(o.hasStaticAfter&&!a.hasStaticAfter)return-1;if(!o.hasStaticAfter&&a.hasStaticAfter)return 1}return a.scores.length-o.scores.length}for(let l=0;l<i;l++)if(o.parsed[l].value!==a.parsed[l].value)return o.parsed[l].value>a.parsed[l].value?1:-1;return o.index-a.index}).map((o,a)=>(o.child.rank=a,o.child))}function da({routeTree:t,initRoute:c}){let e={},o={},a=l=>{l.forEach((r,s)=>{c?.(r,s);let n=e[r.id];if(D(!n,`Duplicate routes found with id: ${String(r.id)}`),e[r.id]=r,!r.isRoot&&r.path){let b=K(r.fullPath);(!o[b]||r.fullPath.endsWith("/"))&&(o[b]=r)}let d=r.children;d?.length&&a(d)})};a([t]);let i=ql(Object.values(e));return{routesById:e,routesByPath:o,flatRoutes:i}}function U(t){return!!t?.isNotFound}function $l(){try{if(typeof window<"u"&&typeof window.sessionStorage=="object")return window.sessionStorage}catch{}}var Tt="tsr-scroll-restoration-v1_3",ts=(t,c)=>{let e;return(...o)=>{e||(e=setTimeout(()=>{t(...o),e=null},c))}};function es(){let t=$l();if(!t)return null;let c=t.getItem(Tt),e=c?JSON.parse(c):{};return{state:e,set:o=>(e=$(o,e)||e,t.setItem(Tt,JSON.stringify(e)))}}var Ge=es(),pe=t=>t.state.__TSR_key||t.href;function na(t){let c=[],e;for(;e=t.parentNode;)c.push(`${t.tagName}:nth-child(${Array.prototype.indexOf.call(e.children,t)+1})`),t=e;return`${c.reverse().join(" > ")}`.toLowerCase()}var Se=!1;function Oe({storageKey:t,key:c,behavior:e,shouldScrollRestoration:o,scrollToTopSelectors:a,location:i}){let l;try{l=JSON.parse(sessionStorage.getItem(t)||"{}")}catch(n){console.error(n);return}let r=c||window.history.state?.__TSR_key,s=l[r];Se=!0;t:{if(o&&s&&Object.keys(s).length>0){for(let b in s){let u=s[b];if(b==="window")window.scrollTo({top:u.scrollY,left:u.scrollX,behavior:e});else if(b){let m=document.querySelector(b);m&&(m.scrollLeft=u.scrollX,m.scrollTop=u.scrollY)}}break t}let n=(i??window.location).hash.split("#",2)[1];if(n){let b=window.history.state?.__hashScrollIntoViewOptions??!0;if(b){let u=document.getElementById(n);u&&u.scrollIntoView(b)}break t}let d={top:0,left:0,behavior:e};if(window.scrollTo(d),a)for(let b of a){if(b==="window")continue;let u=typeof b=="function"?b():document.querySelector(b);u&&u.scrollTo(d)}}Se=!1}function Nc(t,c){if(!Ge&&!t.isServer||((c??t.options.scrollRestoration??!1)&&(t.isScrollRestoring=!0),t.isServer||t.isScrollRestorationSetup||!Ge))return;t.isScrollRestorationSetup=!0,Se=!1;let o=t.options.getScrollRestorationKey||pe;window.history.scrollRestoration="manual";let a=i=>{if(Se||!t.isScrollRestoring)return;let l="";if(i.target===document||i.target===window)l="window";else{let s=i.target.getAttribute("data-scroll-restoration-id");s?l=`[data-scroll-restoration-id="${s}"]`:l=na(i.target)}let r=o(t.state.location);Ge.set(s=>{let n=s[r]||={},d=n[l]||={};if(l==="window")d.scrollX=window.scrollX||0,d.scrollY=window.scrollY||0;else if(l){let b=document.querySelector(l);b&&(d.scrollX=b.scrollLeft||0,d.scrollY=b.scrollTop||0)}return s})};typeof document<"u"&&document.addEventListener("scroll",ts(a,100),!0),t.subscribe("onRendered",i=>{let l=o(i.toLocation);if(!t.resetNextScroll){t.resetNextScroll=!0;return}typeof t.options.scrollRestoration=="function"&&!t.options.scrollRestoration({location:t.latestLocation})||(Oe({storageKey:Tt,key:l,behavior:t.options.scrollRestorationBehavior,shouldScrollRestoration:t.isScrollRestoring,scrollToTopSelectors:t.options.scrollToTopSelectors,location:t.history.location}),t.isScrollRestoring&&Ge.set(r=>(r[l]||={},r)))})}function Jc(t){if(typeof document<"u"&&document.querySelector){let c=t.state.location.state.__hashScrollIntoViewOptions??!0;if(c&&t.state.location.hash!==""){let e=document.getElementById(t.state.location.hash);e&&e.scrollIntoView(c)}}}function ba(t,c=String){let e=new URLSearchParams;for(let o in t){let a=t[o];a!==void 0&&e.set(o,c(a))}return e.toString()}function Qc(t){return t?t==="false"?!1:t==="true"?!0:+t*0===0&&+t+""===t?+t:t:""}function ua(t){let c=new URLSearchParams(t),e={};for(let[o,a]of c.entries()){let i=e[o];i==null?e[o]=Qc(a):Array.isArray(i)?i.push(Qc(a)):e[o]=[i,Qc(a)]}return e}var ma=cs(JSON.parse),Za=os(JSON.stringify,JSON.parse);function cs(t){return c=>{c[0]==="?"&&(c=c.substring(1));let e=ua(c);for(let o in e){let a=e[o];if(typeof a=="string")try{e[o]=t(a)}catch{}}return e}}function os(t,c){let e=typeof c=="function";function o(a){if(typeof a=="object"&&a!==null)try{return t(a)}catch{}else if(e&&typeof a=="string")try{return c(a),t(a)}catch{}return a}return a=>{let i=ba(a,o);return i?`?${i}`:""}}var J="__root__";function kc(t){if(t.statusCode=t.statusCode||t.code||307,!t.reloadDocument&&typeof t.href=="string")try{new URL(t.href),t.reloadDocument=!0}catch{}let c=new Headers(t.headers);t.href&&c.get("Location")===null&&c.set("Location",t.href);let e=new Response(null,{status:t.statusCode,headers:c});if(e.options=t,t.throw)throw e;return e}function A(t){return t instanceof Response&&!!t.options}function Ga(t){let c=new Map,e,o,a=i=>{i.next&&(i.prev?(i.prev.next=i.next,i.next.prev=i.prev,i.next=void 0,o&&(o.next=i,i.prev=o)):(i.next.prev=void 0,e=i.next,i.next=void 0,o&&(i.prev=o,o.next=i)),o=i)};return{get(i){let l=c.get(i);if(l)return a(l),l.value},set(i,l){if(c.size>=t&&e){let s=e;c.delete(s.key),s.next&&(e=s.next,s.next.prev=void 0),s===o&&(o=void 0)}let r=c.get(i);if(r)r.value=l,a(r);else{let s={key:i,value:l,prev:o};o&&(o.next=s),o=s,e||(e=s),c.set(i,s)}}}}var Ae=t=>{if(!t.rendered)return t.rendered=!0,t.onReady?.()},je=(t,c)=>!!(t.preload&&!t.router.state.matches.some(e=>e.id===c)),ga=(t,c)=>{let e=t.router.routesById[c.routeId??""]??t.router.routeTree;!e.options.notFoundComponent&&t.router.options?.defaultNotFoundComponent&&(e.options.notFoundComponent=t.router.options.defaultNotFoundComponent),D(e.options.notFoundComponent,"No notFoundComponent found. Please set a notFoundComponent on your route or provide a defaultNotFoundComponent to the router.");let o=t.matches.find(a=>a.routeId===e.id);D(o,"Could not find match for route: "+e.id),t.updateMatch(o.id,a=>({...a,status:"notFound",error:c,isFetching:!1})),c.routerCode==="BEFORE_LOAD"&&e.parentRoute&&(c.routeId=e.parentRoute.id,ga(t,c))},It=(t,c,e)=>{if(!(!A(e)&&!U(e))){if(A(e)&&e.redirectHandled&&!e.options.reloadDocument)throw e;if(c){c._nonReactive.beforeLoadPromise?.resolve(),c._nonReactive.loaderPromise?.resolve(),c._nonReactive.beforeLoadPromise=void 0,c._nonReactive.loaderPromise=void 0;let o=A(e)?"redirected":"notFound";t.updateMatch(c.id,a=>({...a,status:o,isFetching:!1,error:e})),U(e)&&!e.routeId&&(e.routeId=c.routeId),c._nonReactive.loadPromise?.resolve()}throw A(e)?(t.rendered=!0,e.options._fromLocation=t.location,e.redirectHandled=!0,e=t.router.resolveRedirect(e),e):(ga(t,e),e)}},Xa=(t,c)=>{let e=t.router.getMatch(c);return!!(!t.router.isServer&&e._nonReactive.dehydrated||t.router.isServer&&e.ssr===!1)},ge=(t,c,e,o)=>{let{id:a,routeId:i}=t.matches[c],l=t.router.looseRoutesById[i];if(e instanceof Promise)throw e;e.routerCode=o,t.firstBadMatchIndex??=c,It(t,t.router.getMatch(a),e);try{l.options.onError?.(e)}catch(r){e=r,It(t,t.router.getMatch(a),e)}t.updateMatch(a,r=>(r._nonReactive.beforeLoadPromise?.resolve(),r._nonReactive.beforeLoadPromise=void 0,r._nonReactive.loadPromise?.resolve(),{...r,error:e,status:"error",isFetching:!1,updatedAt:Date.now(),abortController:new AbortController}))},as=(t,c,e,o)=>{let a=t.router.getMatch(c),i=t.matches[e-1]?.id,l=i?t.router.getMatch(i):void 0;if(t.router.isShell()){a.ssr=c===J;return}if(l?.ssr===!1){a.ssr=!1;return}let r=m=>m===!0&&l?.ssr==="data-only"?"data-only":m,s=t.router.options.defaultSsr??!0;if(o.options.ssr===void 0){a.ssr=r(s);return}if(typeof o.options.ssr!="function"){a.ssr=r(o.options.ssr);return}let{search:n,params:d}=a,b={search:De(n,a.searchError),params:De(d,a.paramsError),location:t.location,matches:t.matches.map(m=>({index:m.index,pathname:m.pathname,fullPath:m.fullPath,staticData:m.staticData,id:m.id,routeId:m.routeId,search:De(m.search,m.searchError),params:De(m.params,m.paramsError),ssr:m.ssr}))},u=o.options.ssr(b);if(ut(u))return u.then(m=>{a.ssr=r(m??s)});a.ssr=r(u??s)},ha=(t,c,e,o)=>{if(o._nonReactive.pendingTimeout!==void 0)return;let a=e.options.pendingMs??t.router.options.defaultPendingMs;if(!!(t.onReady&&!t.router.isServer&&!je(t,c)&&(e.options.loader||e.options.beforeLoad||zc(e))&&typeof a=="number"&&a!==1/0&&(e.options.pendingComponent??t.router.options?.defaultPendingComponent))){let l=setTimeout(()=>{Ae(t)},a);o._nonReactive.pendingTimeout=l}},is=(t,c,e)=>{let o=t.router.getMatch(c);if(!o._nonReactive.beforeLoadPromise&&!o._nonReactive.loaderPromise)return;ha(t,c,e,o);let a=()=>{let i=t.router.getMatch(c);i.preload&&(i.status==="redirected"||i.status==="notFound")&&It(t,i,i.error)};return o._nonReactive.beforeLoadPromise?o._nonReactive.beforeLoadPromise.then(a):a()},ls=(t,c,e,o)=>{let a=t.router.getMatch(c),i=a._nonReactive.loadPromise;a._nonReactive.loadPromise=ot(()=>{i?.resolve()});let{paramsError:l,searchError:r}=a;l&&ge(t,e,l,"PARSE_PARAMS"),r&&ge(t,e,r,"VALIDATE_SEARCH"),ha(t,c,o,a);let s=new AbortController,n=t.matches[e-1]?.id,u={...(n?t.router.getMatch(n):void 0)?.context??t.router.options.context??void 0,...a.__routeContext},m=!1,Z=()=>{m||(m=!0,t.updateMatch(c,W=>({...W,isFetching:"beforeLoad",fetchCount:W.fetchCount+1,abortController:s,context:u})))},p=()=>{a._nonReactive.beforeLoadPromise?.resolve(),a._nonReactive.beforeLoadPromise=void 0,t.updateMatch(c,W=>({...W,isFetching:!1}))};if(!o.options.beforeLoad){ht(()=>{Z(),p()});return}a._nonReactive.beforeLoadPromise=ot();let{search:X,params:h,cause:R}=a,B=je(t,c),v={search:X,abortController:s,params:h,preload:B,context:u,location:t.location,navigate:W=>t.router.navigate({...W,_fromLocation:t.location}),buildLocation:t.router.buildLocation,cause:B?"preload":R,matches:t.matches,...t.router.options.additionalContext},H=W=>{if(W===void 0){ht(()=>{Z(),p()});return}(A(W)||U(W))&&(Z(),ge(t,e,W,"BEFORE_LOAD")),ht(()=>{Z(),t.updateMatch(c,g=>({...g,__beforeLoadContext:W,context:{...g.context,...W}})),p()})},L;try{if(L=o.options.beforeLoad(v),ut(L))return Z(),L.catch(W=>{ge(t,e,W,"BEFORE_LOAD")}).then(H)}catch(W){Z(),ge(t,e,W,"BEFORE_LOAD")}H(L)},ss=(t,c)=>{let{id:e,routeId:o}=t.matches[c],a=t.router.looseRoutesById[o],i=()=>{if(t.router.isServer){let s=as(t,e,c,a);if(ut(s))return s.then(r)}return r()},l=()=>ls(t,e,c,a),r=()=>{if(Xa(t,e))return;let s=is(t,e,a);return ut(s)?s.then(l):l()};return i()},Xe=(t,c,e)=>{let o=t.router.getMatch(c);if(!o||!e.options.head&&!e.options.scripts&&!e.options.headers)return;let a={matches:t.matches,match:o,params:o.params,loaderData:o.loaderData};return Promise.all([e.options.head?.(a),e.options.scripts?.(a),e.options.headers?.(a)]).then(([i,l,r])=>{let s=i?.meta,n=i?.links,d=i?.scripts,b=i?.styles;return{meta:s,links:n,headScripts:d,headers:r,scripts:l,styles:b}})},Wa=(t,c,e,o)=>{let a=t.matchPromises[e-1],{params:i,loaderDeps:l,abortController:r,context:s,cause:n}=t.router.getMatch(c),d=je(t,c);return{params:i,deps:l,preload:!!d,parentMatchPromise:a,abortController:r,context:s,location:t.location,navigate:b=>t.router.navigate({...b,_fromLocation:t.location}),cause:d?"preload":n,route:o,...t.router.options.additionalContext}},pa=async(t,c,e,o)=>{try{let a=t.router.getMatch(c);try{(!t.router.isServer||a.ssr===!0)&&Uc(o);let i=o.options.loader?.(Wa(t,c,e,o)),l=o.options.loader&&ut(i);if(!!(l||o._lazyPromise||o._componentsPromise||o.options.head||o.options.scripts||o.options.headers||a._nonReactive.minPendingPromise)&&t.updateMatch(c,b=>({...b,isFetching:"loader"})),o.options.loader){let b=l?await i:i;It(t,t.router.getMatch(c),b),b!==void 0&&t.updateMatch(c,u=>({...u,loaderData:b}))}o._lazyPromise&&await o._lazyPromise;let s=Xe(t,c,o),n=s?await s:void 0,d=a._nonReactive.minPendingPromise;d&&await d,o._componentsPromise&&await o._componentsPromise,t.updateMatch(c,b=>({...b,error:void 0,status:"success",isFetching:!1,updatedAt:Date.now(),...n}))}catch(i){let l=i,r=a._nonReactive.minPendingPromise;r&&await r,U(i)&&await o.options.notFoundComponent?.preload?.(),It(t,t.router.getMatch(c),i);try{o.options.onError?.(i)}catch(d){l=d,It(t,t.router.getMatch(c),d)}let s=Xe(t,c,o),n=s?await s:void 0;t.updateMatch(c,d=>({...d,error:l,status:"error",isFetching:!1,...n}))}}catch(a){let i=t.router.getMatch(c);if(i){let l=Xe(t,c,o);if(l){let r=await l;t.updateMatch(c,s=>({...s,...r}))}i._nonReactive.loaderPromise=void 0}It(t,i,a)}},rs=async(t,c)=>{let{id:e,routeId:o}=t.matches[c],a=!1,i=!1,l=t.router.looseRoutesById[o];if(Xa(t,e)){if(t.router.isServer){let n=Xe(t,e,l);if(n){let d=await n;t.updateMatch(e,b=>({...b,...d}))}return t.router.getMatch(e)}}else{let n=t.router.getMatch(e);if(n._nonReactive.loaderPromise){if(n.status==="success"&&!t.sync&&!n.preload)return n;await n._nonReactive.loaderPromise;let d=t.router.getMatch(e);d.error&&It(t,d,d.error)}else{let d=Date.now()-n.updatedAt,b=je(t,e),u=b?l.options.preloadStaleTime??t.router.options.defaultPreloadStaleTime??3e4:l.options.staleTime??t.router.options.defaultStaleTime??0,m=l.options.shouldReload,Z=typeof m=="function"?m(Wa(t,e,c,l)):m,p=!!b&&!t.router.state.matches.some(B=>B.id===e),X=t.router.getMatch(e);X._nonReactive.loaderPromise=ot(),p!==X.preload&&t.updateMatch(e,B=>({...B,preload:p}));let{status:h,invalid:R}=X;if(a=h==="success"&&(R||(Z??d>u)),!(b&&l.options.preload===!1))if(a&&!t.sync)i=!0,(async()=>{try{await pa(t,e,c,l);let B=t.router.getMatch(e);B._nonReactive.loaderPromise?.resolve(),B._nonReactive.loadPromise?.resolve(),B._nonReactive.loaderPromise=void 0}catch(B){A(B)&&await t.router.navigate(B.options)}})();else if(h!=="success"||a&&t.sync)await pa(t,e,c,l);else{let B=Xe(t,e,l);if(B){let v=await B;t.updateMatch(e,H=>({...H,...v}))}}}}let r=t.router.getMatch(e);i||(r._nonReactive.loaderPromise?.resolve(),r._nonReactive.loadPromise?.resolve()),clearTimeout(r._nonReactive.pendingTimeout),r._nonReactive.pendingTimeout=void 0,i||(r._nonReactive.loaderPromise=void 0),r._nonReactive.dehydrated=void 0;let s=i?r.isFetching:!1;return s!==r.isFetching||r.invalid!==!1?(t.updateMatch(e,n=>({...n,isFetching:s,invalid:!1})),t.router.getMatch(e)):r};async function Mc(t){let c=Object.assign(t,{matchPromises:[]});!c.router.isServer&&c.router.state.matches.some(e=>e._forcePending)&&Ae(c);try{for(let a=0;a<c.matches.length;a++){let i=ss(c,a);ut(i)&&await i}let e=c.firstBadMatchIndex??c.matches.length;for(let a=0;a<e;a++)c.matchPromises.push(rs(c,a));await Promise.all(c.matchPromises);let o=Ae(c);ut(o)&&await o}catch(e){if(U(e)&&!c.preload){let o=Ae(c);throw ut(o)&&await o,e}if(A(e))throw e}return c.matches}async function Uc(t){if(!t._lazyLoaded&&t._lazyPromise===void 0&&(t.lazyFn?t._lazyPromise=t.lazyFn().then(c=>{let{id:e,...o}=c.options;Object.assign(t.options,o),t._lazyLoaded=!0,t._lazyPromise=void 0}):t._lazyLoaded=!0),!t._componentsLoaded&&t._componentsPromise===void 0){let c=()=>{let e=[];for(let o of ya){let a=t.options[o]?.preload;a&&e.push(a())}if(e.length)return Promise.all(e).then(()=>{t._componentsLoaded=!0,t._componentsPromise=void 0});t._componentsLoaded=!0,t._componentsPromise=void 0};t._componentsPromise=t._lazyPromise?t._lazyPromise.then(c):c()}return t._componentsPromise}function De(t,c){return c?{status:"error",error:c}:{status:"success",value:t}}function zc(t){for(let c of ya)if(t.options[c]?.preload)return!0;return!1}var ya=["component","errorComponent","pendingComponent","notFoundComponent"];function Ba(t){return{input:({url:c})=>{for(let e of t)c=Sc(e,c);return c},output:({url:c})=>{for(let e=t.length-1;e>=0;e--)c=Oc(t[e],c);return c}}}function Ia(t){let c=Vt(t.basepath),e=`/${c}`,o=`${e}/`,a=t.caseSensitive?e:e.toLowerCase(),i=t.caseSensitive?o:o.toLowerCase();return{input:({url:l})=>{let r=t.caseSensitive?l.pathname:l.pathname.toLowerCase();return r===a?l.pathname="/":r.startsWith(i)&&(l.pathname=l.pathname.slice(e.length)),l},output:({url:l})=>(l.pathname=E(["/",c,l.pathname]),l)}}function Sc(t,c){let e=t?.input?.({url:c});if(e){if(typeof e=="string")return new URL(e);if(e instanceof URL)return e}return c}function Oc(t,c){let e=t?.output?.({url:c});if(e){if(typeof e=="string")return new URL(e);if(e instanceof URL)return e}return c}function at(t){let c=t.resolvedLocation,e=t.location,o=c?.pathname!==e.pathname,a=c?.href!==e.href,i=c?.hash!==e.hash;return{fromLocation:c,toLocation:e,pathChanged:o,hrefChanged:a,hashChanged:i}}var he=class{constructor(c){this.tempLocationKey=`${Math.round(Math.random()*1e7)}`,this.resetNextScroll=!0,this.shouldViewTransition=void 0,this.isViewTransitionTypesSupported=void 0,this.subscribers=new Set,this.isScrollRestoring=!1,this.isScrollRestorationSetup=!1,this.startTransition=e=>e(),this.update=e=>{e.notFoundRoute&&console.warn("The notFoundRoute API is deprecated and will be removed in the next major version. See https://tanstack.com/router/v1/docs/framework/react/guide/not-found-errors#migrating-from-notfoundroute for more info.");let o=this.options,a=this.basepath??o?.basepath??"/",i=this.basepath===void 0,l=o?.rewrite;this.options={...o,...e},this.isServer=this.options.isServer??typeof document>"u",this.pathParamsDecodeCharMap=this.options.pathParamsAllowedCharacters?new Map(this.options.pathParamsAllowedCharacters.map(u=>[encodeURIComponent(u),u])):void 0,(!this.history||this.options.history&&this.options.history!==this.history)&&(this.options.history?this.history=this.options.history:this.isServer||(this.history=ne())),this.origin=this.options.origin,this.origin||(!this.isServer&&window?.origin&&window.origin!=="null"?this.origin=window.origin:this.origin="http://localhost"),this.history&&this.updateLatestLocation(),this.options.routeTree!==this.routeTree&&(this.routeTree=this.options.routeTree,this.buildRouteTree()),!this.__store&&this.latestLocation&&(this.__store=new de(fa(this.latestLocation),{onUpdate:()=>{this.__store.state={...this.state,cachedMatches:this.state.cachedMatches.filter(u=>!["redirected"].includes(u.status))}}}),Nc(this));let r=!1,s=this.options.basepath??"/",n=this.options.rewrite;if(i||a!==s||l!==n){this.basepath=s;let u=[];Vt(s)!==""&&u.push(Ia({basepath:s})),n&&u.push(n),this.rewrite=u.length===0?void 0:u.length===1?u[0]:Ba(u),this.history&&this.updateLatestLocation(),r=!0}r&&this.__store&&(this.__store.state={...this.state,location:this.latestLocation}),typeof window<"u"&&"CSS"in window&&typeof window.CSS?.supports=="function"&&(this.isViewTransitionTypesSupported=window.CSS.supports("selector(:active-view-transition-type(a)"))},this.updateLatestLocation=()=>{this.latestLocation=this.parseLocation(this.history.location,this.latestLocation)},this.buildRouteTree=()=>{let{routesById:e,routesByPath:o,flatRoutes:a}=da({routeTree:this.routeTree,initRoute:(l,r)=>{l.init({originalIndex:r})}});this.routesById=e,this.routesByPath=o,this.flatRoutes=a;let i=this.options.notFoundRoute;i&&(i.init({originalIndex:99999999999}),this.routesById[i.id]=i)},this.subscribe=(e,o)=>{let a={eventType:e,fn:o};return this.subscribers.add(a),()=>{this.subscribers.delete(a)}},this.emit=e=>{this.subscribers.forEach(o=>{o.eventType===e.type&&o.fn(e)})},this.parseLocation=(e,o)=>{let a=({href:s,state:n})=>{let d=new URL(s,this.origin),b=Sc(this.rewrite,d),u=this.options.parseSearch(b.search),m=this.options.stringifySearch(u);b.search=m;let Z=b.href.replace(b.origin,""),{pathname:p,hash:X}=b;return{href:Z,publicHref:s,url:b.href,pathname:p,searchStr:m,search:S(o?.search,u),hash:X.split("#").reverse()[0]??"",state:S(o?.state,n)}},i=a(e),{__tempLocation:l,__tempKey:r}=i.state;if(l&&(!r||r===this.tempLocationKey)){let s=a(l);return s.state.key=i.state.key,s.state.__TSR_key=i.state.__TSR_key,delete s.state.__tempLocation,{...s,maskedLocation:i}}return i},this.resolvePathWithBase=(e,o)=>Vc({base:e,to:me(o),trailingSlash:this.options.trailingSlash,parseCache:this.parsePathnameCache}),this.matchRoutes=(e,o,a)=>typeof e=="string"?this.matchRoutesInternal({pathname:e,search:o},a):this.matchRoutesInternal(e,o),this.parsePathnameCache=Ga(1e3),this.getMatchedRoutes=(e,o)=>Ra({pathname:e,routePathname:o,caseSensitive:this.options.caseSensitive,routesByPath:this.routesByPath,routesById:this.routesById,flatRoutes:this.flatRoutes,parseCache:this.parsePathnameCache}),this.cancelMatch=e=>{let o=this.getMatch(e);o&&(o.abortController.abort(),clearTimeout(o._nonReactive.pendingTimeout),o._nonReactive.pendingTimeout=void 0)},this.cancelMatches=()=>{this.state.pendingMatches?.forEach(e=>{this.cancelMatch(e.id)})},this.buildLocation=e=>{let o=(i={})=>{let l=i._fromLocation||this.latestLocation,r=this.matchRoutes(l,{_buildLocation:!0}),s=St(r);i.from;let n=i.unsafeRelative==="path"?l.pathname:i.from??s.fullPath,d=this.resolvePathWithBase(n,"."),b=s.search,u={...s.params},m=i.to?this.resolvePathWithBase(d,`${i.to}`):this.resolvePathWithBase(d,"."),Z=i.params===!1||i.params===null?{}:(i.params??!0)===!0?u:Object.assign(u,$(i.params,u)),p=jt({path:m,params:Z,parseCache:this.parsePathnameCache}).interpolatedPath,X=this.matchRoutes(p,void 0,{_buildLocation:!0}).map(f=>this.looseRoutesById[f.routeId]);if(Object.keys(Z).length>0)for(let f of X){let C=f.options.params?.stringify??f.options.stringifyParams;C&&Object.assign(Z,C(Z))}let h=ue(jt({path:m,params:Z,leaveWildcards:!1,leaveParams:e.leaveParams,decodeCharMap:this.pathParamsDecodeCharMap,parseCache:this.parsePathnameCache}).interpolatedPath),R=b;if(e._includeValidateSearch&&this.options.search?.strict){let f={};X.forEach(C=>{if(C.options.validateSearch)try{Object.assign(f,Dc(C.options.validateSearch,{...f,...R}))}catch{}}),R=f}R=ds({search:R,dest:i,destRoutes:X,_includeValidateSearch:e._includeValidateSearch}),R=S(b,R);let B=this.options.stringifySearch(R),v=i.hash===!0?l.hash:i.hash?$(i.hash,l.hash):void 0,H=v?`#${v}`:"",L=i.state===!0?l.state:i.state?$(i.state,l.state):{};L=S(l.state,L);let W=`${h}${B}${H}`,g=new URL(W,this.origin),I=Oc(this.rewrite,g);return{publicHref:I.pathname+I.search+I.hash,href:W,url:I.href,pathname:h,search:R,searchStr:B,state:L,hash:v??"",unmaskOnReload:i.unmaskOnReload}},a=(i={},l)=>{let r=o(i),s=l?o(l):void 0;if(!s){let n={},d=this.options.routeMasks?.find(b=>{let u=Ze(r.pathname,{to:b.from,caseSensitive:!1,fuzzy:!1},this.parsePathnameCache);return u?(n=u,!0):!1});if(d){let{from:b,...u}=d;l={from:e.from,...u,params:n},s=o(l)}}return s&&(r.maskedLocation=s),r};return e.mask?a(e,{from:e.from,...e.mask}):a(e)},this.commitLocation=({viewTransition:e,ignoreBlocker:o,...a})=>{let i=()=>{let s=["key","__TSR_key","__TSR_index","__hashScrollIntoViewOptions"];s.forEach(d=>{a.state[d]=this.latestLocation.state[d]});let n=ct(a.state,this.latestLocation.state);return s.forEach(d=>{delete a.state[d]}),n},l=K(this.latestLocation.href)===K(a.href),r=this.commitLocationPromise;if(this.commitLocationPromise=ot(()=>{r?.resolve()}),l&&i())this.load();else{let{maskedLocation:s,hashScrollIntoView:n,...d}=a;s&&(d={...s,state:{...s.state,__tempKey:void 0,__tempLocation:{...d,search:d.searchStr,state:{...d.state,__tempKey:void 0,__tempLocation:void 0,__TSR_key:void 0,key:void 0}}}},(d.unmaskOnReload??this.options.unmaskOnReload??!1)&&(d.state.__tempKey=this.tempLocationKey)),d.state.__hashScrollIntoViewOptions=n??this.options.defaultHashScrollIntoView??!0,this.shouldViewTransition=e,this.history[a.replace?"replace":"push"](d.publicHref,d.state,{ignoreBlocker:o})}return this.resetNextScroll=a.resetScroll??!0,this.history.subscribers.size||this.load(),this.commitLocationPromise},this.buildAndCommitLocation=({replace:e,resetScroll:o,hashScrollIntoView:a,viewTransition:i,ignoreBlocker:l,href:r,...s}={})=>{if(r){let d=this.history.location.state.__TSR_index,b=Ht(r,{__TSR_index:e?d:d+1});s.to=b.pathname,s.search=this.options.parseSearch(b.search),s.hash=b.hash.slice(1)}let n=this.buildLocation({...s,_includeValidateSearch:!0});return this.commitLocation({...n,viewTransition:i,replace:e,resetScroll:o,hashScrollIntoView:a,ignoreBlocker:l})},this.navigate=({to:e,reloadDocument:o,href:a,...i})=>{if(!o&&a)try{new URL(`${a}`),o=!0}catch{}return o?(a||(a=this.buildLocation({to:e,...i}).url),i.replace?window.location.replace(a):window.location.href=a,Promise.resolve()):this.buildAndCommitLocation({...i,href:a,to:e,_isNavigate:!0})},this.beforeLoad=()=>{if(this.cancelMatches(),this.updateLatestLocation(),this.isServer){let o=this.buildLocation({to:this.latestLocation.pathname,search:!0,params:!0,hash:!0,state:!0,_includeValidateSearch:!0}),a=i=>{try{return encodeURI(decodeURI(i))}catch{return i}};if(Vt(a(this.latestLocation.href))!==Vt(a(o.href))){let i=o.url;throw this.origin&&i.startsWith(this.origin)&&(i=i.replace(this.origin,"")||"/"),kc({href:i})}}let e=this.matchRoutes(this.latestLocation);this.__store.setState(o=>({...o,status:"pending",statusCode:200,isLoading:!0,location:this.latestLocation,pendingMatches:e,cachedMatches:o.cachedMatches.filter(a=>!e.some(i=>i.id===a.id))}))},this.load=async e=>{let o,a,i;for(i=new Promise(r=>{this.startTransition(async()=>{try{this.beforeLoad();let s=this.latestLocation,n=this.state.resolvedLocation;this.state.redirect||this.emit({type:"onBeforeNavigate",...at({resolvedLocation:n,location:s})}),this.emit({type:"onBeforeLoad",...at({resolvedLocation:n,location:s})}),await Mc({router:this,sync:e?.sync,matches:this.state.pendingMatches,location:s,updateMatch:this.updateMatch,onReady:async()=>{this.startViewTransition(async()=>{let d,b,u;ht(()=>{this.__store.setState(m=>{let Z=m.matches,p=m.pendingMatches||m.matches;return d=Z.filter(X=>!p.some(h=>h.id===X.id)),b=p.filter(X=>!Z.some(h=>h.id===X.id)),u=Z.filter(X=>p.some(h=>h.id===X.id)),{...m,isLoading:!1,loadedAt:Date.now(),matches:p,pendingMatches:void 0,cachedMatches:[...m.cachedMatches,...d.filter(X=>X.status!=="error")]}}),this.clearExpiredCache()}),[[d,"onLeave"],[b,"onEnter"],[u,"onStay"]].forEach(([m,Z])=>{m.forEach(p=>{this.looseRoutesById[p.routeId].options[Z]?.(p)})})})}})}catch(s){A(s)?(o=s,this.isServer||this.navigate({...o.options,replace:!0,ignoreBlocker:!0})):U(s)&&(a=s),this.__store.setState(n=>({...n,statusCode:o?o.status:a?404:n.matches.some(d=>d.status==="error")?500:200,redirect:o}))}this.latestLoadPromise===i&&(this.commitLocationPromise?.resolve(),this.latestLoadPromise=void 0,this.commitLocationPromise=void 0),r()})}),this.latestLoadPromise=i,await i;this.latestLoadPromise&&i!==this.latestLoadPromise;)await this.latestLoadPromise;let l;this.hasNotFoundMatch()?l=404:this.__store.state.matches.some(r=>r.status==="error")&&(l=500),l!==void 0&&this.__store.setState(r=>({...r,statusCode:l}))},this.startViewTransition=e=>{let o=this.shouldViewTransition??this.options.defaultViewTransition;if(delete this.shouldViewTransition,o&&typeof document<"u"&&"startViewTransition"in document&&typeof document.startViewTransition=="function"){let a;if(typeof o=="object"&&this.isViewTransitionTypesSupported){let i=this.latestLocation,l=this.state.resolvedLocation,r=typeof o.types=="function"?o.types(at({resolvedLocation:l,location:i})):o.types;if(r===!1){e();return}a={update:e,types:r}}else a=e;document.startViewTransition(a)}else e()},this.updateMatch=(e,o)=>{let a=this.state.pendingMatches?.some(i=>i.id===e)?"pendingMatches":this.state.matches.some(i=>i.id===e)?"matches":this.state.cachedMatches.some(i=>i.id===e)?"cachedMatches":"";a&&this.__store.setState(i=>({...i,[a]:i[a]?.map(l=>l.id===e?o(l):l)}))},this.getMatch=e=>{let o=a=>a.id===e;return this.state.cachedMatches.find(o)??this.state.pendingMatches?.find(o)??this.state.matches.find(o)},this.invalidate=e=>{let o=a=>e?.filter?.(a)??!0?{...a,invalid:!0,...e?.forcePending||a.status==="error"?{status:"pending",error:void 0}:void 0}:a;return this.__store.setState(a=>({...a,matches:a.matches.map(o),cachedMatches:a.cachedMatches.map(o),pendingMatches:a.pendingMatches?.map(o)})),this.shouldViewTransition=!1,this.load({sync:e?.sync})},this.resolveRedirect=e=>{if(!e.options.href){let o=this.buildLocation(e.options),a=o.url;this.origin&&a.startsWith(this.origin)&&(a=a.replace(this.origin,"")||"/"),e.options.href=o.href,e.headers.set("Location",a)}return e.headers.get("Location")||e.headers.set("Location",e.options.href),e},this.clearCache=e=>{let o=e?.filter;o!==void 0?this.__store.setState(a=>({...a,cachedMatches:a.cachedMatches.filter(i=>!o(i))})):this.__store.setState(a=>({...a,cachedMatches:[]}))},this.clearExpiredCache=()=>{let e=o=>{let a=this.looseRoutesById[o.routeId];if(!a.options.loader)return!0;let i=(o.preload?a.options.preloadGcTime??this.options.defaultPreloadGcTime:a.options.gcTime??this.options.defaultGcTime)??300*1e3;return o.status==="error"?!0:Date.now()-o.updatedAt>=i};this.clearCache({filter:e})},this.loadRouteChunk=Uc,this.preloadRoute=async e=>{let o=this.buildLocation(e),a=this.matchRoutes(o,{throwOnError:!0,preload:!0,dest:e}),i=new Set([...this.state.matches,...this.state.pendingMatches??[]].map(r=>r.id)),l=new Set([...i,...this.state.cachedMatches.map(r=>r.id)]);ht(()=>{a.forEach(r=>{l.has(r.id)||this.__store.setState(s=>({...s,cachedMatches:[...s.cachedMatches,r]}))})});try{return a=await Mc({router:this,matches:a,location:o,preload:!0,updateMatch:(r,s)=>{i.has(r)?a=a.map(n=>n.id===r?s(n):n):this.updateMatch(r,s)}}),a}catch(r){if(A(r))return r.options.reloadDocument?void 0:await this.preloadRoute({...r.options,_fromLocation:o});U(r)||console.error(r);return}},this.matchRoute=(e,o)=>{let a={...e,to:e.to?this.resolvePathWithBase(e.from||"",e.to):void 0,params:e.params||{},leaveParams:!0},i=this.buildLocation(a);if(o?.pending&&this.state.status!=="pending")return!1;let r=(o?.pending===void 0?!this.state.isLoading:o.pending)?this.latestLocation:this.state.resolvedLocation||this.state.location,s=Ze(r.pathname,{...o,to:i.pathname},this.parsePathnameCache);return!s||e.params&&!ct(s,e.params,{partial:!0})?!1:s&&(o?.includeSearch??!0)?ct(r.search,i.search,{partial:!0})?s:!1:s},this.hasNotFoundMatch=()=>this.__store.state.matches.some(e=>e.status==="notFound"||e.globalNotFound),this.update({defaultPreloadDelay:50,defaultPendingMs:1e3,defaultPendingMinMs:500,context:void 0,...c,caseSensitive:c.caseSensitive??!1,notFoundMode:c.notFoundMode??"fuzzy",stringifySearch:c.stringifySearch??Za,parseSearch:c.parseSearch??ma}),typeof document<"u"&&(self.__TSR_ROUTER__=this)}isShell(){return!!this.options.isShell}isPrerendering(){return!!this.options.isPrerendering}get state(){return this.__store.state}get looseRoutesById(){return this.routesById}matchRoutesInternal(c,e){let{foundRoute:o,matchedRoutes:a,routeParams:i}=this.getMatchedRoutes(c.pathname,e?.dest?.to),l=!1;(o?o.path!=="/"&&i["**"]:K(c.pathname))&&(this.options.notFoundRoute?a.push(this.options.notFoundRoute):l=!0);let r=(()=>{if(l){if(this.options.notFoundMode!=="root")for(let d=a.length-1;d>=0;d--){let b=a[d];if(b.children)return b.id}return J}})(),s=[],n=d=>d?.id?d.context??this.options.context??void 0:this.options.context??void 0;return a.forEach((d,b)=>{let u=s[b-1],[m,Z,p]=(()=>{let V=u?.search??c.search,nt=u?._strictSearch??void 0;try{let P=Dc(d.options.validateSearch,{...V})??void 0;return[{...V,...P},{...nt,...P},void 0]}catch(P){let Ft=P;if(P instanceof Nt||(Ft=new Nt(P.message,{cause:P})),e?.throwOnError)throw Ft;return[V,{},Ft]}})(),X=d.options.loaderDeps?.({search:m})??"",h=X?JSON.stringify(X):"",{interpolatedPath:R,usedParams:B}=jt({path:d.fullPath,params:i,decodeCharMap:this.pathParamsDecodeCharMap}),v=jt({path:d.id,params:i,leaveWildcards:!0,decodeCharMap:this.pathParamsDecodeCharMap,parseCache:this.parsePathnameCache}).interpolatedPath+h,H=this.getMatch(v),L=this.state.matches.find(V=>V.routeId===d.id),W=H?._strictParams??B,g;if(!H){let V=d.options.params?.parse??d.options.parseParams;if(V)try{Object.assign(W,V(W))}catch(nt){if(g=new Te(nt.message,{cause:nt}),e?.throwOnError)throw g}}Object.assign(i,W);let I=L?"stay":"enter",f;if(H)f={...H,cause:I,params:L?S(L.params,i):i,_strictParams:W,search:L?S(L.search,m):S(H.search,m),_strictSearch:Z};else{let V=d.options.loader||d.options.beforeLoad||d.lazyFn||zc(d)?"pending":"success";f={id:v,index:b,routeId:d.id,params:L?S(L.params,i):i,_strictParams:W,pathname:R,updatedAt:Date.now(),search:L?S(L.search,m):m,_strictSearch:Z,searchError:void 0,status:V,isFetching:!1,error:void 0,paramsError:g,__routeContext:void 0,_nonReactive:{loadPromise:ot()},__beforeLoadContext:void 0,context:{},abortController:new AbortController,fetchCount:0,cause:I,loaderDeps:L?S(L.loaderDeps,X):X,invalid:!1,preload:!1,links:void 0,scripts:void 0,headScripts:void 0,meta:void 0,staticData:d.options.staticData||{},fullPath:d.fullPath}}e?.preload||(f.globalNotFound=r===d.id),f.searchError=p;let C=n(u);f.context={...C,...f.__routeContext,...f.__beforeLoadContext},s.push(f)}),s.forEach((d,b)=>{let u=this.looseRoutesById[d.routeId];if(!this.getMatch(d.id)&&e?._buildLocation!==!0){let Z=s[b-1],p=n(Z);if(u.options.context){let X={deps:d.loaderDeps,params:d.params,context:p??{},location:c,navigate:h=>this.navigate({...h,_fromLocation:c}),buildLocation:this.buildLocation,cause:d.cause,abortController:d.abortController,preload:!!d.preload,matches:s};d.__routeContext=u.options.context(X)??void 0}d.context={...p,...d.__routeContext,...d.__beforeLoadContext}}}),s}},Nt=class extends Error{},Te=class extends Error{};function fa(t){return{loadedAt:0,isLoading:!1,isTransitioning:!1,status:"idle",resolvedLocation:void 0,location:t,matches:[],pendingMatches:[],cachedMatches:[],statusCode:200}}function Dc(t,c){if(t==null)return{};if("~standard"in t){let e=t["~standard"].validate(c);if(e instanceof Promise)throw new Nt("Async validation not supported");if(e.issues)throw new Nt(JSON.stringify(e.issues,void 0,2),{cause:e});return e.value}return"parse"in t?t.parse(c):typeof t=="function"?t(c):{}}function Ra({pathname:t,routePathname:c,caseSensitive:e,routesByPath:o,routesById:a,flatRoutes:i,parseCache:l}){let r={},s=K(t),n=m=>Ze(s,{to:m.fullPath,caseSensitive:m.options?.caseSensitive??e,fuzzy:!0},l),d=c!==void 0?o[c]:void 0;if(d)r=n(d);else{let m;for(let Z of i){let p=n(Z);if(p)if(Z.path!=="/"&&p["**"])m||(m={foundRoute:Z,routeParams:p});else{d=Z,r=p;break}}!d&&m&&(d=m.foundRoute,r=m.routeParams)}let b=d||a[J],u=[b];for(;b.parentRoute;)b=b.parentRoute,u.push(b);return u.reverse(),{matchedRoutes:u,routeParams:r,foundRoute:d}}function ds({search:t,dest:c,destRoutes:e,_includeValidateSearch:o}){let a=e.reduce((r,s)=>{let n=[];if("search"in s.options)s.options.search?.middlewares&&n.push(...s.options.search.middlewares);else if(s.options.preSearchFilters||s.options.postSearchFilters){let d=({search:b,next:u})=>{let m=b;"preSearchFilters"in s.options&&s.options.preSearchFilters&&(m=s.options.preSearchFilters.reduce((p,X)=>X(p),b));let Z=u(m);return"postSearchFilters"in s.options&&s.options.postSearchFilters?s.options.postSearchFilters.reduce((p,X)=>X(p),Z):Z};n.push(d)}if(o&&s.options.validateSearch){let d=({search:b,next:u})=>{let m=u(b);try{return{...m,...Dc(s.options.validateSearch,m)??void 0}}catch{return m}};n.push(d)}return r.concat(n)},[])??[],i=({search:r})=>c.search?c.search===!0?r:$(c.search,r):{};a.push(i);let l=(r,s)=>{if(r>=a.length)return s;let n=a[r];return n({search:s,next:b=>l(r+1,b)})};return l(0,t)}var Ac="Error preloading route! \u261D\uFE0F";var Et=class{constructor(c){if(this.init=e=>{this.originalIndex=e.originalIndex;let o=this.options,a=!o?.path&&!o?.id;this.parentRoute=this.options.getParentRoute?.(),a?this._path=J:this.parentRoute||D(!1,"Child Route instances must pass a 'getParentRoute: () => ParentRoute' option that returns a Route instance.");let i=a?J:o?.path;i&&i!=="/"&&(i=At(i));let l=o?.id||i,r=a?J:E([this.parentRoute.id===J?"":this.parentRoute.id,l]);i===J&&(i="/"),r!==J&&(r=E(["/",r]));let s=r===J?"/":E([this.parentRoute.fullPath,i]);this._path=i,this._id=r,this._fullPath=s,this._to=s},this.clone=e=>{this._path=e._path,this._id=e._id,this._fullPath=e._fullPath,this._to=e._to,this.options.getParentRoute=e.options.getParentRoute,this.children=e.children},this.addChildren=e=>this._addFileChildren(e),this._addFileChildren=e=>(Array.isArray(e)&&(this.children=e),typeof e=="object"&&e!==null&&(this.children=Object.values(e)),this),this._addFileTypes=()=>this,this.updateLoader=e=>(Object.assign(this.options,e),this),this.update=e=>(Object.assign(this.options,e),this),this.lazy=e=>(this.lazyFn=e,this),this.options=c||{},this.isRoot=!c?.getParentRoute,c?.id&&c?.path)throw new Error("Route cannot have both an 'id' and a 'path' option.")}get to(){return this._to}get id(){return this._id}get path(){return this._path}get fullPath(){return this._fullPath}};var We=class extends Et{constructor(c){super(c)}};var et=G(y(),1),Kt=G(M(),1);function _t(t){let c=t.errorComponent??Pt;return(0,et.jsx)(jc,{getResetKey:t.getResetKey,onCatch:t.onCatch,children:({error:e,reset:o})=>e?Kt.createElement(c,{error:e,reset:o}):t.children})}var jc=class extends Kt.Component{constructor(){super(...arguments),this.state={error:null}}static getDerivedStateFromProps(c){return{resetKey:c.getResetKey()}}static getDerivedStateFromError(c){return{error:c}}reset(){this.setState({error:null})}componentDidUpdate(c,e){e.error&&e.resetKey!==this.state.resetKey&&this.reset()}componentDidCatch(c,e){this.props.onCatch&&this.props.onCatch(c,e)}render(){return this.props.children({error:this.state.resetKey!==this.props.getResetKey()?null:this.state.error,reset:()=>{this.reset()}})}};function Pt({error:t}){let[c,e]=Kt.useState(!1);return(0,et.jsxs)("div",{style:{padding:".5rem",maxWidth:"100%"},children:[(0,et.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:".5rem"},children:[(0,et.jsx)("strong",{style:{fontSize:"1rem"},children:"Something went wrong!"}),(0,et.jsx)("button",{style:{appearance:"none",fontSize:".6em",border:"1px solid currentColor",padding:".1rem .2rem",fontWeight:"bold",borderRadius:".25rem"},onClick:()=>e(o=>!o),children:c?"Hide Error":"Show Error"})]}),(0,et.jsx)("div",{style:{height:".25rem"}}),c?(0,et.jsx)("div",{children:(0,et.jsx)("pre",{style:{fontSize:".7em",border:"1px solid red",borderRadius:".25rem",padding:".3rem",color:"red",overflow:"auto"},children:t.message?(0,et.jsx)("code",{children:t.message}):null})}):null]})}var Tc=G(y(),1),Ee=G(M(),1);function xa({children:t,fallback:c=null}){return us()?(0,Tc.jsx)(Ee.default.Fragment,{children:t}):(0,Tc.jsx)(Ee.default.Fragment,{children:c})}function us(){return Ee.default.useSyncExternalStore(ms,()=>!0,()=>!1)}function ms(){return()=>{}}var Zs=!0;function Gs(t,c){if(!Zs){if(t)return;var e="Warning: "+c;typeof console<"u"&&console.warn(e);try{throw Error(e)}catch{}}}var mt=Gs;var $c=G(y(),1);var to=G(M(),1);var Da=G(M(),1);var ka=G(Ja(),1);function Ma(t,c=o=>o,e={}){let o=e.equal??Cs;return(0,ka.useSyncExternalStoreWithSelector)(t.subscribe,()=>t.state,()=>t.state,c,o)}function Cs(t,c){if(Object.is(t,c))return!0;if(typeof t!="object"||t===null||typeof c!="object"||c===null)return!1;if(t instanceof Map&&c instanceof Map){if(t.size!==c.size)return!1;for(let[o,a]of t)if(!c.has(o)||!Object.is(a,c.get(o)))return!1;return!0}if(t instanceof Set&&c instanceof Set){if(t.size!==c.size)return!1;for(let o of t)if(!c.has(o))return!1;return!0}if(t instanceof Date&&c instanceof Date)return t.getTime()===c.getTime();let e=Qa(t);if(e.length!==Qa(c).length)return!1;for(let o=0;o<e.length;o++)if(!Object.prototype.hasOwnProperty.call(c,e[o])||!Object.is(t[e[o]],c[e[o]]))return!1;return!0}function Qa(t){return Object.keys(t).concat(Object.getOwnPropertySymbols(t))}var Sa=G(M(),1);var za=G(M(),1);var Ua=G(M(),1),Kc=Ua.createContext(null);function _e(){return typeof document>"u"?Kc:window.__TSR_ROUTER_CONTEXT__?window.__TSR_ROUTER_CONTEXT__:(window.__TSR_ROUTER_CONTEXT__=Kc,Kc)}function x(t){let c=za.useContext(_e());return mt(!((t?.warn??!0)&&!c),"useRouter must be used inside a <RouterProvider> component!"),c}function F(t){let c=x({warn:t?.router===void 0}),e=t?.router||c,o=(0,Sa.useRef)(void 0);return Ma(e.__store,a=>{if(t?.select){if(t.structuralSharing??e.options.defaultStructuralSharing){let i=S(o.current,t.select(a));return o.current=i,i}return t.select(a)}return a})}var _c=G(M(),1),Jt=_c.createContext(void 0),Oa=_c.createContext(void 0);function z(t){let c=Da.useContext(t.from?Oa:Jt);return F({select:o=>{let a=o.matches.find(i=>t.from?t.from===i.routeId:i.id===c);if(D(!((t.shouldThrow??!0)&&!a),`Could not find ${t.from?`an active match from "${t.from}"`:"a nearest match!"}`),a!==void 0)return t.select?t.select(a):a},structuralSharing:t.structuralSharing})}function ye(t){return z({from:t.from,strict:t.strict,structuralSharing:t.structuralSharing,select:c=>t.select?t.select(c.loaderData):c.loaderData})}function Be(t){let{select:c,...e}=t;return z({...e,select:o=>c?c(o.loaderDeps):o.loaderDeps})}function Ie(t){return z({from:t.from,shouldThrow:t.shouldThrow,structuralSharing:t.structuralSharing,strict:t.strict,select:c=>{let e=t.strict===!1?c.params:c._strictParams;return t.select?t.select(e):e}})}function fe(t){return z({from:t.from,strict:t.strict,shouldThrow:t.shouldThrow,structuralSharing:t.structuralSharing,select:c=>t.select?t.select(c.search):c.search})}var Pe=G(M(),1);function Re(t){let c=x();return Pe.useCallback(e=>c.navigate({...e,from:e.from??t?.from}),[t?.from,c])}var Ka=G(y(),1),Q=G(M(),1),_a=G(ja(),1);var it=G(M(),1);var ve=typeof window<"u"?it.useLayoutEffect:it.useEffect;function qe(t){let c=it.useRef({value:t,prev:null}),e=c.current.value;return t!==e&&(c.current={value:t,prev:e}),c.current.prev}function Ta(t,c,e={},o={}){it.useEffect(()=>{if(!t.current||o.disabled||typeof IntersectionObserver!="function")return;let a=new IntersectionObserver(([i])=>{c(i)},e);return a.observe(t.current),()=>{a.disconnect()}},[c,e,o.disabled,t])}function Ea(t){let c=it.useRef(null);return it.useImperativeHandle(t,()=>c.current,[]),c}function Pa(t,c){let e=x(),[o,a]=Q.useState(!1),i=Q.useRef(!1),l=Ea(c),{activeProps:r,inactiveProps:s,activeOptions:n,to:d,preload:b,preloadDelay:u,hashScrollIntoView:m,replace:Z,startTransition:p,resetScroll:X,viewTransition:h,children:R,target:B,disabled:v,style:H,className:L,onClick:W,onFocus:g,onMouseEnter:I,onMouseLeave:f,onTouchStart:C,ignoreBlocker:V,params:nt,search:P,hash:Ft,state:Uo,mask:Gl,reloadDocument:Br,unsafeRelative:Ir,from:fr,_fromLocation:Rr,...zo}=t,pl=F({select:Y=>Y.location.search,structuralSharing:!0}),So=t.from,ie=Q.useMemo(()=>({...t,from:So}),[e,pl,So,t._fromLocation,t.hash,t.to,t.search,t.params,t.state,t.mask,t.unsafeRelative]),bt=Q.useMemo(()=>e.buildLocation({...ie}),[e,ie]),Ne=Q.useMemo(()=>{if(v)return;let Y=bt.maskedLocation?bt.maskedLocation.url:bt.url,k=!1;return e.origin&&(Y.startsWith(e.origin)?Y=e.history.createHref(Y.replace(e.origin,""))||"/":k=!0),{href:Y,external:k}},[v,bt.maskedLocation,bt.url,e.origin,e.history]),Je=Q.useMemo(()=>{if(Ne?.external)return Ne.href;try{return new URL(d),d}catch{}},[d,Ne]),zt=t.reloadDocument||Je?!1:b??e.options.defaultPreload,vc=u??e.options.defaultPreloadDelay??0,Lc=F({select:Y=>{if(Je)return!1;if(n?.exact){if(!Cc(Y.location.pathname,bt.pathname,e.basepath))return!1}else{let k=Dt(Y.location.pathname,e.basepath),q=Dt(bt.pathname,e.basepath);if(!(k.startsWith(q)&&(k.length===q.length||k[q.length]==="/")))return!1}return(n?.includeSearch??!0)&&!ct(Y.location.search,bt.search,{partial:!n?.exact,ignoreUndefined:!n?.explicitUndefined})?!1:n?.includeHash?Y.location.hash===bt.hash:!0}}),wt=Q.useCallback(()=>{e.preloadRoute({...ie}).catch(Y=>{console.warn(Y),console.warn(Ac)})},[e,ie]),gl=Q.useCallback(Y=>{Y?.isIntersecting&&wt()},[wt]);Ta(l,gl,ks,{disabled:!!v||zt!=="viewport"}),Q.useEffect(()=>{i.current||!v&&zt==="render"&&(wt(),i.current=!0)},[v,wt,zt]);let Xl=Y=>{let k=Y.currentTarget.getAttribute("target"),q=B!==void 0?B:k;if(!v&&!Ms(Y)&&!Y.defaultPrevented&&(!q||q==="_self")&&Y.button===0){Y.preventDefault(),(0,_a.flushSync)(()=>{a(!0)});let jo=e.subscribe("onResolved",()=>{jo(),a(!1)});e.navigate({...ie,replace:Z,resetScroll:X,hashScrollIntoView:m,startTransition:p,viewTransition:h,ignoreBlocker:V})}};if(Je)return{...zo,ref:l,href:Je,...R&&{children:R},...B&&{target:B},...v&&{disabled:v},...H&&{style:H},...L&&{className:L},...W&&{onClick:W},...g&&{onFocus:g},...I&&{onMouseEnter:I},...f&&{onMouseLeave:f},...C&&{onTouchStart:C}};let Oo=Y=>{v||zt&&wt()},hl=Oo,Wl=Y=>{if(!(v||!zt))if(!vc)wt();else{let k=Y.target;if(Le.has(k))return;let q=setTimeout(()=>{Le.delete(k),wt()},vc);Le.set(k,q)}},yl=Y=>{if(v||!zt||!vc)return;let k=Y.target,q=Le.get(k);q&&(clearTimeout(q),Le.delete(k))},Qe=Lc?$(r,{})??Vs:Pc,ke=Lc?Pc:$(s,{})??Pc,Do=[L,Qe.className,ke.className].filter(Boolean).join(" "),Ao=(H||Qe.style||ke.style)&&{...H,...Qe.style,...ke.style};return{...zo,...Qe,...ke,href:Ne?.href,ref:l,onClick:xe([W,Xl]),onFocus:xe([g,Oo]),onMouseEnter:xe([I,Wl]),onMouseLeave:xe([f,yl]),onTouchStart:xe([C,hl]),disabled:!!v,target:B,...Ao&&{style:Ao},...Do&&{className:Do},...v&&Ns,...Lc&&Js,...o&&Qs}}var Pc={},Vs={className:"active"},Ns={role:"link","aria-disabled":!0},Js={"data-status":"active","aria-current":"page"},Qs={"data-transitioning":"transitioning"},Le=new WeakMap,ks={rootMargin:"100px"},xe=t=>c=>{for(let e of t)if(e){if(c.defaultPrevented)return;e(c)}};function qc(t){return Q.forwardRef(function(e,o){return(0,Ka.jsx)(Qt,{...e,_asChild:t,ref:o})})}var Qt=Q.forwardRef((t,c)=>{let{_asChild:e,...o}=t,{type:a,ref:i,...l}=Pa(o,c),r=typeof o.children=="function"?o.children({isActive:l["data-status"]==="active"}):o.children;return e===void 0&&delete l.disabled,Q.createElement(e||"a",{...l,ref:i},r)});function Ms(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}var $e=class extends Et{constructor(c){super(c),this.useMatch=e=>z({select:e?.select,from:this.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>z({...e,from:this.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>fe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useParams=e=>Ie({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useLoaderDeps=e=>Be({...e,from:this.id}),this.useLoaderData=e=>ye({...e,from:this.id}),this.useNavigate=()=>Re({from:this.fullPath}),this.Link=to.default.forwardRef((e,o)=>(0,$c.jsx)(Qt,{ref:o,from:this.fullPath,...e})),this.$$typeof=Symbol.for("react.memo")}};function Ye(t){return new $e(t)}var tc=class extends We{constructor(c){super(c),this.useMatch=e=>z({select:e?.select,from:this.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>z({...e,from:this.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>fe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useParams=e=>Ie({select:e?.select,structuralSharing:e?.structuralSharing,from:this.id}),this.useLoaderDeps=e=>Be({...e,from:this.id}),this.useLoaderData=e=>ye({...e,from:this.id}),this.useNavigate=()=>Re({from:this.fullPath}),this.Link=to.default.forwardRef((e,o)=>(0,$c.jsx)(Qt,{ref:o,from:this.fullPath,...e})),this.$$typeof=Symbol.for("react.memo")}};function eo(t){return new tc(t)}function co(t){return typeof t=="object"?new ec(t,{silent:!0}).createRoute(t):new ec(t,{silent:!0}).createRoute}var ec=class{constructor(c,e){this.path=c,this.createRoute=o=>{mt(this.silent,"FileRoute is deprecated and will be removed in the next major version. Use the createFileRoute(path)(options) function instead.");let a=Ye(o);return a.isRoot=!1,a},this.silent=e?.silent}};var cc=class{constructor(c){this.useMatch=e=>z({select:e?.select,from:this.options.id,structuralSharing:e?.structuralSharing}),this.useRouteContext=e=>z({from:this.options.id,select:o=>e?.select?e.select(o.context):o.context}),this.useSearch=e=>fe({select:e?.select,structuralSharing:e?.structuralSharing,from:this.options.id}),this.useParams=e=>Ie({select:e?.select,structuralSharing:e?.structuralSharing,from:this.options.id}),this.useLoaderDeps=e=>Be({...e,from:this.options.id}),this.useLoaderData=e=>ye({...e,from:this.options.id}),this.useNavigate=()=>{let e=x();return Re({from:e.routesById[this.options.id].fullPath})},this.options=c,this.$$typeof=Symbol.for("react.memo")}};function oo(t){return typeof t=="object"?new cc(t):c=>new cc({id:t,...c})}var lt=G(y(),1),sc=G(M(),1);var ft=G(M(),1);function qa(){let t=x(),c=ft.useRef({router:t,mounted:!1}),[e,o]=ft.useState(!1),{hasPendingMatches:a,isLoading:i}=F({select:b=>({isLoading:b.isLoading,hasPendingMatches:b.matches.some(u=>u.status==="pending")}),structuralSharing:!0}),l=qe(i),r=i||e||a,s=qe(r),n=i||a,d=qe(n);return t.startTransition=b=>{o(!0),ft.startTransition(()=>{b(),o(!1)})},ft.useEffect(()=>{let b=t.history.subscribe(t.load),u=t.buildLocation({to:t.latestLocation.pathname,search:!0,params:!0,hash:!0,state:!0,_includeValidateSearch:!0});return K(t.latestLocation.href)!==K(u.href)&&t.commitLocation({...u,replace:!0}),()=>{b()}},[t,t.history]),ve(()=>{if(typeof window<"u"&&t.ssr||c.current.router===t&&c.current.mounted)return;c.current={router:t,mounted:!0},(async()=>{try{await t.load()}catch(u){console.error(u)}})()},[t]),ve(()=>{l&&!i&&t.emit({type:"onLoad",...at(t.state)})},[l,t,i]),ve(()=>{d&&!n&&t.emit({type:"onBeforeRouteMount",...at(t.state)})},[n,d,t]),ve(()=>{s&&!r&&(t.emit({type:"onResolved",...at(t.state)}),t.__store.setState(b=>({...b,status:"idle",resolvedLocation:b.location})),Jc(t))},[r,s,t]),null}var w=G(y(),1),O=G(M(),1);var ao=G(y(),1);function $a(t){let c=F({select:e=>`not-found-${e.location.pathname}-${e.status}`});return(0,ao.jsx)(_t,{getResetKey:()=>c,onCatch:(e,o)=>{if(U(e))t.onCatch?.(e,o);else throw e},errorComponent:({error:e})=>{if(U(e))return t.fallback?.(e);throw e},children:t.children})}function ti(){return(0,ao.jsx)("p",{children:"Not Found"})}var oc=G(y(),1);function Rt(t){return(0,oc.jsx)(oc.Fragment,{children:t.children})}var ac=G(y(),1);function io(t,c,e){return c.options.notFoundComponent?(0,ac.jsx)(c.options.notFoundComponent,{data:e}):t.options.defaultNotFoundComponent?(0,ac.jsx)(t.options.defaultNotFoundComponent,{data:e}):(0,ac.jsx)(ti,{})}var oi=G(y(),1);var ei=G(y(),1);function ci({children:t}){let c=x();return c.isServer?(0,ei.jsx)("script",{nonce:c.options.ssr?.nonce,className:"$tsr",dangerouslySetInnerHTML:{__html:[t].filter(Boolean).join(`
`)+";$_TSR.c()"}}):null}function ai(){let t=x();if(!t.isScrollRestoring||!t.isServer||typeof t.options.scrollRestoration=="function"&&!t.options.scrollRestoration({location:t.latestLocation}))return null;let e=(t.options.getScrollRestorationKey||pe)(t.latestLocation),o=e!==pe(t.latestLocation)?e:void 0,a={storageKey:Tt,shouldScrollRestoration:!0};return o&&(a.key=o),(0,oi.jsx)(ci,{children:`(${Oe.toString()})(${JSON.stringify(a)})`})}var ic=O.memo(function({matchId:c}){let e=x(),o=F({select:h=>{let R=h.matches.find(B=>B.id===c);return D(R,`Could not find match for matchId "${c}". Please file an issue!`),{routeId:R.routeId,ssr:R.ssr,_displayPending:R._displayPending}},structuralSharing:!0}),a=e.routesById[o.routeId],i=a.options.pendingComponent??e.options.defaultPendingComponent,l=i?(0,w.jsx)(i,{}):null,r=a.options.errorComponent??e.options.defaultErrorComponent,s=a.options.onCatch??e.options.defaultOnCatch,n=a.isRoot?a.options.notFoundComponent??e.options.notFoundRoute?.options.component:a.options.notFoundComponent,d=o.ssr===!1||o.ssr==="data-only",b=(!a.isRoot||a.options.wrapInSuspense||d)&&(a.options.wrapInSuspense??i??(a.options.errorComponent?.preload||d))?O.Suspense:Rt,u=r?_t:Rt,m=n?$a:Rt,Z=F({select:h=>h.loadedAt}),p=F({select:h=>{let R=h.matches.findIndex(B=>B.id===c);return h.matches[R-1]?.routeId}}),X=a.isRoot?a.options.shellComponent??Rt:Rt;return(0,w.jsxs)(X,{children:[(0,w.jsx)(Jt.Provider,{value:c,children:(0,w.jsx)(b,{fallback:l,children:(0,w.jsx)(u,{getResetKey:()=>Z,errorComponent:r||Pt,onCatch:(h,R)=>{if(U(h))throw h;mt(!1,`Error in route match: ${c}`),s?.(h,R)},children:(0,w.jsx)(m,{fallback:h=>{if(!n||h.routeId&&h.routeId!==o.routeId||!h.routeId&&!a.isRoot)throw h;return O.createElement(n,h)},children:d||o._displayPending?(0,w.jsx)(xa,{fallback:l,children:(0,w.jsx)(ii,{matchId:c})}):(0,w.jsx)(ii,{matchId:c})})})})}),p===J&&e.options.scrollRestoration?(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(Us,{}),(0,w.jsx)(ai,{})]}):null]})});function Us(){let t=x(),c=O.useRef(void 0);return(0,w.jsx)("script",{suppressHydrationWarning:!0,ref:e=>{e&&(c.current===void 0||c.current.href!==t.latestLocation.href)&&(t.emit({type:"onRendered",...at(t.state)}),c.current=t.latestLocation)}},t.latestLocation.state.__TSR_key)}var ii=O.memo(function({matchId:c}){let e=x(),{match:o,key:a,routeId:i}=F({select:s=>{let n=s.matches.find(Z=>Z.id===c),d=n.routeId,u=(e.routesById[d].options.remountDeps??e.options.defaultRemountDeps)?.({routeId:d,loaderDeps:n.loaderDeps,params:n._strictParams,search:n._strictSearch});return{key:u?JSON.stringify(u):void 0,routeId:d,match:{id:n.id,status:n.status,error:n.error,_forcePending:n._forcePending,_displayPending:n._displayPending}}},structuralSharing:!0}),l=e.routesById[i],r=O.useMemo(()=>{let s=l.options.component??e.options.defaultComponent;return s?(0,w.jsx)(s,{},a):(0,w.jsx)(lc,{})},[a,l.options.component,e.options.defaultComponent]);if(o._displayPending)throw e.getMatch(o.id)?._nonReactive.displayPendingPromise;if(o._forcePending)throw e.getMatch(o.id)?._nonReactive.minPendingPromise;if(o.status==="pending"){let s=l.options.pendingMinMs??e.options.defaultPendingMinMs;if(s){let n=e.getMatch(o.id);if(n&&!n._nonReactive.minPendingPromise&&!e.isServer){let d=ot();n._nonReactive.minPendingPromise=d,setTimeout(()=>{d.resolve(),n._nonReactive.minPendingPromise=void 0},s)}}throw e.getMatch(o.id)?._nonReactive.loadPromise}if(o.status==="notFound")return D(U(o.error),"Expected a notFound error"),io(e,l,o.error);if(o.status==="redirected")throw D(A(o.error),"Expected a redirect error"),e.getMatch(o.id)?._nonReactive.loadPromise;if(o.status==="error"){if(e.isServer){let s=(l.options.errorComponent??e.options.defaultErrorComponent)||Pt;return(0,w.jsx)(s,{error:o.error,reset:void 0,info:{componentStack:""}})}throw o.error}return r}),lc=O.memo(function(){let c=x(),e=O.useContext(Jt),o=F({select:n=>n.matches.find(d=>d.id===e)?.routeId}),a=c.routesById[o],i=F({select:n=>{let b=n.matches.find(u=>u.id===e);return D(b,`Could not find parent match for matchId "${e}"`),b.globalNotFound}}),l=F({select:n=>{let d=n.matches,b=d.findIndex(u=>u.id===e);return d[b+1]?.id}}),r=c.options.defaultPendingComponent?(0,w.jsx)(c.options.defaultPendingComponent,{}):null;if(i)return io(c,a,void 0);if(!l)return null;let s=(0,w.jsx)(ic,{matchId:l});return e===J?(0,w.jsx)(O.Suspense,{fallback:r,children:s}):s});function lo(){let t=x(),e=t.routesById[J].options.pendingComponent??t.options.defaultPendingComponent,o=e?(0,lt.jsx)(e,{}):null,a=t.isServer||typeof document<"u"&&t.ssr?Rt:sc.Suspense,i=(0,lt.jsxs)(a,{fallback:o,children:[!t.isServer&&(0,lt.jsx)(qa,{}),(0,lt.jsx)(zs,{})]});return t.options.InnerWrap?(0,lt.jsx)(t.options.InnerWrap,{children:i}):i}function zs(){let t=x(),c=F({select:a=>a.matches[0]?.id}),e=F({select:a=>a.loadedAt}),o=c?(0,lt.jsx)(ic,{matchId:c}):null;return(0,lt.jsx)(Jt.Provider,{value:c,children:t.options.disableGlobalCatchBoundary?o:(0,lt.jsx)(_t,{getResetKey:()=>e,errorComponent:Pt,onCatch:a=>{mt(!1,"The following error wasn't caught by any route! At the very least, consider setting an 'errorComponent' in your RootRoute!"),mt(!1,a.message||a.toString())},children:o})})}function so(t){return F({select:c=>{let e=c.matches;return t?.select?t.select(e):e},structuralSharing:t?.structuralSharing})}var ro=t=>new rc(t),rc=class extends he{constructor(c){super(c)}};typeof globalThis<"u"?(globalThis.createFileRoute=co,globalThis.createLazyFileRoute=oo):typeof window<"u"&&(window.createFileRoute=co,window.createLazyFileRoute=oo);var Fe=G(y(),1);function li({router:t,children:c,...e}){Object.keys(e).length>0&&t.update({...t.options,...e,context:{...t.options.context,...e.context}});let o=_e(),a=(0,Fe.jsx)(o.Provider,{value:t,children:c});return t.options.Wrap?(0,Fe.jsx)(t.options.Wrap,{children:a}):a}function no({router:t,...c}){return(0,Fe.jsx)(li,{router:t,...c,children:(0,Fe.jsx)(lo,{})})}function bo(){return F({select:t=>t.location.state.__TSR_index!==0})}var bl=G(kt());var cl=G(uo()),ol=G(ni());var gc=G(Xt()),$t=G(Zt()),Fo=G(kt()),vi=G(mo()),Li=G(Zi());var dc=G(gt()),Zo=(0,dc.forwardRef)(({icon:t,size:c=24,...e},o)=>(0,dc.cloneElement)(t,{width:c,height:c,...e,ref:o}));var nc=G(Gt()),Go=G(y()),po=(0,Go.jsx)(nc.SVG,{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:(0,Go.jsx)(nc.Path,{d:"m15.99 10.889-3.988 3.418-3.988-3.418.976-1.14 3.012 2.582 3.012-2.581.976 1.139Z"})});var bc=G(Gt()),go=G(y()),Xo=(0,go.jsx)(bc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,go.jsx)(bc.Path,{d:"m13.1 16-3.4-4 3.4-4 1.1 1-2.6 3 2.6 3-1.1 1z"})});var uc=G(Gt()),ho=G(y()),Wo=(0,ho.jsx)(uc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,ho.jsx)(uc.Path,{d:"M14.6 7l-1.2-1L8 12l5.4 6 1.2-1-4.6-5z"})});var mc=G(Gt()),yo=G(y()),Bo=(0,yo.jsx)(mc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,yo.jsx)(mc.Path,{d:"M10.8622 8.04053L14.2805 12.0286L10.8622 16.0167L9.72327 15.0405L12.3049 12.0286L9.72327 9.01672L10.8622 8.04053Z"})});var Zc=G(Gt()),Io=G(y()),fo=(0,Io.jsx)(Zc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,Io.jsx)(Zc.Path,{d:"M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z"})});var Gc=G(Gt()),Ro=G(y()),vo=(0,Ro.jsx)(Gc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,Ro.jsx)(Gc.Path,{d:"M13 5c-3.3 0-6 2.7-6 6 0 1.4.5 2.7 1.3 3.7l-3.8 3.8 1.1 1.1 3.8-3.8c1 .8 2.3 1.3 3.7 1.3 3.3 0 6-2.7 6-6S16.3 5 13 5zm0 10.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z"})});var pc=G(Gt()),Lo=G(y()),xo=(0,Lo.jsx)(pc.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"-2 -2 24 24",children:(0,Lo.jsx)(pc.Path,{d:"M20 10c0-5.51-4.49-10-10-10C4.48 0 0 4.49 0 10c0 5.52 4.48 10 10 10 5.51 0 10-4.48 10-10zM7.78 15.37L4.37 6.22c.55-.02 1.17-.08 1.17-.08.5-.06.44-1.13-.06-1.11 0 0-1.45.11-2.37.11-.18 0-.37 0-.58-.01C4.12 2.69 6.87 1.11 10 1.11c2.33 0 4.45.87 6.05 2.34-.68-.11-1.65.39-1.65 1.58 0 .74.45 1.36.9 2.1.35.61.55 1.36.55 2.46 0 1.49-1.4 5-1.4 5l-3.03-8.37c.54-.02.82-.17.82-.17.5-.05.44-1.25-.06-1.22 0 0-1.44.12-2.38.12-.87 0-2.33-.12-2.33-.12-.5-.03-.56 1.2-.06 1.22l.92.08 1.26 3.41zM17.41 10c.24-.64.74-1.87.43-4.25.7 1.29 1.05 2.71 1.05 4.25 0 3.29-1.73 6.24-4.4 7.78.97-2.59 1.94-5.2 2.92-7.78zM6.1 18.09C3.12 16.65 1.11 13.53 1.11 10c0-1.3.23-2.48.72-3.59C3.25 10.3 4.67 14.2 6.1 18.09zm4.03-6.63l2.58 6.98c-.86.29-1.76.45-2.71.45-.79 0-1.57-.11-2.29-.33.81-2.38 1.62-4.74 2.42-7.1z"})});var xi=G(gi()),Yi=G(uo()),Fi=G(hi());function Wi(t){var c,e,o="";if(typeof t=="string"||typeof t=="number")o+=t;else if(typeof t=="object")if(Array.isArray(t)){var a=t.length;for(c=0;c<a;c++)t[c]&&(e=Wi(t[c]))&&(o&&(o+=" "),o+=e)}else for(e in t)t[e]&&(o&&(o+=" "),o+=e);return o}function Ss(){for(var t,c,e=0,o="",a=arguments.length;e<a;e++)(t=arguments[e])&&(c=Wi(t))&&(o&&(o+=" "),o+=c);return o}var j=Ss;var yi=G(Xt());var Bi=G(kt()),Ii=G(mo()),we=G(y()),Os=`/**
 * SCSS Variables.
 *
