...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React48 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef20 = React48.useRef, useEffect18 = React48.useEffect, useMemo18 = React48.useMemo, useDebugValue2 = React48.useDebugValue;
...
var TooltipStore = class _TooltipStore extends ReactStore {
  ...
  static useStore(externalStore, initialState2) {
    const internalStore = useRefWithInit(() => {
      return new _TooltipStore(initialState2);
    }).current;
...
var Popup = (0, import_element14.forwardRef)(function TooltipPopup3({ portal, positioner, children, className, ...props }, ref) {
  const popupContent = (
     ...
     *     below
     */
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(ThemeProvider, { color: { bg: "#1e1e1e" }, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
...
var RouterLinkItem = createLink((0, import_element17.forwardRef)(AnchorOnlyItem));
...
function isSvg(element) {
  return (0, import_element18.isValidElement)(element) && (element.type === import_primitives12.SVG || element.type === "svg");
}
...
function useSidebarParent() {
  ...
  const [parentId, setParentId] = (0, import_element19.useState)(
    findDrilldownParent(currentMenuItem?.id, menuItems)
  );
  const [parentDropdownId, setParentDropdownId] = (0, import_element19.useState)(findDropdownParent(currentMenuItem?.id, menuItems));
...
function Navigation() {
  const backButtonRef = (0, import_element20.useRef)(null);
  const [animationDirection, setAnimationDirection] = (0, import_element20.useState)(null);
  ...
  const parent = (0, import_element20.useMemo)(
  ...
  const items = (0, import_element20.useMemo)(
...
function SaveButton() {
  const [isSaveViewOpen, setIsSaveViewOpened] = (0, import_element22.useState)(false);
  ...
  const [showSavedState, setShowSavedState] = (0, import_element22.useState)(false);
...
function Canvas({ canvas }) {
  const [Editor, setEditor] = (0, import_element24.useState)(null);
...
function CanvasRenderer({
  ...
  const [CustomCanvas, setCustomCanvas] = (0, import_element25.useState)(null);
...
function useRouteTitle() {
  ...
  const isInitialLocationRef = (0, import_element26.useRef)(true);
...
function Root2() {
  ...
  const [isMobileSidebarOpen, setIsMobileSidebarOpen] = (0, import_element27.useState)(false);
...
function Router({
  ...
  const router = (0, import_element28.useMemo)(() => {
...
async function init({
  ...
  if (rootElement) {
    const root = (0, import_element29.createRoot)(rootElement);
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_element29.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(App, {}) })
    );
  }
}
async function initSinglePage({
  ...
  if (rootElement) {
    const root = (0, import_element29.createRoot)(rootElement);
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_element29.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(App, { rootComponent: RootSinglePage }) })
    );
  }
}

// packages/boot/build-module/index.mjs
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='31e05eb23a']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "31e05eb23a");
