...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='faf95e4e3c']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "faf95e4e3c");
  style.appendChild(document.createTextNode(".boot-site-icon{display:flex}.boot-site-icon__icon{fill:var(--wpds-color-fg-content-neutral,#1e1e1e);height:32px;width:32px}.boot-site-icon__image{aspect-ratio:1/1;border-radius:var(--wpds-border-radius-surface-md,4px);height:32px;object-fit:cover;width:32px}"));
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='903b4302af']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "903b4302af");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='aa981d5c80']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "aa981d5c80");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='a28bae34c6']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "a28bae34c6");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='2af26d6e85']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "2af26d6e85");
