...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='f48cc9e42b']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "f48cc9e42b");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='d071475a49']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "d071475a49");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='905f43ef17']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "905f43ef17");
