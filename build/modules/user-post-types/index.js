...
function usePublicTaxonomies() {
  ...
  return (0, import_element.useMemo)(() => {
    return taxonomies?.filter((t) => t.visibility?.public ?? false).sort((a, b) => {
...
var supportsField = {
  ...
  render: ({ item }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_jsx_runtime34.Fragment, { children: features.map((f) => SUPPORT_LABELS[f] ?? f).join(", ") });
  },
  filterBy: false
};
var statusField = {
