...
// packages/user-post-types/build-module/utils.mjs
...
// packages/user-post-types/build-module/fields/general.mjs
...
// packages/user-post-types/build-module/lock-unlock.mjs
...
var SUPPORT_LABELS = {
  title: (0, import_i18n4.__)("Title"),
  editor: (0, import_i18n4.__)("Editor"),
  thumbnail: (0, import_i18n4.__)("Featured image"),
  excerpt: (0, import_i18n4.__)("Excerpt"),
  comments: (0, import_i18n4.__)("Comments"),
  revisions: (0, import_i18n4.__)("Revisions"),
  author: (0, import_i18n4.__)("Author"),
  "page-attributes": (0, import_i18n4.__)("Page attributes"),
  "custom-fields": (0, import_i18n4.__)("Custom fields"),
  trackbacks: (0, import_i18n4.__)("Trackbacks"),
  "post-formats": (0, import_i18n4.__)("Post formats")
};
var titleField = {
  id: "title",
...
var hasArchiveField = {
  id: "has_archive",
  label: (0, import_i18n4.__)("Has archive"),
  type: "boolean",
  description: (0, import_i18n4.__)(
...
var showInRestField = {
  id: "show_in_rest",
  label: (0, import_i18n4.__)("Show in REST API"),
  type: "boolean",
  description: (0, import_i18n4.__)(
...
var supportsField = {
  id: "supports",
  label: (0, import_i18n4.__)("Supports"),
  type: "array",
  description: (0, import_i18n4.__)(
  ...
  render: ({ item }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_jsx_runtime51.Fragment, { children: features.map((f2) => SUPPORT_LABELS[f2] ?? f2).join(", ") });
  },
  filterBy: false
};
var statusField = {
  ...
  render: ({ item }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(Badge, { intent: isActive ? "stable" : "draft", children: isActive ? (0, import_i18n4.__)("Active") : (0, import_i18n4.__)("Inactive") });
  },
  enableSorting: false
};
...
function useSlugField(originalSlug, currentValue) {
  const registeredPostTypes = (0, import_data2.useSelect)(
    (select) => select(import_core_data2.store).getPostTypes(),
    []
  );
  ...
  return (0, import_element41.useMemo)(
    () => ({
      id: "slug",
      label: (0, import_i18n4.__)("Post type key"),
      type: "text",
      enableGlobalSearch: true,
      description: /* @__PURE__ */ (0, import_jsx_runtime51.jsxs)(Stack, { direction: "column", gap: "sm", render: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("span", {}), children: [
        showRenameWarning && /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(notice_exports.Root, { intent: "warning", render: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("span", {}), children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(notice_exports.Description, { children: (0, import_i18n4.__)(
          "Changing the key renames the post type \u2014 existing posts may become inaccessible until a migration updates the database."
        ) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("span", { children: (0, import_i18n4.__)(
      ...
      isValid: {
        ...
        custom: async (value) => {
          ...
          if (slugTaken) {
            return (0, import_i18n4.__)("This post type key is already in use.");
          }
          ...
          return !!drafts?.length ? (0, import_i18n4.__)("This post type key is already in use.") : null;
        }
      },
...
function useTaxonomiesField() {
  ...
  return (0, import_element41.useMemo)(() => {
    ...
    return {
      id: "taxonomies",
      label: (0, import_i18n4.__)("Taxonomies"),
      type: "array",
      description: (0, import_i18n4.__)(
...
// packages/user-post-types/build-module/fields/labels.mjs
...
var menuNameField = labelField("menu_name", (0, import_i18n5.__)("Menu name"), {
  placeholder: (0, import_i18n5.__)("Posts"),
...
var allItemsField = labelField("all_items", (0, import_i18n5.__)("All items"), {
  placeholder: (0, import_i18n5.__)("All Posts")
});
var addNewField = labelField("add_new", (0, import_i18n5.__)("Add new"), {
  placeholder: (0, import_i18n5.__)("Add New"),
  description: (0, import_i18n5.__)("Shown in the admin menu and on toolbar buttons.")
});
var addNewItemLabelField = labelField(
  "add_new_item",
  (0, import_i18n5.__)("Add new item"),
  {
    placeholder: (0, import_i18n5.__)("Add New Post")
  }
);
var editItemField = labelField("edit_item", (0, import_i18n5.__)("Edit item"), {
  placeholder: (0, import_i18n5.__)("Edit Post")
});
var newItemField = labelField("new_item", (0, import_i18n5.__)("New item"), {
  placeholder: (0, import_i18n5.__)("New Post")
});
var viewItemField = labelField("view_item", (0, import_i18n5.__)("View item"), {
  placeholder: (0, import_i18n5.__)("View Post")
});
var viewItemsField = labelField("view_items", (0, import_i18n5.__)("View items"), {
  placeholder: (0, import_i18n5.__)("View Posts"),
  description: (0, import_i18n5.__)("Used as the link label for the post type archive.")
});
var searchItemsField = labelField(
  "search_items",
  (0, import_i18n5.__)("Search items"),
  {
    placeholder: (0, import_i18n5.__)("Search Posts")
  }
);
var notFoundField = labelField("not_found", (0, import_i18n5.__)("Not found"), {
  placeholder: (0, import_i18n5.__)("No posts found."),
  description: (0, import_i18n5.__)("Shown in the admin list when no posts match.")
});
var notFoundInTrashField = labelField(
  "not_found_in_trash",
  (0, import_i18n5.__)("Not found in trash"),
  {
    placeholder: (0, import_i18n5.__)("No posts found in Trash.")
  }
);
var archivesField = labelField("archives", (0, import_i18n5.__)("Archives"), {
  placeholder: (0, import_i18n5.__)("Post Archives"),
  description: (0, import_i18n5.__)(
    "Used in the navigation menus block when adding a link to the post type archive."
  )
});
var attributesField = labelField("attributes", (0, import_i18n5.__)("Attributes"), {
  placeholder: (0, import_i18n5.__)("Post Attributes"),
  description: (0, import_i18n5.__)(
...
var parentItemColonField = labelField(
  ...
  {
    placeholder: (0, import_i18n5.__)("Parent Page:"),
    description: (0, import_i18n5.__)(
...
var insertIntoItemField = labelField(
  "insert_into_item",
  (0, import_i18n5.__)("Insert into item"),
  {
    placeholder: (0, import_i18n5.__)("Insert into post"),
    description: (0, import_i18n5.__)("Shown in the media library uploader.")
  }
);
var uploadedToThisItemField = labelField(
  "uploaded_to_this_item",
  (0, import_i18n5.__)("Uploaded to this item"),
  {
    placeholder: (0, import_i18n5.__)("Uploaded to this post")
  }
);
var featuredImageField = labelField(
  "featured_image",
  (0, import_i18n5.__)("Featured image"),
  {
    placeholder: (0, import_i18n5.__)("Featured image")
  }
);
var setFeaturedImageField = labelField(
  "set_featured_image",
  (0, import_i18n5.__)("Set featured image"),
  {
    placeholder: (0, import_i18n5.__)("Set featured image")
  }
);
var removeFeaturedImageField = labelField(
  "remove_featured_image",
  (0, import_i18n5.__)("Remove featured image"),
  {
    placeholder: (0, import_i18n5.__)("Remove featured image")
  }
);
var useFeaturedImageField = labelField(
  "use_featured_image",
  (0, import_i18n5.__)("Use as featured image"),
  {
    placeholder: (0, import_i18n5.__)("Use as featured image")
  }
);
var filterItemsListField = labelField(
  "filter_items_list",
  (0, import_i18n5.__)("Filter items list"),
  {
    placeholder: (0, import_i18n5.__)("Filter posts list"),
    description: (0, import_i18n5.__)(
...
var itemsListNavigationField = labelField(
  "items_list_navigation",
  (0, import_i18n5.__)("Items list navigation"),
  {
    placeholder: (0, import_i18n5.__)("Posts list navigation"),
    description: (0, import_i18n5.__)("Screen reader text for the admin list pagination.")
  }
);
var itemsListField = labelField("items_list", (0, import_i18n5.__)("Items list"), {
  placeholder: (0, import_i18n5.__)("Posts list"),
  description: (0, import_i18n5.__)("Screen reader text for the admin list table.")
});
var labelsForm = {
  layout: { type: "regular" },
...
// packages/user-post-types/build-module/actions/activate.mjs
var import_i18n6 = __toESM(require_i18n(), 1);

// packages/user-post-types/build-module/actions/utils.mjs
...
var activateAction = createStatusAction({
  ...
  messages: {
    successSingle: (0, import_i18n6.__)("Post type activated."),
    ...
    failSingle: (0, import_i18n6.__)("Failed to activate post type."),
    failMany: (0, import_i18n6.__)("Failed to activate post types."),
    errorSingle: (message2) => (0, import_i18n6.sprintf)(
      /* translators: %s: an error message */
      (0, import_i18n6.__)("An error occurred while activating the post type: %s"),
      message2
    ),
...
// packages/user-post-types/build-module/actions/deactivate.mjs
...
var deactivateAction = createStatusAction({
  ...
  targetStatus: "draft",
  messages: {
    successSingle: (0, import_i18n7.__)("Post type deactivated."),
    ...
    failSingle: (0, import_i18n7.__)("Failed to deactivate post type."),
    failMany: (0, import_i18n7.__)("Failed to deactivate post types."),
    errorSingle: (message2) => (0, import_i18n7.sprintf)(
      /* translators: %s: an error message */
      (0, import_i18n7.__)("An error occurred while deactivating the post type: %s"),
      message2
    ),
...
// packages/user-post-types/build-module/actions/delete.mjs
...
function DeletePostTypeModal({
    ...
    if (promiseResult.every(({ status }) => status === "fulfilled")) {
      createSuccessNotice(
        itemsToDelete.length === 1 ? (0, import_i18n8.sprintf)(
          ...
          (0, import_i18n8.__)('"%s" post type deleted.'),
      ...
      if (promiseResult.length === 1) {
        ...
        if (typedError.reason?.message && typedError.reason.code !== "unknown_error") {
          ...
          errorMessage = (0, import_i18n8.__)("Failed to delete post type.");
        }
      } else {
        const errorMessages = /* @__PURE__ */ new Set();
        const failedPromises = promiseResult.filter(
        ...
        if (errorMessages.size === 0) {
          errorMessage = (0, import_i18n8.__)("Failed to delete post types.");
        } else if (errorMessages.size === 1) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(Stack, { direction: "column", gap: "md", children: [
    /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(Text, { children: items.length > 1 ? (0, import_i18n8.sprintf)(
...
// packages/user-post-types/build-module/actions/duplicate.mjs
...
var { ValidatedCheckboxControl } = unlock3(import_components3.privateApis);
function Checkbox({
  field,
  onChange,
  data,
...
var { ValidatedComboboxControl } = unlock3(import_components4.privateApis);
function Combobox({
  data,
  field,
  onChange,
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(import_components4.Spinner, {});
  }
...
function RelativeDateControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime56.jsx)(
    import_components5.BaseControl,
    {
      ...
      hideLabelFromVision,
      help: description,
      children: /* @__PURE__ */ (0, import_jsx_runtime56.jsxs)(Stack, { direction: "row", gap: "sm", children: [
...
var { DateCalendar, ValidatedInputControl: ValidatedInputControl2 } = unlock3(import_components6.privateApis);
...
function CalendarDateTimeControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
    import_components6.BaseControl,
    {
      ...
      help: description,
      hideLabelFromVision,
      children: /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)(Stack, { direction: "column", gap: "lg", children: [
        ...
        !compact && /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
          DateCalendar,
          {
            style: { width: "100%" },
...
var { DateCalendar: DateCalendar2, DateRangeCalendar } = unlock3(import_components7.privateApis);
var DATE_PRESETS = [
  {
    id: "today",
...
function ValidatedDateControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime58.jsxs)("div", { onBlur, children: [
    children,
    /* @__PURE__ */ (0, import_jsx_runtime58.jsx)("div", { "aria-live": "polite", children: customValidity && /* @__PURE__ */ (0, import_jsx_runtime58.jsxs)(
      "p",
      {
        className: clsx_default(
...
var { ValidatedSelectControl } = unlock3(import_components8.privateApis);
function Select({
  data,
  field,
  onChange,
...
function AdaptiveSelect(props) {
  ...
  if (elements.length >= ELEMENTS_THRESHOLD) {
    return /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(Combobox, { ...props });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(Select, { ...props });
}
...
var { ValidatedInputControl: ValidatedInputControl3 } = unlock3(import_components9.privateApis);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "email",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(import_components10.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(import_components10.Icon, { icon: envelope_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "tel",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(import_components11.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(import_components11.Icon, { icon: mobile_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "url",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(import_components12.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(import_components12.Icon, { icon: link_default }) })
      }
    }
  );
}
...
var { ValidatedNumberControl } = unlock3(import_components13.privateApis);
...
function BetweenControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime65.jsx)(
    import_components13.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime65.jsxs)(import_components13.Flex, { direction: "row", gap: 4, children: [
...
function Integer(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(ValidatedNumber, { ...props });
}
...
var { ValidatedRadioControl } = unlock3(import_components14.privateApis);
function Radio({
  data,
  field,
  onChange,
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(import_components14.Spinner, {});
  }
...
var { ValidatedToggleControl } = unlock3(import_components15.privateApis);
function Toggle({
  field,
  onChange,
  data,
...
var { ValidatedTextareaControl } = unlock3(import_components16.privateApis);
function Textarea({
  data,
  field,
  onChange,
...
var { ValidatedToggleGroupControl } = unlock3(import_components17.privateApis);
function ToggleGroup({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(import_components17.Spinner, {});
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(
    ValidatedToggleGroupControl,
    {
      ...
      value,
      hideLabelFromVision,
      children: elements.map((el) => /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(
...
var { ValidatedFormTokenField } = unlock3(import_components18.privateApis);
    ...
    ValidatedFormTokenField,
    {
      ...
      __experimentalRenderItem: ({ item }) => {
        if (typeof item === "string" && elements) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)("span", { children: element?.label || item });
        }
        return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)("span", { children: item });
      }
    }
  );
}
...
var { ValidatedInputControl: ValidatedInputControl4 } = unlock3(import_components19.privateApis);
var ColorPickerDropdown = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
    import_components19.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
        import_components19.Button,
        {
          onClick: onToggle,
          "aria-label": (0, import_i18n15.__)("Open color picker"),
          size: "small",
          disabled: disabled2,
          accessibleWhenDisabled: true,
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(import_components19.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(import_components19.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
...
function Color({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
    ValidatedInputControl4,
    {
      ...
      type: "text",
      disabled: disabled2,
      prefix: /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(import_components19.__experimentalInputControlPrefixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
        ColorPickerDropdown,
        {
          color: value,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(import_components20.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(
          import_components20.Button,
          {
            icon: isVisible ? unseen_default : seen_default,
            onClick: toggleVisibility,
            size: "small",
            label: isVisible ? (0, import_i18n16.__)("Hide password") : (0, import_i18n16.__)("Show password"),
            disabled: disabled2,
            accessibleWhenDisabled: true
          }
        ) })
...
function createConfiguredControl(config) {
  ...
  return function ConfiguredControl(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime76.jsx)(BaseControlType, { ...props, config: controlConfig });
  };
}
...
function render({
  ...
  if (field.hasElements) {
    return /* @__PURE__ */ (0, import_jsx_runtime77.jsx)(RenderFromElements, { item, field });
  }
...
function isValidCustom(item, field) {
  ...
  if (![void 0, "", null].includes(value) && !emailRegex.test(value)) {
    return (0, import_i18n17.__)("Value must be a valid email address.");
  }
  return null;
}
var email_default = {
...
function isValidCustom2(item, field) {
  ...
  if (![void 0, "", null].includes(value) && !Number.isInteger(value)) {
    return (0, import_i18n18.__)("Value must be an integer.");
  }
  return null;
}
var integer_default = {
...
function isValidCustom3(item, field) {
  ...
  if (!isEmpty(value) && !Number.isFinite(value)) {
    return (0, import_i18n19.__)("Value must be a number.");
  }
  return null;
}
var number_default = {
...
function getValueFormatted6({
  ...
  const value = field.getValue({ item });
  if (value === true) {
    return (0, import_i18n20.__)("True");
  }
  if (value === false) {
    return (0, import_i18n20.__)("False");
  }
  return "";
}
function isValidCustom4(item, field) {
  ...
  if (![void 0, "", null].includes(value) && ![true, false].includes(value)) {
    return (0, import_i18n20.__)("Value must be true, false, or undefined");
  }
  return null;
}
...
function isValidCustom5(item, field) {
  ...
  if (![void 0, "", null].includes(value) && !Array.isArray(value)) {
    return (0, import_i18n21.__)("Value must be an array.");
  }
  if (!value.every((v2) => typeof v2 === "string")) {
    return (0, import_i18n21.__)("Every value must be a string.");
  }
  return null;
}
...
function render3({ item, field }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime78.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
...
function isValidCustom6(item, field) {
  ...
  if (![void 0, "", null].includes(value) && !w(value).isValid()) {
    return (0, import_i18n22.__)("Value must be a valid color.");
  }
  return null;
}
...
function DataFormProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(DataFormContext.Provider, { value: { fields }, children });
}
...
function normalizeLayout(layout) {
  ...
  if (layout?.type === "regular") {
    ...
    if (typeof openAs === "object" && openAs.type === "modal") {
      normalizedOpenAs = {
        type: "modal",
        applyLabel: openAs.applyLabel?.trim() || (0, import_i18n23.__)("Apply"),
        cancelLabel: openAs.cancelLabel?.trim() || (0, import_i18n23.__)("Cancel")
      };
    } else if (openAs === "modal") {
      normalizedOpenAs = {
        type: "modal",
        applyLabel: (0, import_i18n23.__)("Apply"),
        cancelLabel: (0, import_i18n23.__)("Cancel")
      };
    } else {
...
function Header3({ title }) {
  return /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
    Stack,
    {
      ...
      gap: "lg",
      children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(Stack, { direction: "row", align: "center", children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_components21.__experimentalHeading, { level: 2, size: 13, children: title }) })
    }
  );
}
function FormRegularField({
  ...
  if (!!field.children) {
    return /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, { children: [
      !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(Header3, { title: field.label }),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_components21.BaseControl.VisualLabel, { children: fieldDefinition.label })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime80.jsx)("div", { className: "dataforms-layouts-regular__field-control", children: fieldDefinition.readOnly === true ? /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime80.jsx)("div", { className: "dataforms-layouts-regular__field", children: fieldDefinition.readOnly === true ? /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, { children: [
    !hideLabelFromVision && labelPosition !== "none" && /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_components21.BaseControl.VisualLabel, { children: fieldDefinition.label }),
    /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
      fieldDefinition.render,
      {
        item: data,
...
function getLabelContent(showError, errorMessage, fieldLabel) {
  return showError ? /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(import_components22.Tooltip, { text: errorMessage, placement: "top", children: /* @__PURE__ */ (0, import_jsx_runtime81.jsxs)("span", { className: "dataforms-layouts-panel__field-label-error-content", children: [
    /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(import_components22.Icon, { icon: error_default, size: 16 }),
    fieldLabel
  ] }) }) : fieldLabel;
}
...
function SummaryButton({
  ...
  const ariaLabel = showError ? (0, import_i18n24.sprintf)(
    // translators: %s: Field name.
    (0, import_i18n24._x)("Edit %s (has errors)", "field"),
    fieldLabel || ""
  ) : (0, import_i18n24.sprintf)(
    // translators: %s: Field name.
    (0, import_i18n24._x)("Edit %s", "field"),
    fieldLabel || ""
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime82.jsxs)(
    "div",
    {
      ...
      children: [
        labelPosition !== "none" && /* @__PURE__ */ (0, import_jsx_runtime82.jsx)("span", { className: labelClassName, children: labelContent }),
        labelPosition === "none" && showError && /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(import_components23.Tooltip, { text: errorMessage, placement: "top", children: /* @__PURE__ */ (0, import_jsx_runtime82.jsx)("span", { className: "dataforms-layouts-panel__field-label-error-content", children: /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(import_components23.Icon, { icon: error_default, size: 16 }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
          "span",
          {
            id: `${controlId}`,
            className: "dataforms-layouts-panel__field-control",
            children: summaryFields.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
              "span",
              {
                style: {
                  display: "flex",
                ...
                children: summaryFields.map((summaryField) => /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
                  "span",
                  {
                    style: { width: "100%" },
            ...
            ) : summaryFields.map((summaryField) => /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
              summaryField.render,
              {
                item: data,
                field: summaryField
        ...
        !disabled2 && /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
...
function handleElementsValidationAsync(promise, formField, promiseHandler) {
  ...
  promise.then((result) => {
      ...
      setFormValidity((prev) => {
        const newFormValidity = setValidityAtPath(
          prev,
          {
            elements: {
              type: "invalid",
              message: (0, import_i18n25.__)("Could not validate elements.")
            }
          },
          [...path, formField.id]
        );
    ...
    if (error2 instanceof Error) {
      ...
      errorMessage = String(error2) || (0, import_i18n25.__)(
    ...
    setFormValidity((prev) => {
      const newFormValidity = setValidityAtPath(
        prev,
        {
          custom: {
            type: "invalid",
            message: (0, import_i18n25.__)("Validation could not be processed.")
          }
        },
        [...path, formField.id]
      );
...
function validateFormField(item, formField, promiseHandler) {
  ...
  if (formField.field?.isValid.pattern && !formField.field.isValid.pattern.validate(item, formField.field)) {
    return {
      pattern: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value does not match the required pattern.")
      }
    };
  }
  if (formField.field?.isValid.min && !formField.field.isValid.min.validate(item, formField.field)) {
    return {
      min: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value is below the minimum.")
      }
    };
  }
  if (formField.field?.isValid.max && !formField.field.isValid.max.validate(item, formField.field)) {
    return {
      max: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value is above the maximum.")
      }
    };
  }
  if (formField.field?.isValid.minLength && !formField.field.isValid.minLength.validate(item, formField.field)) {
    return {
      minLength: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value is too short.")
      }
    };
  }
  if (formField.field?.isValid.maxLength && !formField.field.isValid.maxLength.validate(item, formField.field)) {
    return {
      maxLength: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value is too long.")
      }
    };
  }
  if (formField.field?.isValid.elements && formField.field.hasElements && !formField.field.getElements && Array.isArray(formField.field.elements) && !formField.field.isValid.elements.validate(item, formField.field)) {
    return {
      elements: {
        type: "invalid",
        message: (0, import_i18n25.__)("Value must be one of the elements.")
      }
    };
  }
  let customError;
  if (!!formField.field && formField.field.isValid.custom) {
    try {
      ...
      if (error2 instanceof Error) {
        ...
        errorMessage = String(error2) || (0, import_i18n25.__)("Unknown error when running custom validation.");
      }
      return {
        custom: {
          type: "invalid",
  ...
  if (!!formField.field && formField.field.isValid.elements && formField.field.hasElements && typeof formField.field.getElements === "function") {
    ...
    fieldValidity.elements = {
      type: "validating",
      message: (0, import_i18n25.__)("Validating\u2026")
    };
  }
...
function ModalContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime83.jsxs)(
    import_components24.Modal,
    {
      ...
      size: "medium",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime83.jsx)("div", { ref: mergedRef, children: /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(
          DataFormLayout,
          {
            data: modalData,
            form,
            ...
            validity,
            children: (FieldLayout, childField, childFieldValidity, markWhenOptional) => /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(
              FieldLayout,
              {
                data: modalData,
                field: childField,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime83.jsxs)(
          Stack,
          {
            ...
            gap: "md",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(import_components24.__experimentalSpacer, { style: { flex: 1 } }),
...
function DropdownHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
    Stack,
    {
      ...
      gap: "lg",
      children: /* @__PURE__ */ (0, import_jsx_runtime84.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", children: [
        title && /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(import_components25.__experimentalHeading, { level: 2, size: 13, children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(import_components25.__experimentalSpacer, { style: { flex: 1 } }),
        onClose && /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
          import_components25.Button,
          {
            label: (0, import_i18n26.__)("Close"),
...
function DropdownContentWithValidation({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime84.jsx)("div", { ref, children });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
        import_components25.Dropdown,
        {
          ...
          renderToggle: ({ isOpen, onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
            SummaryButton,
            {
              data,
              field,
          ...
          renderContent: ({ onClose }) => /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(DropdownContentWithValidation, { touched, children: /* @__PURE__ */ (0, import_jsx_runtime84.jsxs)("div", { ref: dialogRef, ...dialogProps, children: [
...
function ValidationBadge({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime86.jsx)(Badge, { intent: "high", children: (0, import_i18n27.sprintf)(
...
function HeaderContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime87.jsxs)(
    Stack,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(card_exports.Title, { children: label }),
        (hasBadge || hasSummary) && /* @__PURE__ */ (0, import_jsx_runtime87.jsxs)(collapsible_card_exports.HeaderDescription, { className: "dataforms-layouts-card__field-header-content-description", children: [
          hasBadge && /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(ValidationBadge, { validity }),
          hasSummary && /* @__PURE__ */ (0, import_jsx_runtime87.jsx)("div", { className: "dataforms-layouts-card__field-summary", children: visibleSummaryFields.map((summaryField) => /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(
            summaryField.render,
            {
              item: data,
              field: summaryField
...
function BodyContent({
  ...
  if (field.children) {
    return /* @__PURE__ */ (0, import_jsx_runtime87.jsxs)(import_jsx_runtime87.Fragment, { children: [
      field.description && /* @__PURE__ */ (0, import_jsx_runtime87.jsx)("div", { className: "dataforms-layouts-card__field-description", children: field.description }),
...
function FormCardField({
  ...
  const bodyContent = /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(
    BodyContent,
    {
      data,
      field,
  ...
  const headerContent = /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(
    HeaderContent,
    {
      data,
      fields,
  ...
  if (withHeader && isCollapsible) {
    return /* @__PURE__ */ (0, import_jsx_runtime87.jsxs)(
      collapsible_card_exports.Root,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(collapsible_card_exports.Header, { children: headerContent }),
          /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime87.jsxs)(card_exports.Root, { className: "dataforms-layouts-card__field", children: [
    withHeader && /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(card_exports.Header, { children: headerContent }),
    /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(card_exports.Content, { ref: contentRef, onBlur: handleBlur, children: bodyContent })
  ] });
}
...
function Header4({ title }) {
  return /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
    Stack,
    {
      ...
      gap: "lg",
      children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(Stack, { direction: "row", align: "center", children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(import_components26.__experimentalHeading, { level: 2, size: 13, children: title }) })
    }
  );
}
var EMPTY_WRAPPER = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(import_jsx_runtime88.Fragment, { children });
function FormRowField({
  ...
  if (!!field.children) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime88.jsxs)("div", { className: "dataforms-layouts-row__field", children: [
      !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(Header4, { title: field.label }),
      /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(Stack, { direction: "row", align: layout.alignment, gap: "lg", children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
        DataFormLayout,
        {
          data,
          form,
          ...
          validity: validity?.children,
          as: EMPTY_WRAPPER,
          children: (FieldLayout, childField, childFieldValidity) => /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
            "div",
            {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(import_jsx_runtime88.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)("div", { className: "dataforms-layouts-row__field-control", children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
    RegularLayout,
    {
      data,
      field,
...
function FormDetailsField({
  ...
  if (summaryField && summaryField.render) {
    summaryContent = /* @__PURE__ */ (0, import_jsx_runtime89.jsx)(summaryField.render, { item: data, field: summaryField });
  } else {
    summaryContent = field.label || (0, import_i18n28.__)("More details");
  }
  return /* @__PURE__ */ (0, import_jsx_runtime89.jsxs)(
    "details",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime89.jsx)("summary", { className: "dataforms-layouts-details__summary", children: /* @__PURE__ */ (0, import_jsx_runtime89.jsxs)(
          Stack,
          {
            direction: "row",
            align: "center",
            ...
            children: [
              summaryContent,
              touched && /* @__PURE__ */ (0, import_jsx_runtime89.jsx)(ValidationBadge, { validity })
            ]
          }
        ) }),
...
var FORM_FIELD_LAYOUTS = [
  {
    ...
    wrapper: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime90.jsx)(
      Stack,
      {
        direction: "column",
  ...
  },
  {
    ...
    wrapper: ({
      ...
      Stack,
      {
        ...
        className: "dataforms-layouts__wrapper",
        gap: "lg",
        children: /* @__PURE__ */ (0, import_jsx_runtime90.jsx)("div", { className: "dataforms-layouts-row__field", children: /* @__PURE__ */ (0, import_jsx_runtime90.jsx)(
          Stack,
          {
            direction: "row",
            gap: "lg",
...
var DEFAULT_WRAPPER = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime91.jsx)(Stack, { direction: "column", className: "dataforms-layouts__wrapper", gap: "lg", children });
function DataFormLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime91.jsx)(Wrapper, { layout: form.layout, children: form.fields.map((formField) => {
...
function DataForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(DataFormProvider, { fields: normalizedFields, children: /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(
    DataFormLayout,
    {
      data,
      form: normalizedForm,
...
function DuplicatePostTypeModal({
  ...
  const [data, setData] = (0, import_element74.useState)(() => ({
    ...
    status: "draft",
    title: {
      raw: (0, import_i18n29.sprintf)(
        /* translators: %s: existing post type title. */
        (0, import_i18n29._x)("%s (Copy)", "post type"),
        source.title.raw
      )
    },
    ...
    try {
      ...
      createSuccessNotice(
        (0, import_i18n29.sprintf)(
          ...
          (0, import_i18n29.__)('"%s" post type created.'),
          data.title.raw
        ),
        { type: "snackbar" }
      );
      ...
      createErrorNotice(
        typedError?.message && typedError.code !== "unknown_error" ? typedError.message : (0, import_i18n29.__)("Failed to duplicate post type."),
        { type: "snackbar" }
      );
    } finally {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime93.jsxs)(Stack, { direction: "column", gap: "md", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime93.jsxs)(Stack, { direction: "row", justify: "flex-end", gap: "sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(
        import_components27.Button,
        {
          ...
          accessibleWhenDisabled: true,
          children: (0, import_i18n29.__)("Cancel")
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(
        import_components27.Button,
        {
          ...
          accessibleWhenDisabled: true,
          onClick: onDuplicate,
          children: (0, import_i18n29._x)("Duplicate", "action label")
        }
      )
    ] })
  ] });
...
var duplicatePostTypeAction = {
  ...
  label: (0, import_i18n29._x)("Duplicate", "action label"),
  icon: copy_default,
  modalHeader: (0, import_i18n29.__)("Duplicate post type"),
  modalFocusOnMount: "firstContentElement",
...
export {
  ...
  defaultForm,
  delete_default as deletePostTypeAction,
  descriptionField,
  duplicate_default as duplicatePostTypeAction,
  editItemField,
  featuredImageField,
