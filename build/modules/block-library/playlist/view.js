...
var h = function(r2) {
  ...
  var a2 = Math.floor(t2), o2 = e3 * (1 - n2), i2 = e3 * (1 - (t2 - a2) * n2), s2 = e3 * (1 - (1 - t2 + a2) * n2), d2 = a2 % 6;
  return { r: 255 * [e3, i2, o2, o2, s2, e3][d2], g: 255 * [s2, e3, e3, i2, o2, o2][d2], b: 255 * [o2, o2, s2, e3, e3, i2][d2], a: u2 };
};
var b = function(r2) {
...
var f = function(r2) {
  return h((n2 = (t2 = r2).s, { h: t2.h, s: (n2 *= ((e3 = t2.l) < 50 ? e3 : 100 - e3) / 100) > 0 ? 2 * n2 / (e3 + n2) * 100 : 0, v: e3 + n2, a: t2.a }));
  var t2, n2, e3;
};
var c = function(r2) {
  return { h: (t2 = d(r2)).h, s: (u2 = (200 - (n2 = t2.s)) * (e3 = t2.v) / 100) > 0 && u2 < 200 ? n2 * e3 / 100 / (u2 <= 100 ? u2 : 200 - u2) * 100 : 0, l: u2 / 2, a: t2.a };
  var t2, n2, e3, u2;
};
...
var y = { string: [[function(r2) {
  ...
  var i2 = b({ h: Number(n2), s: Number(e3), l: Number(u2), a: Number(o2) });
  return f(i2);
}, "hsl"], [function(r2) {
...
var j = (function() {
  ...
  return r2.prototype.isValid = function() {
    ...
    return r3 = g(c(this.rgba)), t2 = r3.h, n2 = r3.s, e3 = r3.l, (u2 = r3.a) < 1 ? "hsla(" + t2 + ", " + n2 + "%, " + e3 + "%, " + u2 + ")" : "hsl(" + t2 + ", " + n2 + "%, " + e3 + "%)";
    var r3, t2, n2, e3, u2;
