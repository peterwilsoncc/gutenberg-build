...
function WithMenuSeparators({ children }) {
  return import_element7.Children.toArray(children).filter(Boolean).map((child, i2) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_element7.Fragment, { children: [
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime95.jsxs)(Stack, { direction: "row", justify: "space-between", gap: "sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime95.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", justify: "start", children: [
            ...
            title && /* @__PURE__ */ (0, import_jsx_runtime95.jsx)(HeadingTag, { className: style_default3["header-title"], children: title }),
            breadcrumbs,
            badges
          ] }),
        ...
        subTitle && /* @__PURE__ */ (0, import_jsx_runtime95.jsx)("p", { className: style_default3["header-subtitle"], children: subTitle })
      ]
    }
  );
}
...
function CategoryField({ item }) {
  ...
  const categoryLabels = (0, import_element61.useMemo)(() => {
...
function useAugmentPatternsWithPermissions(patterns) {
  const idsAndTypes = (0, import_element62.useMemo)(
...
function PatternList() {
  ...
  const [showPatternModal, setShowPatternModal] = (0, import_element63.useState)(false);
  ...
  const categoryFilter = (0, import_element63.useMemo)(() => {
    const filter = view.filters?.find((f2) => f2.field === "category");
    return filter?.value || "all-patterns";
  }, [view.filters]);
  const syncStatusFilter = (0, import_element63.useMemo)(() => {
    const filter = view.filters?.find((f2) => f2.field === "sync-status");
    return filter?.value;
  }, [view.filters]);
  const patternType = (0, import_element63.useMemo)(() => {
    if (type === "my-patterns") {
