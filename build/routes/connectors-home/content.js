...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='c50c3c0e77']")) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      isEmpty ? /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(import_components4.Button, { variant: "secondary", href: "plugin-install.php" }, (0, import_i18n3.__)("Learn more"))
      ) : /* @__PURE__ */ React.createElement(import_components4.__experimentalVStack, { spacing: 3 }, connectors.map((connector) => {
        if (connector.render) {
          return /* @__PURE__ */ React.createElement(
            connector.render,
            {
