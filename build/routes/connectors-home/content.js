...
function renderPortalWithChildren(portal, defaultPortal, children) {
  ...
  return (0, import_element13.cloneElement)(rootPortal, {
    children
  });
}
...
var Popup = (0, import_element16.forwardRef)(function TooltipPopup3({
  align = "center",
  portal,
  side = "top",
  sideOffset = 4,
  ...
  const portalChildren = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    index_parts_exports.Positioner,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ThemeProvider, { color: { bg: "#1e1e1e" }, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
  ...
  return renderPortalWithChildren(portal, /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Portal, {}), portalChildren);
});
...
if (typeof process === "undefined" || true) {
  registerStyle6("358a2a646a", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-compositions{._28cfdc260e755391__icon-button{--wp-ui-button-aspect-ratio:1;--wp-ui-button-padding-inline:0;--wp-ui-button-min-width:unset}.f1c70d719989a85a__icon{margin:-1px}}");
}
var style_default6 = { "icon-button": "_28cfdc260e755391__icon-button", "icon": "f1c70d719989a85a__icon" };
var IconButton = (0, import_element18.forwardRef)(
  function IconButton2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Provider, { delay: 0, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(Root, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(Popup, { children: [
        label,
...
function safeRenderToString(message) {
  ...
  try {
    return (0, import_element20.renderToString)(message);
  } catch {
    return void 0;
  }
}
...
var Root2 = (0, import_element20.forwardRef)(function Notice({
  intent = "neutral",
  children,
  icon,
...
var Description = (0, import_element22.forwardRef)(
...
var Actions = (0, import_element23.forwardRef)(
...
var CloseIcon = (0, import_element24.forwardRef)(
...
var ActionButton = (0, import_element25.forwardRef)(
...
var ActionLink = (0, import_element26.forwardRef)(
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(Stack, { direction: "column", className: style_default15.header, children: [
      ...
      Stack,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", justify: "start", children: [
            showSidebarToggle && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
              SidebarToggleSlot,
              {
                ...
                className: style_default15["sidebar-toggle-slot"]
              }
            ),
            visual && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
              "div",
              {
                className: style_default15["header-visual"],
                "aria-hidden": "true",
                children: visual
              }
            ),
            title && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
              Text,
              {
                className: style_default15["header-title"],
          ...
          actions && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
            ...
            {
              align: "center",
              className: style_default15["header-actions"],
              direction: "row",
              gap: "sm",
              children: actions
            }
    ...
    subTitle && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
      Text,
      {
        ...
        variant: "body-md",
        className: style_default15["header-subtitle"],
        children: subTitle
      }
    )
  ] });
...
function Page({
  ...
  const classes = clsx_default(style_default16.page, className);
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='0fd4decca8']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "0fd4decca8");
...
function useConnectorPlugin({
  ...
  const [isExpanded, setIsExpanded] = (0, import_element28.useState)(false);
  const [isBusy, setIsBusy] = (0, import_element28.useState)(false);
  const [connectedState, setConnectedState] = (0, import_element28.useState)(initialIsConnected);
  const [pluginStatusOverride, setPluginStatusOverride] = (0, import_element28.useState)(null);
...
function ApiKeyConnector({
  ...
  const actionButtonRef = (0, import_element29.useRef)(null);
...
function AiPluginCallout() {
  const [isBusy, setIsBusy] = (0, import_element30.useState)(false);
  const [justActivated, setJustActivated] = (0, import_element30.useState)(false);
  ...
  const initialHasConnectedProvider = (0, import_element30.useRef)(
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "ai-plugin-callout" }, /* @__PURE__ */ React.createElement("div", { className: "ai-plugin-callout__content" }, /* @__PURE__ */ React.createElement("p", null, (0, import_element30.createInterpolateElement)(getMessage(), {
...
function ConnectorsPage() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      canInstallPlugins && !isFileModDisabled && /* @__PURE__ */ React.createElement("p", null, (0, import_element31.createInterpolateElement)(
        (0, import_i18n7.__)(
