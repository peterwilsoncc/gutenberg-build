...
function ViewGrid({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)(import_jsx_runtime50.Fragment, {
    ...
    children: [
      ...
      isInfiniteScroll && isLoading && /* @__PURE__ */ (0, import_jsx_runtime50.jsx)("p", { className: "dataviews-loading-more", children: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(import_components9.Spinner, {}) })
    ]
  });
}
...
function ViewList(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime51.jsxs)(import_jsx_runtime51.Fragment, { children: [
    ...
    isInfiniteScroll && isLoading && /* @__PURE__ */ (0, import_jsx_runtime51.jsx)("p", { className: "dataviews-loading-more", children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_components10.Spinner, {}) })
  ] });
}
...
function createElement3(Type, props) {
  ...
  if (React7.isValidElement(render4)) {
    ...
    element = /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(Type, { ...rest });
  }
  if (wrapElement) {
...
function createStoreContext(providers = [], scopedProviders = []) {
  ...
  const ContextProvider = (props) => {
    return providers.reduceRight(
      (children, Provider) => /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(Provider, { ...props, children }),
      /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(context.Provider, { ...props })
    );
  };
  const ScopedContextProvider = (props) => {
    return /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(ContextProvider, { ...props, children: scopedProviders.reduceRight(
      (children, Provider) => /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(Provider, { ...props, children }),
      /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(scopedContext.Provider, { ...props })
    ) });
  };
  return {
    context,
...
var useCompositeItem = createHook(
  function useCompositeItem2({
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = {
      id,
...
var useComposite = createHook(
  function useComposite2({
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(CompositeContextProvider, { value: store, children: element }),
      [store]
    );
...
var useDisclosureContent = createHook(function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => /* @__PURE__ */ (0, import_jsx_runtime65.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var DisclosureContent = forwardRef22(function DisclosureContent2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime65.jsx)(DisclosureContentImpl, { ...props });
});
...
var useComboboxItem = createHook(
  function useComboboxItem2({
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(ComboboxItemValueContext.Provider, { value, children: /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
...
function splitValue(itemValue, userValue) {
  ...
  const parts = [];
  const span = (value, autocomplete = false) => /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(
    "span",
    {
...
var useComboboxList = createHook(
  function useComboboxList2({ store, alwaysVisible, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(ComboboxScopedContextProvider, { value: store, children: /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
function ComboboxProvider(props = {}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
...
function DataViewsLayout({ className }) {
  ...
  if (!hasInitiallyLoaded) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)("div", { className: "dataviews-loading", children: /* @__PURE__ */ (0, import_jsx_runtime79.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(import_components25.Spinner, {}) }) });
  }
...
function DataViewsFooter() {
  ...
  return (!!totalItems || isRefreshing) && /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
    "div",
    {
...
function Combobox3({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime85.jsx)(import_components30.Spinner, {});
  }
...
function Select({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime89.jsx)(import_components34.Spinner, {});
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "email",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(import_components36.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(import_components36.Icon, { icon: envelope_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "tel",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(import_components37.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(import_components37.Icon, { icon: mobile_default }) })
      }
    }
  );
}
...
function BetweenControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime95.jsx)(
    import_components39.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime95.jsxs)(import_components39.Flex, { direction: "row", gap: 4, children: [
...
function Radio({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_components40.Spinner, {});
  }
...
function ArrayControl({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(import_components44.Spinner, {});
  }
    ...
    import_components45.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
        import_components45.Button,
        {
          ...
          size: "small",
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components45.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components45.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
...
function Color({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
    ValidatedInputControl3,
    {
      ...
      hideLabelFromVision,
      type: "text",
      prefix: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components45.__experimentalInputControlPrefixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
        ColorPickerDropdown,
        {
          color: value,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components46.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime111.jsxs)(import_components48.__experimentalVStack, { className: "admin-ui-page__header", as: "header", children: [
    /* @__PURE__ */ (0, import_jsx_runtime111.jsxs)(import_components48.__experimentalHStack, { justify: "space-between", spacing: 2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime111.jsxs)(import_components48.__experimentalHStack, { spacing: 2, justify: "left", children: [
        ...
        title && /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(import_components48.__experimentalHeading, { as: "h2", level: 3, weight: 500, truncate: true, children: title }),
        breadcrumbs,
        badges
      ] }),
...
function AuthorField({ item }) {
  ...
  return /* @__PURE__ */ React.createElement(import_components49.__experimentalHStack, { alignment: "left", spacing: 0 }, imageUrl && /* @__PURE__ */ React.createElement(
    "div",
    {
      className: clsx_default(
  ...
  ), !imageUrl && /* @__PURE__ */ React.createElement("div", { className: "routes-template-list-author-field__icon" }, /* @__PURE__ */ React.createElement(import_components49.Icon, { icon })), /* @__PURE__ */ React.createElement("span", { className: "routes-template-list-author-field__name" }, text));
}
var authorField = {
...
var { Badge: Badge3 } = unlock2(import_components50.privateApis);
var activeField = {
...
function useTemplates(activeView = "active") {
  ...
  const activeTemplates = (0, import_element59.useMemo)(() => {
  ...
  const records = (0, import_element59.useMemo)(() => {
...
function usePostTypeArchiveMenuItems() {
  ...
  const postTypesWithArchives = (0, import_element61.useMemo)(
  ...
  const postTypeLabels = (0, import_element61.useMemo)(
  ...
  const needsUniqueIdentifier = (0, import_element61.useCallback)(
    ({ labels, slug }) => {
      const singularName = labels.singular_name.toLowerCase();
...
var usePostTypeMenuItems = (onClickMenuItem) => {
  ...
  const templateLabels = (0, import_element61.useMemo)(
    () => publicPostTypes?.reduce((accumulator, { labels }) => {
  ...
  const templatePrefixes = (0, import_element61.useMemo)(
  ...
  const postTypesMenuItems = (0, import_element61.useMemo)(
    () => menuItems.reduce(
      (accumulator, postType) => {
        const { slug } = postType;
...
var useTaxonomiesMenuItems = (onClickMenuItem) => {
  ...
  const taxonomiesMenuItems = (0, import_element61.useMemo)(
    () => menuItems.reduce(
      (accumulator, taxonomy) => {
        const { slug } = taxonomy;
...
var useEntitiesInfo = (entityName, templatePrefixes, additionalQueryParameters = EMPTY_OBJECT2) => {
  ...
  const entitiesInfo = (0, import_element61.useMemo)(() => {
    return Object.keys(templatePrefixes || {}).reduce(
      (accumulator, slug) => {
        accumulator[slug] = {
...
function useSearchSuggestions(entityForSuggestions, search) {
  ...
  const [suggestions, setSuggestions] = (0, import_element62.useState)(EMPTY_ARRAY8);
...
function SuggestionList({
  ...
  const [showSearchControl, setShowSearchControl] = (0, import_element62.useState)(false);
...
function AddCustomTemplateModalContent({
  ...
  const [showSearchEntities, setShowSearchEntities] = (0, import_element62.useState)(false);
  (0, import_element62.useEffect)(() => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    !showSearchEntities && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(import_components51.__experimentalText, { as: "p" }, (0, import_i18n51.__)(
    ...
    ), /* @__PURE__ */ React.createElement(import_components51.Flex, { justify: "right" }, /* @__PURE__ */ React.createElement(
      import_components51.Button,
      {
        __next40pxDefaultSize: true,
        variant: "tertiary",
...
function AddCustomGenericTemplateModalContent({
  ...
  const [title, setTitle] = (0, import_element63.useState)("");
  const defaultTitle = (0, import_i18n52.__)("Custom Template");
  const [isBusy, setIsBusy] = (0, import_element63.useState)(false);
  const inputRef = (0, import_element63.useRef)(null);
  ...
  return /* @__PURE__ */ React.createElement("form", { onSubmit: onCreateTemplate }, /* @__PURE__ */ React.createElement(import_components52.__experimentalVStack, { spacing: 6 }, /* @__PURE__ */ React.createElement(
...
function TemplateListItem({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "template-list-add-new-template__template-icon" }, /* @__PURE__ */ React.createElement(import_components53.Icon, { icon })),
      /* @__PURE__ */ React.createElement(
...
function NewTemplateModal({ onClose }) {
  const [modalContent, setModalContent] = (0, import_element64.useState)(modalContentMap.templatesList);
  const [entityForSuggestions, setEntityForSuggestions] = (0, import_element64.useState)();
  const [isSubmitting, setIsSubmitting] = (0, import_element64.useState)(false);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    modalContent === modalContentMap.templatesList && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(import_components53.Flex, { className: "template-list-add-new-template__template-list__prompt" }, (0, import_i18n53.__)(
...
function NewTemplate() {
  const [showModal, setShowModal] = (0, import_element64.useState)(false);
...
var add_new_template_default = (0, import_element64.memo)(NewTemplate);

// routes/template-list/style.scss
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='bfa9b6f0e8']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "bfa9b6f0e8");
...
var { Tabs } = unlock2(import_components54.privateApis);
...
function TemplateListActivation() {
  ...
  const [selectedRegisteredTemplate, setSelectedRegisteredTemplate] = (0, import_element65.useState)(null);
...
function useTemplatesLegacy(activeView = "all") {
  ...
  const filteredRecords = (0, import_element66.useMemo)(() => {
    if (!records) {
      return [];
    }
    if (activeView === "all") {
...
var { Tabs: Tabs2 } = unlock2(import_components55.privateApis);
...
function TemplateListLegacy() {
  ...
  const activeViewOverrides = (0, import_element67.useMemo)(
    () => getActiveViewOverridesForTabLegacy(activeView),
    [activeView]
  );
  const handleQueryParamsChange = (0, import_element67.useCallback)(
    (params) => {
      navigate({
        search: {
          ...searchParams,
  ...
  const { data: posts, paginationInfo } = (0, import_element67.useMemo)(() => {
    return filterSortAndPaginate(records, view, fields);
  }, [records, view, fields]);
  const cleanupDeletedPostIdsFromUrl = (0, import_element67.useCallback)(
    (deletedItems) => {
      const deletedIds = deletedItems.map(
        (item) => item.id.toString()
      );
  ...
  const onActionPerformed = (0, import_element67.useCallback)(
    (actionId, items) => {
      if (actionId === "move-to-trash" || actionId === "permanently-delete") {
        cleanupDeletedPostIdsFromUrl(items);
      }
  ...
  const tabs = (0, import_element67.useMemo)(() => {
    const baseTabs = [
      {
        slug: "all",
  ...
  const handleTabChange = (0, import_element67.useCallback)(
    (viewSlug) => {
      navigate({
        to: `/templates/list/${viewSlug}`
      });
