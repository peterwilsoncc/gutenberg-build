...
function Page({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime112.jsxs)(navigable_region_default, { className: classes, ariaLabel: effectiveAriaLabel, children: [
    (title || breadcrumbs || badges || actions) && /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
      Header,
      {
        headingLevel,
        breadcrumbs,
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='876b69bd56']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "876b69bd56");
