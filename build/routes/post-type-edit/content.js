...
// routes/post-type-edit/post-type-form.scss
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='8a92123a70']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "8a92123a70");
  style.appendChild(document.createTextNode(".post-type-form{box-sizing:border-box;margin:0 auto;max-width:680px;padding:24px;width:100%}"));
  document.head.appendChild(style);
}
...
function PostTypeEditStage() {
  ...
  return /* @__PURE__ */ React.createElement(PostTypePage, { key: id, ...postTypePageProps });
}
function PostTypePage({
  ...
  const formId = (0, import_compose4.useInstanceId)(PostTypePage, "post-type-form");
  ...
  async function onSave() {
    ...
    try {
      ...
      const successMessage = isAddMode ? (0, import_i18n23.sprintf)(
        ...
        (0, import_i18n23.__)('"%s" post type created.'),
        data.title.raw
      ) : (0, import_i18n23.sprintf)(
        /* translators: %s: post type plural label. */
        (0, import_i18n23.__)('"%s" post type updated.'),
        data.title.raw
      );
      ...
      if (error2?.message && error2?.code !== "unknown_error") {
        ...
        errorMessage = (0, import_i18n23.__)("Failed to create post type.");
      } else {
        errorMessage = (0, import_i18n23.__)("Failed to update post type.");
      }
  ...
  return /* @__PURE__ */ React.createElement(
    page_default,
    {
      ...
      breadcrumbs: /* @__PURE__ */ React.createElement(
        ...
        {
          items: [
            { label: (0, import_i18n23.__)("Post Types"), to: "/" },
