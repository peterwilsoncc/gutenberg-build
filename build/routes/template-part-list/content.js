...
function WithMenuSeparators({ children }) {
  return import_element7.Children.toArray(children).filter(Boolean).map((child, i2) => /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(import_element7.Fragment, { children: [
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(Stack, { direction: "row", justify: "space-between", gap: "sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", justify: "start", children: [
            ...
            title && /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(HeadingTag, { className: style_default3["header-title"], children: title }),
            breadcrumbs,
            badges
          ] }),
        ...
        subTitle && /* @__PURE__ */ (0, import_jsx_runtime100.jsx)("p", { className: style_default3["header-subtitle"], children: subTitle })
      ]
    }
  );
}
...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element61.useState)(defaultTitle);
  const [area, setArea] = (0, import_element61.useState)(defaultArea);
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element62.useState)(false);
  const defaultView = DEFAULT_VIEW;
  const activeViewOverrides = (0, import_element62.useMemo)(
  ...
  const postTypeQuery = (0, import_element62.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
