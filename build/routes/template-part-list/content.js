...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element57.useState)(defaultTitle);
  const [area, setArea] = (0, import_element57.useState)(defaultArea);
  const [isSubmitting, setIsSubmitting] = (0, import_element57.useState)(false);
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element58.useState)(false);
  ...
  const postTypeQuery = (0, import_element58.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
