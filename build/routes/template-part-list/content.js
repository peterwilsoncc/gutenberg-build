...
function DataViewsPagination() {
  const { view, onChangeView, paginationInfo } = (0, import_element35.useContext)(dataviews_context_default);
...
function RichTextControl({
  ...
  const popoverSlotRef = (0, import_element69.useRef)(null);
  const [popoverContainer, setPopoverContainer] = (0, import_element69.useState)(null);
  const popoverContainerRef = (0, import_compose12.useRefEffect)((element) => {
    setPopoverContainer(element.ownerDocument.body);
  }, []);
  const blurDeselectTimeoutRef = (0, import_element69.useRef)();
  const stopPopoverFocusTrackingRef = (0, import_element69.useRef)(
    void 0
  );
  ...
  const unusedContentRef = (0, import_element69.useRef)(null);
  const {
    ref: autocompleteRef,
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime109.jsxs)(import_components42.SlotFillProvider, { children: [
      ...
      popoverContainer && (0, import_element69.createPortal)(
...
function DataViews({
  ...
  const [selectionState, setSelectionState] = (0, import_element77.useState)([]);
  ...
  const _selection = (0, import_element77.useMemo)(() => {
  ...
  const defaultLayouts = (0, import_element77.useMemo)(
    () => Object.fromEntries(
...
var NavigableRegion = (0, import_element78.forwardRef)(
...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element79.useState)(defaultTitle);
  const [area, setArea] = (0, import_element79.useState)(defaultArea);
  const [isSubmitting, setIsSubmitting] = (0, import_element79.useState)(false);
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element80.useState)(false);
  const defaultView = DEFAULT_VIEW;
  const activeViewOverrides = (0, import_element80.useMemo)(
  ...
  const postTypeQuery = (0, import_element80.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
  ...
  const cleanupDeletedPostIdsFromUrl = (0, import_element80.useCallback)(
    (deletedItems) => {
  ...
  const handleTabChange = (0, import_element80.useCallback)(
    (areaSlug) => {
      navigate({
