...
import {
  hasArchiveField as hasArchiveField2,
...
// routes/post-types/actions/quick-edit.tsx
...
// routes/post-types/style.scss
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='50bacb9223']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "50bacb9223");
  style.appendChild(document.createTextNode(".boot-layout__stage:has(.post-types-page){height:calc(100vh - 46px)}@media (min-width:782px){.boot-layout__stage:has(.post-types-page){height:calc(100vh - 32px)}}.dataviews-action-modal__quick-edit-post-type{align-items:stretch;justify-content:flex-end}.dataviews-action-modal__quick-edit-post-type .components-modal__frame{animation-name:none;border-radius:8px;height:calc(100% - 32px);margin:16px 16px 16px 0;max-height:calc(100% - 32px);max-width:400px;position:relative}@media (prefers-reduced-motion:no-preference){.dataviews-action-modal__quick-edit-post-type .components-modal__frame{animation-duration:.2s;animation-name:quick-edit-post-type-slide-in-right;animation-timing-function:ease-out}}.dataviews-action-modal__quick-edit-post-type.is-animating-out .components-modal__frame{animation-name:none}@media (prefers-reduced-motion:no-preference){.dataviews-action-modal__quick-edit-post-type.is-animating-out .components-modal__frame{animation-duration:.2s;animation-name:quick-edit-post-type-slide-out-right;animation-timing-function:ease-out}}.dataviews-action-modal__quick-edit-post-type .components-modal__content{overflow-y:auto;padding:0}.dataviews-action-modal__quick-edit-post-type .dataviews-action-modal__quick-edit-post-type-header{background:#fff;padding:16px 24px;position:sticky;top:0;z-index:1}.dataviews-action-modal__quick-edit-post-type .dataviews-action-modal__quick-edit-post-type-content{padding:0 24px}.dataviews-action-modal__quick-edit-post-type .dataviews-action-modal__quick-edit-post-type-footer{background:#fff;bottom:0;padding:16px 24px;position:sticky;z-index:1}.dataviews-action-modal__quick-edit-post-type .dataviews-action-modal__quick-edit-post-type-footer .components-button{flex:1;justify-content:center}@keyframes quick-edit-post-type-slide-in-right{0%{transform:translateX(100%)}to{transform:translateX(0)}}@keyframes quick-edit-post-type-slide-out-right{0%{transform:translateX(0)}to{transform:translateX(100%)}}"));
  document.head.appendChild(style);
}
...
function QuickEditPostTypeModal({
    ...
    try {
      ...
      createSuccessNotice(
        (0, import_i18n50.sprintf)(
          ...
          (0, import_i18n50.__)('"%s" post type updated.'),
          data.title.raw
        ),
        { type: "snackbar" }
      );
      ...
      createErrorNotice(
        error2?.message && error2?.code !== "unknown_error" ? error2.message : (0, import_i18n50.__)("Failed to update post type."),
        { type: "snackbar" }
      );
    } finally {
      setIsSaving(false);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Text, { variant: "heading-sm", render: /* @__PURE__ */ React.createElement("h2", null) }, (0, import_i18n50.__)("Quick edit post type")),
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "dataviews-action-modal__quick-edit-post-type-content" }, /* @__PURE__ */ React.createElement(
    DataForm,
    {
      data,
      fields,
...
function PostTypesPage() {
  ...
  const postTypeActions = (0, import_element90.useMemo)(
    () => [
      editAction,
      quick_edit_default,
      activateAction,
  ...
  const taxonomiesField = useTaxonomiesField2();
  ...
  return /* @__PURE__ */ React.createElement(
    page_default,
    {
      title: (0, import_i18n51.__)("Post Types"),
      ...
      actions: /* @__PURE__ */ React.createElement(
        ...
        (0, import_i18n51.__)("Add post type")
      )
    },
    /* @__PURE__ */ React.createElement(
      dataviews_default,
