      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(Stack, { direction: "row", justify: "space-between", gap: "sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", justify: "start", children: [
            ...
            title && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(HeadingTag, { className: style_default10["header-title"], children: title }),
            breadcrumbs,
            badges
          ] }),
        ...
        subTitle && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("p", { className: style_default10["header-subtitle"], children: subTitle })
      ]
    }
  );
}
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='8657312997']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "8657312997");
  style.appendChild(document.createTextNode(".experiments-page__form{margin:0 auto;max-width:680px;padding:24px}.experiments-page__form .dataforms-layouts-regular__field:first-child{padding-top:4px}"));
  document.head.appendChild(style);
}
