  ...
  isValid: {
    ...
    custom: (item, field) => {
      ...
      if (![void 0, "", null].includes(value) && !emailRegex.test(value)) {
        return (0, import_i18n28.__)("Value must be a valid email address.");
      }
      return null;
    }
  },
  ...
  isValid: {
    ...
    custom: (item, field) => {
      ...
      if (!isEmpty2(value) && !Number.isFinite(value)) {
        return (0, import_i18n30.__)("Value must be a number.");
      }
      return null;
    }
  },
...
var boolean_default = {
  ...
  isValid: {
    ...
    custom: (item, field) => {
      ...
      if (![void 0, "", null].includes(value) && ![true, false].includes(value)) {
        return (0, import_i18n31.__)("Value must be true, false, or undefined");
      }
      return null;
    }
  },
  ...
  render: ({ item, field }) => {
    ...
    if (field.getValue({ item }) === true) {
      return (0, import_i18n31.__)("True");
    }
    if (field.getValue({ item }) === false) {
      return (0, import_i18n31.__)("False");
    }
    return null;
  },
  enableSorting: true,
  ...
  isValid: {
    ...
    custom: (item, field) => {
      ...
      if (![void 0, "", null].includes(value) && !Array.isArray(value)) {
        return (0, import_i18n32.__)("Value must be an array.");
      }
      if (!value.every((v2) => typeof v2 === "string")) {
        return (0, import_i18n32.__)("Every value must be a string.");
      }
      return null;
    }
  },
  ...
  isValid: {
    ...
    custom: (item, field) => {
      ...
      if (![void 0, "", null].includes(value) && !w(value).isValid()) {
        return (0, import_i18n33.__)("Value must be a valid color.");
      }
      return null;
    }
  },
...
function RelativeDateControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(
    import_components31.BaseControl,
    {
      ...
      label,
      hideLabelFromVision,
      children: /* @__PURE__ */ (0, import_jsx_runtime78.jsxs)(import_components31.__experimentalHStack, { spacing: 2.5, children: [
...
function CalendarDateTimeControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(
    import_components32.BaseControl,
    {
      ...
      help: description,
      hideLabelFromVision,
      children: /* @__PURE__ */ (0, import_jsx_runtime79.jsxs)(import_components32.__experimentalVStack, { spacing: 4, children: [
    ...
    ValidatedDateControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
        import_components33.BaseControl,
        {
          ...
          label: displayLabel,
          hideLabelFromVision,
          children: /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_components33.__experimentalVStack, { spacing: 4, children: [
            /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_components33.__experimentalHStack, { spacing: 2, wrap: true, justify: "flex-start", children: [
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
        import_components33.BaseControl,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_components33.__experimentalVStack, { spacing: 4, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime80.jsxs)(import_components33.__experimentalHStack, { spacing: 2, children: [
              /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
                import_components33.__experimentalInputControl,
                {
                  __next40pxDefaultSize: true,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "email",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(import_components35.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(import_components35.Icon, { icon: envelope_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "tel",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(import_components36.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(import_components36.Icon, { icon: mobile_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "url",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(import_components37.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(import_components37.Icon, { icon: link_default }) })
      }
    }
  );
}
...
function BetweenControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime85.jsx)(
    import_components38.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime85.jsxs)(import_components38.Flex, { direction: "row", gap: 4, children: [
...
function ToggleGroup({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(import_components43.Spinner, {});
  }
  if (elements.length === 0) {
    return null;
  }
...
function ArrayControl({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime94.jsx)(import_components44.Spinner, {});
  }
...
var ColorPicker = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime95.jsx)(
    ...
    {
      renderToggle: ({ onToggle, isOpen }) => /* @__PURE__ */ (0, import_jsx_runtime95.jsx)(import_components45.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime95.jsx)(
        "button",
        {
          type: "button",
          onClick: onToggle,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(import_components46.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(
