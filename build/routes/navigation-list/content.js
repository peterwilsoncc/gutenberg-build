...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React52 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef45 = React52.useRef, useEffect31 = React52.useEffect, useMemo42 = React52.useMemo, useDebugValue2 = React52.useDebugValue;
...
function PickerActivityItem({
  ...
  const verticalGap = (0, import_element38.useMemo)(() => {
    switch (density) {
      case "comfortable":
        return "md";
      default:
...
function ViewPickerActivity({
  ...
  const { itemListLabel, paginationInfo } = (0, import_element38.useContext)(dataviews_context_default);
  const isMultiselect = useIsMultiselectPicker(actions);
  const titleField = fields.find(
    (field) => field.id === view?.titleField
  );
...
function createStoreContext(providers = [], scopedProviders = []) {
  ...
  const ContextProvider = (props) => {
    return providers.reduceRight(
      (children, Provider2) => /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(Provider2, { ...props, children }),
...
var useComposite = createHook(
  function useComposite2({
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(CompositeContextProvider, { value: store, children: element }),
      [store]
    );
...
var useDisclosureContent = createHook(function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var useComboboxList = createHook(
  function useComboboxList2({ store, alwaysVisible, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(ComboboxScopedContextProvider, { value: store, children: /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
function ComboboxProvider(props = {}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
...
function DataViewsFooter() {
  ...
  return (!!totalItems || isRefreshing) && /* @__PURE__ */ (0, import_jsx_runtime86.jsx)(
    "div",
    {
...
var AddNavigationModal = ({
  ...
  const [menuTitle, setMenuTitle] = (0, import_element75.useState)("");
  const [isBusy, setIsBusy] = (0, import_element75.useState)(false);
...
function NavigationList() {
  ...
  const defaultView = (0, import_element76.useMemo)(() => {
    return getDefaultView();
  }, []);
  const handleQueryParamsChange = (0, import_element76.useCallback)(
    (params) => {
      navigate({
        search: {
          ...searchParams,
  ...
  const [showAddModal, setShowAddModal] = (0, import_element76.useState)(false);
  ...
  const firstNavigationId = (0, import_element76.useMemo)(() => {
