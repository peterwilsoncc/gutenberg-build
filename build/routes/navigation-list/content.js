...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React50 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState37 = React50.useState, useEffect31 = React50.useEffect, useLayoutEffect5 = React50.useLayoutEffect, useDebugValue2 = React50.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React50 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef46 = React50.useRef, useEffect31 = React50.useEffect, useMemo41 = React50.useMemo, useDebugValue2 = React50.useDebugValue;
...
var Popup = (0, import_element15.forwardRef)(function TooltipPopup3({ portal, positioner, children, className, ...props }, ref) {
  const popupContent = /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_theme.ThemeProvider, { color: POPUP_COLOR, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
...
var useComposite = createHook(function useComposite2({ store, composite = true, focusOnMove = composite, moveOnKeyPress = true, ...props }) {
  ...
  (0, import_react14.useEffect)(() => {
    ...
    const itemElement = getEnabledItem(store, activeId2)?.element;
  ...
  props = useWrapElement(props, (element) => /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(CompositeScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
...
function filterOverlappingOffsets(offsets) {
  return offsets.filter(([offset4, length], i2, arr) => {
    return !arr.some(([o2, l2], j2) => j2 !== i2 && o2 <= offset4 && o2 + l2 >= offset4 + length);
  });
}
...
var { ValidatedCheckboxControl } = unlock2(import_components29.privateApis);
function Checkbox({
  field,
  onChange,
  data,
...
var { ValidatedComboboxControl } = unlock2(import_components30.privateApis);
function Combobox3({
  data,
  field,
  onChange,
...
var { DateCalendar, ValidatedInputControl } = unlock2(import_components32.privateApis);
...
var { DateCalendar: DateCalendar2, DateRangeCalendar } = unlock2(import_components33.privateApis);
var DATE_PRESETS = [
  {
    id: "today",
...
var { ValidatedSelectControl } = unlock2(import_components34.privateApis);
function Select({
  data,
  field,
  onChange,
...
var { ValidatedInputControl: ValidatedInputControl2 } = unlock2(import_components35.privateApis);
...
var { ValidatedNumberControl } = unlock2(import_components39.privateApis);
...
var { ValidatedRadioControl } = unlock2(import_components40.privateApis);
function Radio({
  data,
  field,
  onChange,
