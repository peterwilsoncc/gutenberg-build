...
// translators: Use a non-breaking space between 'g:i' and 'a' if appropriate.
// translators: Use a non-breaking space between 'g:i' and 'a' if appropriate.
(0,yn._x)("F j, Y g:i a","Comment date full date format"),n);return(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)("img",{src:null!=e?e:o,className:"editor-collab-sidebar-panel__user-avatar",alt:(0,yn.__)("User avatar"),width:32,height:32}),(0,V.jsxs)(ir.__experimentalVStack,{spacing:"0",children:[(0,V.jsx)("span",{className:"editor-collab-sidebar-panel__user-name",children:null!=t?t:r}),n&&(0,V.jsx)(ir.Tooltip,{placement:"top",text:p,children:(0,V.jsx)("time",{dateTime:l,className:"editor-collab-sidebar-panel__user-time",children:u})})]})]})},dy=function e({onSubmit:t,onCancel:n,thread:s,submitButtonText:o,placeholderText:r,rows:i=4}){var a;const[l,c]=(0,u.useState)(null!==(a=s?.content?.raw)&&void 0!==a?a:""),d=(0,p.useInstanceId)(e,"comment-input"),m=l===s?.content?.raw||!(h=l,h.trim()).length;var h;return(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(ir.VisuallyHidden,{as:"label",htmlFor:d,children:(0,yn.__)("Comment")}),(0,V.jsx)(xf.A,{id:d,value:null!=l?l:"",onChange:e=>c(e.target.value),rows:i,maxRows:20,placeholder:r||""}),(0,V.jsxs)(ir.__experimentalHStack,{spacing:"3",justify:"flex-start",wrap:!0,children:[(0,V.jsx)(ir.Button,{__next40pxDefaultSize:!0,accessibleWhenDisabled:!0,variant:"primary",onClick:()=>{t(l),c("")},disabled:m,text:o}),(0,V.jsx)(ir.Button,{__next40pxDefaultSize:!0,variant:"tertiary",onClick:n,text:(0,yn._x)("Cancel","Cancel comment button")})]})]})},{useBlockElement:uy}=W(h.privateApis),{Menu:py}=W(ir.privateApis);function my({threads:e,onEditComment:t,onAddReply:n,onCommentDelete:s,onCommentResolve:o,onCommentReopen:r,setShowCommentBoard:i}){const{blockCommentId:a}=(0,c.useSelect)((e=>{const{getBlockAttributes:t,getSelectedBlockClientId:n}=e(h.store),s=n();return{blockCommentId:s?t(s)?.blockCommentId:null}}),[]),[l=a,d]=(0,u.useState)();return Array.isArray(e)&&e.length>0?e.map((e=>(0,V.jsx)(hy,{thread:e,onAddReply:n,onCommentDelete:s,onCommentResolve:o,onCommentReopen:r,onEditComment:t,isFocused:l===e.id,setFocusThread:d,setShowCommentBoard:i},e.id))):(0,V.jsx)(ir.__experimentalVStack,{alignment:"left",className:"editor-collab-sidebar-panel__thread",justify:"flex-start",spacing:"2",children:
// translators: message displayed when there are no comments available
// translators: message displayed when there are no comments available
(0,yn.__)("No comments available")})}function hy({thread:e,onEditComment:t,onAddReply:n,onCommentDelete:s,onCommentResolve:o,onCommentReopen:r,isFocused:i,setFocusThread:a,setShowCommentBoard:l}){const{flashBlock:d}=(0,c.useDispatch)(h.store),u=uy(e.blockClientId),p=e?.reply,m=p.length?p[p.length-1]:void 0,g=p.length?p.slice(0,-1):[];return(0,V.jsxs)(ir.__experimentalVStack,{className:ni("editor-collab-sidebar-panel__thread",{"editor-collab-sidebar-panel__focus-thread":i}),id:e.id,spacing:"2",onClick:()=>(({id:e,blockClientId:t})=>{l(!1),a(e),t&&u&&(u.scrollIntoView({behavior:"instant",block:"center"}),d(t))})(e),children:[(0,V.jsx)(gy,{thread:e,onResolve:o,onReopen:r,onEdit:t,onDelete:s,status:e.status}),i&&p.map((n=>(0,V.jsx)(ir.__experimentalVStack,{className:"editor-collab-sidebar-panel__child-thread",id:n.id,spacing:"2",children:(0,V.jsx)(gy,{thread:n,onEdit:"approved"!==e.status?t:void 0,onDelete:"approved"!==e.status?s:void 0})},n.id))),!i&&g.length>0&&(0,V.jsx)(ir.__experimentalHStack,{className:"editor-collab-sidebar-panel__more-reply-separator",children:(0,V.jsx)(ir.Button,{size:"compact",variant:"tertiary",className:"editor-collab-sidebar-panel__more-reply-button",onClick:()=>a(e.id),children:(0,yn.sprintf)(
// translators: %s: number of replies.
// translators: %s: number of replies.
(0,yn._n)("%s more reply","%s more replies",g.length),g.length)})}),!i&&m&&(0,V.jsx)(gy,{thread:m,onEdit:"approved"!==e.status?t:void 0,onDelete:"approved"!==e.status?s:void 0}),i&&(0,V.jsxs)(ir.__experimentalVStack,{className:"editor-collab-sidebar-panel__child-thread",spacing:"2",children:[(0,V.jsx)(ir.__experimentalHStack,{alignment:"left",spacing:"3",justify:"flex-start",children:(0,V.jsx)(cy,{})}),(0,V.jsx)(ir.__experimentalVStack,{spacing:"3",className:"editor-collab-sidebar-panel__comment-field",children:(0,V.jsx)(dy,{onSubmit:t=>{"approved"===e.status&&r(e.id),n(t,e.id)},onCancel:e=>{e.stopPropagation(),a(null),l(!1)},placeholderText:"approved"===e.status&&(0,yn.__)("Adding a comment will re-open this discussion…."),submitButtonText:"approved"===e.status?(0,yn._x)("Reopen & Reply","Reopen comment and add reply"):(0,yn._x)("Reply","Add reply comment"),rows:"approved"===e.status?2:4})})]})]})}const gy=({thread:e,onResolve:t,onReopen:n,onEdit:s,onDelete:o,status:r})=>{const[i,a]=(0,u.useState)(!1),[l,c]=(0,u.useState)(!1),d=()=>{a(!1),c(!1)},p=[s&&"approved"!==r&&{id:"edit",title:(0,yn._x)("Edit","Edit comment"),onClick:()=>{a("edit")}},o&&{id:"delete",title:(0,yn._x)("Delete","Delete comment"),onClick:()=>{a("delete"),c(!0)}},n&&"approved"===r&&{id:"reopen",title:(0,yn._x)("Reopen","Reopen comment"),onClick:()=>{n(e.id)}}],m=0===e?.parent&&t,h=p.filter((e=>e?.onClick));return(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(ir.__experimentalHStack,{alignment:"left",spacing:"3",justify:"flex-start",children:[(0,V.jsx)(cy,{avatar:e?.author_avatar_urls?.[48],name:e?.author_name,date:e?.date}),(0,V.jsx)("span",{className:"editor-collab-sidebar-panel__comment-status",children:(0,V.jsxs)(ir.__experimentalHStack,{alignment:"right",justify:"flex-end",spacing:"0",children:[m&&(0,V.jsx)(ir.Button,{label:(0,yn._x)("Resolve","Mark comment as resolved"),size:"small",icon:Zl,disabled:"approved"===r,accessibleWhenDisabled:"approved"===r,onClick:()=>{t(e.id)}}),(0,V.jsxs)(py,{placement:"bottom-end",children:[(0,V.jsx)(py.TriggerButton,{render:(0,V.jsx)(ir.Button,{size:"small",icon:ly,label:(0,yn.__)("Actions"),disabled:!h.length,accessibleWhenDisabled:!0})}),(0,V.jsx)(py.Popover,{children:h.map((e=>(0,V.jsx)(py.Item,{onClick:t=>{t.stopPropagation(),e.onClick()},children:(0,V.jsx)(py.ItemLabel,{children:e.title})},e.id)))})]})]})})]}),"edit"===i?(0,V.jsx)(dy,{onSubmit:t=>{s(e.id,t),a(!1)},onCancel:()=>d(),thread:e,submitButtonText:(0,yn._x)("Update","verb")}):(0,V.jsx)(u.RawHTML,{className:"editor-collab-sidebar-panel__user-comment",children:e?.content?.rendered}),"delete"===i&&(0,V.jsx)(ir.__experimentalConfirmDialog,{isOpen:l,onConfirm:()=>{o(e.id),a(!1),c(!1)},onCancel:d,confirmButtonText:(0,yn.__)("Delete"),children:
