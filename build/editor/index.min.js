...
(0,m.__)("Some errors occurred while restoring the posts: %s"),[...t].join(","))}n(e,{type:"snackbar"})}}},ng={id:"view-post",label:(0,m.__)("View"),isPrimary:!0,icon:uu,isEligible:e=>"trash"!==e.status,callback(e,{onActionPerformed:t}){const s=e[0];window.open(s.link,"_blank"),t&&t(e)}},ig={id:"view-post-revisions",context:"list",label(e){var t;const s=null!==(t=e[0]._links?.["version-history"]?.[0]?.count)&&void 0!==t?t:0;return(0,m.sprintf)(/* translators: %s: number of revisions */ /* translators: %s: number of revisions */
...
// translators: %s: Current post format.
(0,m.__)("Change format: %s"),t?.caption),onClick:s,children:t?.caption}),renderContent:({onClose:e})=>(0,E.jsxs)("div",{className:"editor-post-format__dialog-content",children:[(0,E.jsx)(g.__experimentalInspectorPopoverHeader,{title:(0,m.__)("Format"),onClose:e}),(0,E.jsx)(bl,{})]})})})})};function Pg(){const e=(0,d.useSelect)((e=>e(mn).getEditedPostAttribute("modified")),[]),t=e&&(0,m.sprintf)(
...
(0,m._n)("%d block is hidden.","%d blocks are hidden.",n),n),(0,E.jsx)(Rn.Button,{variant:"link",onClick:()=>i(e),children:(0,m.__)("Reset")})]}),(0,E.jsx)(Rn.SearchControl,{__nextHasNoMarginBottom:!0,label:(0,m.__)("Search for a block"),placeholder:(0,m.__)("Search for a block"),value:a,onChange:e=>l(e),className:"editor-block-manager__search"}),(0,E.jsxs)("div",{tabIndex:"0",role:"region","aria-label":(0,m.__)("Available block types"),className:"editor-block-manager__results",children:[0===e.length&&(0,E.jsx)("p",{className:"editor-block-manager__no-results",children:(0,m.__)("No blocks found.")}),t.map((t=>(0,E.jsx)(l_,{title:t.title,blockTypes:e.filter((e=>e.category===t.slug))},t.slug))),(0,E.jsx)(l_,{title:(0,m.__)("Uncategorized"),blockTypes:e.filter((({category:e})=>!e))})]})]})})),{PreferencesModal:d_,PreferencesModalTabs:u_,PreferencesModalSection:p_,PreferenceToggleControl:h_}=h(I.privateApis),{PATTERN_TYPES:m_}=h(wn.privateApis),g_={id:"delete-post",label:(0,m.__)("Delete"),isPrimary:!0,icon:Sm,isEligible:e=>{return function(e){return e.type===F||e.type===V}(e)?!!(t=e)&&[t.source,t.source].includes(H.custom)&&!t.has_theme_file:e.type===m_.user;var t},supportsBulk:!0,hideModalHeader:!0,RenderModal:({items:e,closeModal:t,onActionPerformed:s})=>{const[o,n]=(0,j.useState)(!1),{removeTemplates:i}=h((0,d.useDispatch)(mn));return(0,E.jsxs)(Rn.__experimentalVStack,{spacing:"5",children:[(0,E.jsx)(Rn.__experimentalText,{children:e.length>1?(0,m.sprintf)(
// translators: %d: number of items to delete.
// translators: %d: number of items to delete.
(0,m._n)("Delete %d item?","Delete %d items?",e.length),e.length):(0,m.sprintf)(
// translators: %s: The template or template part's titles
// translators: %s: The template or template part's titles
(0,m.__)('Delete "%s"?'),(r=e[0],"string"==typeof r.title?(0,Oo.decodeEntities)(r.title):(0,Oo.decodeEntities)(r.title?.rendered||"")))}),(0,E.jsxs)(Rn.__experimentalHStack,{justify:"right",children:[(0,E.jsx)(Rn.Button,{variant:"tertiary",onClick:t,disabled:o,__experimentalIsFocusable:!0,children:(0,m.__)("Cancel")}),(0,E.jsx)(Rn.Button,{variant:"primary",onClick:async()=>{n(!0),await i(e,{allowUndo:!1}),s?.(e),n(!1),t?.()},isBusy:o,disabled:o,__experimentalIsFocusable:!0,children:(0,m.__)("Delete")})]})]});var r}},f_=g_,{store:b_,...y_}=l,x_={};function v_(e,t,s){const{registerEntityAction:o}=h((0,d.dispatch)(mn));o(e,t,s)}function w_(e,t,s){const{unregisterEntityAction:o}=h((0,d.dispatch)(mn));o(e,t,s)}p(x_,{CreateTemplatePartModal:Ju,BackButton:vh,EntitiesSavedStatesExtensible:dr,Editor:function({postType:e,postId:t,templateId:s,settings:o,children:n,initialEdits:i,onActionPerformed:r,extraContent:a,extraSidebarPanels:l,...c}){const{post:u,template:p,hasLoadedPost:h}=(0,d.useSelect)((o=>{const{getEntityRecord:n,hasFinishedResolution:i}=o(b.store);return{post:n("postType",e,t),template:s?n("postType",F,s):void 0,hasLoadedPost:i("getEntityRecord",["postType",e,t])}}),[e,t,s]);return(0,E.jsxs)(E.Fragment,{children:[h&&!u&&(0,E.jsx)(Rn.Notice,{status:"warning",isDismissible:!1,children:(0,m.__)("You attempted to edit an item that doesn't exist. Perhaps it was deleted?")}),!!u&&(0,E.jsxs)(lp,{post:u,__unstableTemplate:p,settings:o,initialEdits:i,useSubRegistry:!1,children:[(0,E.jsx)(xm,{...c,children:a}),(0,E.jsx)(n_,{onActionPerformed:r,extraPanels:l}),n]})]})},EditorContentSlotFill:_h,GlobalStylesProvider:function({children:e}){const t=$d();return t.isReady?(0,E.jsx)(zd.Provider,{value:t,children:e}):null},mergeBaseAndUserConfigs:Gd,PluginPostExcerpt:Xa,PreferencesModal:function({extraSections:e={}}){const t=(0,bn.useViewportMatch)("medium"),{isActive:s,showBlockBreadcrumbsOption:o}=(0,d.useSelect)((e=>{const{getEditorSettings:s}=e(mn),{get:o}=e(I.store),{isModalActive:n}=e(ni),i=s().richEditingEnabled;return{showBlockBreadcrumbsOption:!o("core","distractionFree")&&t&&i,isActive:n("editor/preferences")}}),[t]),{closeModal:n}=(0,d.useDispatch)(ni),{setIsListViewOpened:i,setIsInserterOpened:r}=(0,d.useDispatch)(mn),{set:a}=(0,d.useDispatch)(I.store),l=(0,j.useMemo)((()=>[{name:"general",tabLabel:(0,m.__)("General"),content:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsxs)(p_,{title:(0,m.__)("Interface"),children:[(0,E.jsx)(h_,{scope:"core",featureName:"showListViewByDefault",help:(0,m.__)("Opens the List View sidebar by default."),label:(0,m.__)("Always open List View")}),o&&(0,E.jsx)(h_,{scope:"core",featureName:"showBlockBreadcrumbs",help:(0,m.__)("Display the block hierarchy trail at the bottom of the editor."),label:(0,m.__)("Show block breadcrumbs")}),(0,E.jsx)(h_,{scope:"core",featureName:"allowRightClickOverrides",help:(0,m.__)("Allows contextual List View menus via right-click, overriding browser defaults."),label:(0,m.__)("Allow right-click contextual menus")})]}),(0,E.jsxs)(p_,{title:(0,m.__)("Document settings"),description:(0,m.__)("Select what settings are shown in the document panel."),children:[(0,E.jsx)(oa.Slot,{}),(0,E.jsx)(Xc,{taxonomyWrapper:(e,t)=>(0,E.jsx)(Jr,{label:t.labels.menu_name,panelName:`taxonomy-panel-${t.slug}`})}),(0,E.jsx)(rl,{children:(0,E.jsx)(Jr,{label:(0,m.__)("Featured image"),panelName:"featured-image"})}),(0,E.jsx)(Ka,{children:(0,E.jsx)(Jr,{label:(0,m.__)("Excerpt"),panelName:"post-excerpt"})}),(0,E.jsx)(xr,{supportKeys:["comments","trackbacks"],children:(0,E.jsx)(Jr,{label:(0,m.__)("Discussion"),panelName:"discussion-panel"})}),(0,E.jsx)(br,{children:(0,E.jsx)(Jr,{label:(0,m.__)("Page attributes"),panelName:"page-attributes"})})]}),t&&(0,E.jsx)(p_,{title:(0,m.__)("Publishing"),children:(0,E.jsx)(r_,{help:(0,m.__)("Review settings, such as visibility and tags."),label:(0,m.__)("Enable pre-publish checks")})}),e?.general]})},{name:"appearance",tabLabel:(0,m.__)("Appearance"),content:(0,E.jsxs)(p_,{title:(0,m.__)("Appearance"),description:(0,m.__)("Customize the editor interface to suit your needs."),children:[(0,E.jsx)(h_,{scope:"core",featureName:"fixedToolbar",onToggle:()=>a("core","distractionFree",!1),help:(0,m.__)("Access all block and document tools in a single place."),label:(0,m.__)("Top toolbar")}),(0,E.jsx)(h_,{scope:"core",featureName:"distractionFree",onToggle:()=>{a("core","fixedToolbar",!0),r(!1),i(!1)},help:(0,m.__)("Reduce visual distractions by hiding the toolbar and other elements to focus on writing."),label:(0,m.__)("Distraction free")}),(0,E.jsx)(h_,{scope:"core",featureName:"focusMode",help:(0,m.__)("Highlights the current block and fades other content."),label:(0,m.__)("Spotlight mode")}),e?.appearance]})},{name:"accessibility",tabLabel:(0,m.__)("Accessibility"),content:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(p_,{title:(0,m.__)("Navigation"),description:(0,m.__)("Optimize the editing experience for enhanced control."),children:(0,E.jsx)(h_,{scope:"core",featureName:"keepCaretInsideBlock",help:(0,m.__)("Keeps the text cursor within the block boundaries, aiding users with screen readers by preventing unintentional cursor movement outside the block."),label:(0,m.__)("Contain text cursor inside block")})}),(0,E.jsx)(p_,{title:(0,m.__)("Interface"),children:(0,E.jsx)(h_,{scope:"core",featureName:"showIconLabels",label:(0,m.__)("Show button text labels"),help:(0,m.__)("Show text instead of icons on buttons across the interface.")})})]})},{name:"blocks",tabLabel:(0,m.__)("Blocks"),content:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(p_,{title:(0,m.__)("Inserter"),children:(0,E.jsx)(h_,{scope:"core",featureName:"mostUsedBlocks",help:(0,m.__)("Adds a category with the most frequently used blocks in the inserter."),label:(0,m.__)("Show most used blocks")})}),(0,E.jsx)(p_,{title:(0,m.__)("Manage block visibility"),description:(0,m.__)("Disable blocks that you don't want to appear in the inserter. They can always be toggled back on later."),children:(0,E.jsx)(c_,{})})]})}]),[o,e,r,i,a,t]);return s?(0,E.jsx)(d_,{closeModal:n,children:(0,E.jsx)(u_,{sections:l})}):null},usePostActions:ug,ToolsMoreMenuGroup:Rh,ViewMoreMenuGroup:Oh,ResizableEditor:rm,registerDefaultActions:function(){const{registerEntityAction:e}=h((0,d.dispatch)(mn));e("postType","*",f_)},useBlockEditorSettings:Jd,interfaceStore:b_,...y_})})(),(window.wp=window.wp||{}).editor=o})();
