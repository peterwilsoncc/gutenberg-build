...
(0,gs._n)("%d block is hidden.","%d blocks are hidden.",l),l),(0,P.jsx)(Vo.Button,{__next40pxDefaultSize:!0,variant:"link",onClick:()=>function(e){const t=e.map((({name:e})=>e));o(t)}(d),children:(0,gs.__)("Reset")})]}),(0,P.jsx)(Vo.SearchControl,{__nextHasNoMarginBottom:!0,label:(0,gs.__)("Search for a block"),placeholder:(0,gs.__)("Search for a block"),value:t,onChange:e=>s(e),className:"editor-block-manager__search"}),(0,P.jsxs)("div",{tabIndex:"0",role:"region","aria-label":(0,gs.__)("Available block types"),className:"editor-block-manager__results",children:[0===d.length&&(0,P.jsx)("p",{className:"editor-block-manager__no-results",children:(0,gs.__)("No blocks found.")}),i.map((e=>(0,P.jsx)(J_,{title:e.title,blockTypes:d.filter((t=>t.category===e.slug))},e.slug))),(0,P.jsx)(J_,{title:(0,gs.__)("Uncategorized"),blockTypes:d.filter((({category:e})=>!e))})]})]})}const{PreferencesModal:tf,PreferencesModalTabs:sf,PreferencesModalSection:of,PreferenceToggleControl:nf}=xs(j.privateApis),rf="content",af={name:"core/pattern-overrides",getValues({select:e,clientId:t,context:s,bindings:o}){const n=s["pattern/overrides"],{getBlockAttributes:i}=e(m.store),r=i(t),a={};for(const e of Object.keys(o)){const t=n?.[r?.metadata?.name]?.[e];a[e]=void 0!==t?""===t?void 0:t:r[e]}return a},setValues({select:e,dispatch:t,clientId:s,bindings:o}){const{getBlockAttributes:n,getBlockParentsByBlockName:i,getBlocks:r}=e(m.store),a=n(s),l=a?.metadata?.name;if(!l)return;const[c]=i(s,"core/block",!0),d=Object.entries(o).reduce(((e,[t,{newValue:s}])=>(e[t]=s,e)),{});if(!c){const e=s=>{for(const o of s)o.attributes?.metadata?.name===l&&t(m.store).updateBlockAttributes(o.clientId,d),e(o.innerBlocks)};return void e(r())}const u=n(c)?.[rf];t(m.store).updateBlockAttributes(c,{[rf]:{...u,[l]:{...u?.[l],...Object.entries(d).reduce(((e,[t,s])=>(e[t]=void 0===s?"":s,e)),{})}}})},canUserEditValue:()=>!0};function lf(e,t){const{getEditedEntityRecord:s}=e(d.store),{getRegisteredPostMeta:o}=xs(e(d.store));let n;t?.postType&&t?.postId&&(n=s("postType",t?.postType,t?.postId).meta);const i=o(t?.postType),r={};return Object.entries(i||{}).forEach((([e,t])=>{var s;"footnotes"!==e&&"_"!==e.charAt(0)&&(r[e]={label:t.title||e,value:null!==(s=n?.[e])&&void 0!==s?s:t.default||void 0})})),Object.keys(r||{}).length?r:null}const cf={name:"core/post-meta",getValues({select:e,context:t,bindings:s}){const o=lf(e,t),n={};for(const[e,t]of Object.entries(s)){var i;const s=t.args.key,{value:r,label:a}=o?.[s]||{};n[e]=null!==(i=null!=r?r:a)&&void 0!==i?i:s}return n},setValues({dispatch:e,context:t,bindings:s}){const o={};Object.values(s).forEach((({args:e,newValue:t})=>{o[e.key]=t})),e(d.store).editEntityRecord("postType",t?.postType,t?.postId,{meta:o})},canUserEditValue({select:e,context:t,args:s}){if(t?.query||t?.queryId)return!1;if("wp_template"===(t?.postType||e(or).getCurrentPostType()))return!1;const o=lf(e,t)?.[s.key]?.value;return void 0!==o&&(!e(or).getEditorSettings().enableCustomFields&&!!e(d.store).canUser("update",{kind:"postType",name:t?.postType,id:t?.postId}))},getFieldsList:({select:e,context:t})=>lf(e,t)},{store:df,...uf}=l,pf={};function hf(e,t,s){const{registerEntityAction:o}=xs((0,c.dispatch)(or));o(e,t,s)}function mf(e,t,s){const{unregisterEntityAction:o}=xs((0,c.dispatch)(or));o(e,t,s)}ys(pf,{CreateTemplatePartModal:Si,BackButton:ig,EntitiesSavedStatesExtensible:$a,Editor:function({postType:e,postId:t,templateId:s,settings:o,children:n,initialEdits:i,onActionPerformed:r,extraContent:a,extraSidebarPanels:l,...u}){const{post:p,template:h,hasLoadedPost:m}=(0,c.useSelect)((o=>{const{getEntityRecord:n,hasFinishedResolution:i}=o(d.store);return{post:n("postType",e,t),template:s?n("postType",R,s):void 0,hasLoadedPost:i("getEntityRecord",["postType",e,t])}}),[e,t,s]);return(0,P.jsxs)(P.Fragment,{children:[m&&!p&&(0,P.jsx)(Vo.Notice,{status:"warning",isDismissible:!1,children:(0,gs.__)("You attempted to edit an item that doesn't exist. Perhaps it was deleted?")}),!!p&&(0,P.jsxs)(Wh,{post:p,__unstableTemplate:h,settings:o,initialEdits:i,useSubRegistry:!1,children:[(0,P.jsx)(a_,{...u,children:a}),n,(0,P.jsx)(K_,{onActionPerformed:r,extraPanels:l})]})]})},EditorContentSlotFill:eg,GlobalStylesProvider:function({children:e}){const t=Fp();return t.isReady?(0,P.jsx)(Mp.Provider,{value:t,children:e}):null},mergeBaseAndUserConfigs:Lp,PluginPostExcerpt:Nc,PostCardPanel:b_,PreferencesModal:function({extraSections:e={}}){const t=(0,p.useViewportMatch)("medium"),{isActive:s,showBlockBreadcrumbsOption:o}=(0,c.useSelect)((e=>{const{getEditorSettings:s}=e(or),{get:o}=e(j.store),{isModalActive:n}=e(Fr),i=s().richEditingEnabled;return{showBlockBreadcrumbsOption:!o("core","distractionFree")&&t&&i,isActive:n("editor/preferences")}}),[t]),{closeModal:n}=(0,c.useDispatch)(Fr),{setIsListViewOpened:i,setIsInserterOpened:r}=(0,c.useDispatch)(or),{set:a}=(0,c.useDispatch)(j.store),l=!!yh().length,d=(0,u.useMemo)((()=>[{name:"general",tabLabel:(0,gs.__)("General"),content:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(of,{title:(0,gs.__)("Interface"),children:[(0,P.jsx)(nf,{scope:"core",featureName:"showListViewByDefault",help:(0,gs.__)("Opens the List View sidebar by default."),label:(0,gs.__)("Always open List View")}),o&&(0,P.jsx)(nf,{scope:"core",featureName:"showBlockBreadcrumbs",help:(0,gs.__)("Display the block hierarchy trail at the bottom of the editor."),label:(0,gs.__)("Show block breadcrumbs")}),(0,P.jsx)(nf,{scope:"core",featureName:"allowRightClickOverrides",help:(0,gs.__)("Allows contextual List View menus via right-click, overriding browser defaults."),label:(0,gs.__)("Allow right-click contextual menus")}),l&&(0,P.jsx)(nf,{scope:"core",featureName:"enableChoosePatternModal",help:(0,gs.__)("Shows starter patterns when creating a new page."),label:(0,gs.__)("Show starter patterns")})]}),(0,P.jsxs)(of,{title:(0,gs.__)("Document settings"),description:(0,gs.__)("Select what settings are shown in the document panel."),children:[(0,P.jsx)(Ml.Slot,{}),(0,P.jsx)(Wu,{taxonomyWrapper:(e,t)=>(0,P.jsx)(Nl,{label:t.labels.menu_name,panelName:`taxonomy-panel-${t.slug}`})}),(0,P.jsx)(Fc,{children:(0,P.jsx)(Nl,{label:(0,gs.__)("Featured image"),panelName:"featured-image"})}),(0,P.jsx)(Ec,{children:(0,P.jsx)(Nl,{label:(0,gs.__)("Excerpt"),panelName:"post-excerpt"})}),(0,P.jsx)(el,{supportKeys:["comments","trackbacks"],children:(0,P.jsx)(Nl,{label:(0,gs.__)("Discussion"),panelName:"discussion-panel"})}),(0,P.jsx)(Ja,{children:(0,P.jsx)(Nl,{label:(0,gs.__)("Page attributes"),panelName:"page-attributes"})})]}),t&&(0,P.jsx)(of,{title:(0,gs.__)("Publishing"),children:(0,P.jsx)(Q_,{help:(0,gs.__)("Review settings, such as visibility and tags."),label:(0,gs.__)("Enable pre-publish checks")})}),e?.general]})},{name:"appearance",tabLabel:(0,gs.__)("Appearance"),content:(0,P.jsxs)(of,{title:(0,gs.__)("Appearance"),description:(0,gs.__)("Customize the editor interface to suit your needs."),children:[(0,P.jsx)(nf,{scope:"core",featureName:"fixedToolbar",onToggle:()=>a("core","distractionFree",!1),help:(0,gs.__)("Access all block and document tools in a single place."),label:(0,gs.__)("Top toolbar")}),(0,P.jsx)(nf,{scope:"core",featureName:"distractionFree",onToggle:()=>{a("core","fixedToolbar",!0),r(!1),i(!1)},help:(0,gs.__)("Reduce visual distractions by hiding the toolbar and other elements to focus on writing."),label:(0,gs.__)("Distraction free")}),(0,P.jsx)(nf,{scope:"core",featureName:"focusMode",help:(0,gs.__)("Highlights the current block and fades other content."),label:(0,gs.__)("Spotlight mode")}),e?.appearance]})},{name:"accessibility",tabLabel:(0,gs.__)("Accessibility"),content:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(of,{title:(0,gs.__)("Navigation"),description:(0,gs.__)("Optimize the editing experience for enhanced control."),children:(0,P.jsx)(nf,{scope:"core",featureName:"keepCaretInsideBlock",help:(0,gs.__)("Keeps the text cursor within the block boundaries, aiding users with screen readers by preventing unintentional cursor movement outside the block."),label:(0,gs.__)("Contain text cursor inside block")})}),(0,P.jsx)(of,{title:(0,gs.__)("Interface"),children:(0,P.jsx)(nf,{scope:"core",featureName:"showIconLabels",label:(0,gs.__)("Show button text labels"),help:(0,gs.__)("Show text instead of icons on buttons across the interface.")})})]})},{name:"blocks",tabLabel:(0,gs.__)("Blocks"),content:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(of,{title:(0,gs.__)("Inserter"),children:(0,P.jsx)(nf,{scope:"core",featureName:"mostUsedBlocks",help:(0,gs.__)("Adds a category with the most frequently used blocks in the inserter."),label:(0,gs.__)("Show most used blocks")})}),(0,P.jsx)(of,{title:(0,gs.__)("Manage block visibility"),description:(0,gs.__)("Disable blocks that you don't want to appear in the inserter. They can always be toggled back on later."),children:(0,P.jsx)(ef,{})})]})},window.__experimentalMediaProcessing&&{name:"media",tabLabel:(0,gs.__)("Media"),content:(0,P.jsx)(P.Fragment,{children:(0,P.jsxs)(of,{title:(0,gs.__)("General"),description:(0,gs.__)("Customize options related to the media upload flow."),children:[(0,P.jsx)(nf,{scope:"core/media",featureName:"optimizeOnUpload",help:(0,gs.__)("Compress media items before uploading to the server."),label:(0,gs.__)("Pre-upload compression")}),(0,P.jsx)(nf,{scope:"core/media",featureName:"requireApproval",help:(0,gs.__)("Require approval step when optimizing existing media."),label:(0,gs.__)("Approval step")})]})})}].filter(Boolean)),[o,e,r,i,a,t,l]);return s?(0,P.jsx)(tf,{closeModal:n,children:(0,P.jsx)(sf,{sections:d})}):null},usePostActions:d_,ToolsMoreMenuGroup:bg,ViewMoreMenuGroup:vg,ResizableEditor:Wg,registerCoreBlockBindingsSources:function(){(0,y.registerBlockBindingsSource)(af),(0,y.registerBlockBindingsSource)(cf)},bootstrapBlockBindingsSourcesFromServer:function(e){if(e){const{addBootstrappedBlockBindingsSource:t}=xs((0,c.dispatch)(y.store));for(const[s,o]of Object.entries(e))t({name:s,...o})}},interfaceStore:df,...uf})})(),(window.wp=window.wp||{}).editor=o})();
