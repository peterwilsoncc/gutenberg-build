...
// translators: message displayed when there are no comments available
(0,yn.__)("No comments available")})}function _y({thread:e,onEditComment:t,onAddReply:n,onCommentDelete:s,isFocused:o,setFocusThread:r,setShowCommentBoard:i}){const{toggleBlockHighlight:a}=(0,c.useDispatch)(h.store),l=my(e.blockClientId),d=(0,p.useDebounce)(a,50),u=()=>{d(e.blockClientId,!0)},m=()=>{d(e.blockClientId,!1)},g=e?.reply,_=g.length?g[g.length-1]:void 0,f=g.length?g.slice(0,-1):[];return(0,V.jsxs)(ir.__experimentalVStack,{className:ni("editor-collab-sidebar-panel__thread",{"editor-collab-sidebar-panel__focus-thread":o}),id:e.id,spacing:"2",onClick:()=>(({id:e,blockClientId:t})=>{i(!1),r(e),t&&l&&l.scrollIntoView({behavior:"instant",block:"center"})})(e),onMouseEnter:u,onMouseLeave:m,onFocus:u,onBlur:m,children:[(0,V.jsx)(fy,{thread:e,onEdit:t,onDelete:s,status:e.status}),o&&g.map((n=>(0,V.jsx)(ir.__experimentalVStack,{className:"editor-collab-sidebar-panel__child-thread",id:n.id,spacing:"2",children:(0,V.jsx)(fy,{thread:n,onEdit:"approved"!==e.status?t:void 0,onDelete:"approved"!==e.status?s:void 0})},n.id))),!o&&f.length>0&&(0,V.jsx)(ir.__experimentalHStack,{className:"editor-collab-sidebar-panel__more-reply-separator",children:(0,V.jsx)(ir.Button,{size:"compact",variant:"tertiary",className:"editor-collab-sidebar-panel__more-reply-button",onClick:()=>r(e.id),children:(0,yn.sprintf)(
// translators: %s: number of replies.
// translators: %s: number of replies.
(0,yn._n)("%s more reply","%s more replies",f.length),f.length)})}),!o&&_&&(0,V.jsx)(fy,{thread:_,onEdit:"approved"!==e.status?t:void 0,onDelete:"approved"!==e.status?s:void 0}),o&&(0,V.jsxs)(ir.__experimentalVStack,{className:"editor-collab-sidebar-panel__child-thread",spacing:"2",children:[(0,V.jsx)(ir.__experimentalHStack,{alignment:"left",spacing:"3",justify:"flex-start",children:(0,V.jsx)(uy,{})}),(0,V.jsx)(ir.__experimentalVStack,{spacing:"2",children:(0,V.jsx)(py,{onSubmit:s=>{"approved"===e.status&&t({id:e.id,status:"hold"}),n({content:s,parent:e.id})},onCancel:e=>{e.stopPropagation(),r(null),i(!1)},submitButtonText:"approved"===e.status?(0,yn.__)("Reopen & Reply"):(0,yn.__)("Reply"),rows:"approved"===e.status?2:4,labelText:(0,yn.sprintf)(
