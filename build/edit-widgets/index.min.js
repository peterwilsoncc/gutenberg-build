...
/* translators: button label text should, if possible, be under 16
      	characters. */,label:(0,v._x)("Toggle block inserter","Generic label for block inserter button"),size:"compact"}),e&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(E.ToolbarItem,{as:Zt}),(0,I.jsx)(E.ToolbarItem,{as:Kt}),(0,I.jsx)(E.ToolbarItem,{as:E.Button,className:"edit-widgets-header-toolbar__list-view-toggle",icon:Ut,isPressed:r
...
(0,v.__)('The "%s" plugin has encountered an error and cannot be rendered.'),e))}}),(0,I.jsx)(vr,{}),(0,I.jsx)(kr,{})]})})})},Er=["core/more","core/freeform","core/template-part","core/block"],{registerCoreBlockBindingsSources:Ar,bootstrapBlockBindingsSourcesFromServer:Ir}=nt(p.privateApis);function Cr(e,t){const r=document.getElementById(e),i=(0,h.createRoot)(r),s=(0,m.__experimentalGetCoreBlocks)().filter((e=>!(Er.includes(e.name)||e.name.startsWith("core/post")||e.name.startsWith("core/query")||e.name.startsWith("core/site")||e.name.startsWith("core/navigation"))));return(0,l.dispatch)(b.store).setDefaults("core/edit-widgets",{fixedToolbar:!1,welcomeGuide:!0,showBlockBreadcrumbs:!0,themeStyles:!0}),(0,l.dispatch)(d.store).reapplyBlockTypeFilters(),(0,m.registerCoreBlocks)(s),Ir(t?.blockBindingsSources),Ar(),(0,w.registerLegacyWidgetBlock)(),(0,m.__experimentalRegisterExperimentalCoreBlocks)({enableFSEBlocks:St}),(0,w.registerLegacyWidgetVariations)(t),Tr(c),(0,w.registerWidgetGroupBlock)(),t.__experimentalFetchLinkSuggestions=(e,r)=>(0,_.__experimentalFetchLinkSuggestions)(e,r,t),(0,d.setFreeformContentHandlerName)("core/html"),i.render((0,I.jsx)(h.StrictMode,{children:(0,I.jsx)(Sr,{blockEditorSettings:t})})),i}const Br=Cr;function Nr(){g()("wp.editWidgets.reinitializeEditor",{since:"6.2",version:"6.3"})}const Tr=e=>{if(!e)return;const{metadata:t,settings:r,name:i}=e;t&&(0,d.unstable__bootstrapServerSideBlockDefinitions)({[i]:t}),(0,d.registerBlockType)(i,r)};(window.wp=window.wp||{}).editWidgets=t})();
