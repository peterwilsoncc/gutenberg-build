...
global $gutenberg_experiments_wp_admin_routes, $gutenberg_experiments_wp_admin_menu_items;
$gutenberg_experiments_wp_admin_routes     = array();
$gutenberg_experiments_wp_admin_menu_items = array();
 ...
 */
function gutenberg_register_experiments_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_experiments_wp_admin_routes;
	...
	$gutenberg_experiments_wp_admin_routes[] = $route;
}
 ...
 */
function gutenberg_register_experiments_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $gutenberg_experiments_wp_admin_menu_items;
	...
	$gutenberg_experiments_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_experiments_wp_admin_routes() {
	global $gutenberg_experiments_wp_admin_routes;
	return $gutenberg_experiments_wp_admin_routes ?? array();
}
 ...
 */
function gutenberg_get_experiments_wp_admin_menu_items() {
	global $gutenberg_experiments_wp_admin_menu_items;
	return $gutenberg_experiments_wp_admin_menu_items ?? array();
}
 ...
 */
function gutenberg_experiments_wp_admin_preload_data() {
...
function gutenberg_experiments_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	/**
	 * Fires when the experiments admin page is initialized so extensions can register routes and menu items.
	 */
	do_action( 'experiments-wp-admin_init' );

	// Preload REST API data
	gutenberg_experiments_wp_admin_preload_data();

	// Get all registered routes
	$routes = gutenberg_get_experiments_wp_admin_routes();
 ...
 */
function gutenberg_experiments_wp_admin_render_page() {
	?>
	<style>
