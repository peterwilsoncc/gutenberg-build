...
global $gutenberg_media_editor_routes, $gutenberg_media_editor_menu_items;
$gutenberg_media_editor_routes     = array();
$gutenberg_media_editor_menu_items = array();
 ...
 */
function gutenberg_register_media_editor_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_media_editor_routes;
	...
	$gutenberg_media_editor_routes[] = $route;
}
 ...
 */
function gutenberg_register_media_editor_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_media_editor_menu_items;
	...
	$gutenberg_media_editor_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_media_editor_routes() {
	global $gutenberg_media_editor_routes;
	return $gutenberg_media_editor_routes ?? array();
}
 ...
 */
function gutenberg_get_media_editor_menu_items() {
	global $gutenberg_media_editor_menu_items;
	return $gutenberg_media_editor_menu_items ?? array();
}
 ...
 */
function gutenberg_media_editor_preload_data() {
 ...
 */
function gutenberg_media_editor_render_page() {
	...
	gutenberg_media_editor_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_media_editor_menu_items();
	$routes = gutenberg_get_media_editor_routes();
 ...
 */
function gutenberg_media_editor_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'media-editor' === $_GET['page'] ) {
		gutenberg_media_editor_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_media_editor_intercept_render' );
