...
global $gutenberg_taxonomies_wp_admin_routes, $gutenberg_taxonomies_wp_admin_menu_items;
$gutenberg_taxonomies_wp_admin_routes     = array();
$gutenberg_taxonomies_wp_admin_menu_items = array();
 ...
 */
function gutenberg_register_taxonomies_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_taxonomies_wp_admin_routes;
	...
	$gutenberg_taxonomies_wp_admin_routes[] = $route;
}
 ...
 */
function gutenberg_register_taxonomies_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $gutenberg_taxonomies_wp_admin_menu_items;
	...
	$gutenberg_taxonomies_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_taxonomies_wp_admin_routes() {
	global $gutenberg_taxonomies_wp_admin_routes;
	return $gutenberg_taxonomies_wp_admin_routes ?? array();
}
 ...
 */
function gutenberg_get_taxonomies_wp_admin_menu_items() {
	global $gutenberg_taxonomies_wp_admin_menu_items;
	return $gutenberg_taxonomies_wp_admin_menu_items ?? array();
}
 ...
 */
function gutenberg_taxonomies_wp_admin_preload_data() {
 ...
 */
function gutenberg_taxonomies_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	gutenberg_taxonomies_wp_admin_preload_data();

	// Get all registered routes
	$routes = gutenberg_get_taxonomies_wp_admin_routes();
	...
	if ( file_exists( $asset_file ) ) {
		...
		$boot_dependencies = apply_filters(
			'taxonomies-wp-admin_boot_dependencies',
			$boot_dependencies
		);
 ...
 */
function gutenberg_taxonomies_wp_admin_render_page() {
	?>
	<style>
...
add_action( 'admin_enqueue_scripts', 'gutenberg_taxonomies_wp_admin_enqueue_scripts' );
