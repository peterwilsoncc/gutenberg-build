...
global $gutenberg_taxonomies_routes, $gutenberg_taxonomies_menu_items;
$gutenberg_taxonomies_routes     = array();
$gutenberg_taxonomies_menu_items = array();
 ...
 */
function gutenberg_register_taxonomies_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_taxonomies_routes;
	...
	$gutenberg_taxonomies_routes[] = $route;
}
 ...
 */
function gutenberg_register_taxonomies_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_taxonomies_menu_items;
	...
	$gutenberg_taxonomies_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_taxonomies_routes() {
	global $gutenberg_taxonomies_routes;
	return $gutenberg_taxonomies_routes ?? array();
}
 ...
 */
function gutenberg_get_taxonomies_menu_items() {
	global $gutenberg_taxonomies_menu_items;
	return $gutenberg_taxonomies_menu_items ?? array();
}
 ...
 */
function gutenberg_taxonomies_preload_data() {
 ...
 */
function gutenberg_taxonomies_render_page() {
	...
	gutenberg_taxonomies_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_taxonomies_menu_items();
	$routes = gutenberg_get_taxonomies_routes();
 ...
 */
function gutenberg_taxonomies_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'taxonomies' === $_GET['page'] ) {
		gutenberg_taxonomies_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_taxonomies_intercept_render' );
