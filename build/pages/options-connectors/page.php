...
global $gutenberg_options_connectors_routes, $gutenberg_options_connectors_menu_items;
$gutenberg_options_connectors_routes     = array();
$gutenberg_options_connectors_menu_items = array();
 ...
 */
function gutenberg_register_options_connectors_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_options_connectors_routes;
	...
	$gutenberg_options_connectors_routes[] = $route;
}
 ...
 */
function gutenberg_register_options_connectors_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_options_connectors_menu_items;
	...
	$gutenberg_options_connectors_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_options_connectors_routes() {
	global $gutenberg_options_connectors_routes;
	return $gutenberg_options_connectors_routes ?? array();
}
 ...
 */
function gutenberg_get_options_connectors_menu_items() {
	global $gutenberg_options_connectors_menu_items;
	return $gutenberg_options_connectors_menu_items ?? array();
}
 ...
 */
function gutenberg_options_connectors_preload_data() {
 ...
 */
function gutenberg_options_connectors_render_page() {
	...
	gutenberg_options_connectors_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_options_connectors_menu_items();
	$routes = gutenberg_get_options_connectors_routes();
 ...
 */
function gutenberg_options_connectors_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'options-connectors' === $_GET['page'] ) {
		gutenberg_options_connectors_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_options_connectors_intercept_render' );
