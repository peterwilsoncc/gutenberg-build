"use strict";var wp;(wp||={}).autop=(()=>{var l=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var u=Object.getOwnPropertyNames;var b=Object.prototype.hasOwnProperty;var $=(e,r)=>{for(var n in r)l(e,n,{get:r[n],enumerable:!0})},w=(e,r,n,c)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of u(r))!b.call(e,i)&&i!==n&&l(e,i,{get:()=>r[i],enumerable:!(c=f(r,i))||c.enumerable});return e};var v=e=>w(l({},"__esModule",{value:!0}),e);var S={};$(S,{autop:()=>R,removep:()=>j});var k=(()=>{let e="!(?:-(?!->)[^\\-]*)*(?:-->)?",r="!\\[CDATA\\[[^\\]]*(?:](?!]>)[^\\]]*)*?(?:]]>)?",c="(<("+("(?=!--|!\\[CDATA\\[)((?=!-)"+e+"|"+r+")")+"|[^>]*>?))";return new RegExp(c)})();function O(e){let r=[],n=e,c;for(;c=n.match(k);){let i=c.index;r.push(n.slice(0,i)),r.push(c[0]),n=n.slice(i+c[0].length)}return n.length&&r.push(n),r}function E(e,r){let n=O(e),c=!1,i=Object.keys(r);for(let s=1;s<n.length;s+=2)for(let a=0;a<i.length;a++){let p=i[a];if(n[s].indexOf(p)!==-1){n[s]=n[s].replace(new RegExp(p,"g"),r[p]),c=!0;break}}return c&&(e=n.join("")),e}function R(e,r=!0){let n=[];if(e.trim()==="")return"";if(e=e+`
`,e.indexOf("<pre")!==-1){let s=e.split("</pre>"),a=s.pop();e="";for(let p=0;p<s.length;p++){let o=s[p],g=o.indexOf("<pre");if(g===-1){e+=o;continue}let d="<pre wp-pre-tag-"+p+"></pre>";n.push([d,o.substr(g)+"</pre>"]),e+=o.substr(0,g)+d}e+=a}e=e.replace(/<br\s*\/?>\s*<br\s*\/?>/g,`
