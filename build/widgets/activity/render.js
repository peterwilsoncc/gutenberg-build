...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React49 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef47 = React49.useRef, useEffect32 = React49.useEffect, useMemo41 = React49.useMemo, useDebugValue2 = React49.useDebugValue;
...
function Activity({ attributes }) {
  ...
  const [view, setView] = (0, import_element86.useState)(DEFAULT_VIEW);
  const queries = (0, import_element86.useMemo)(
    () => ({
      future: {
        status: "future",
        orderby: "date",
  ...
  const allEvents = (0, import_element86.useMemo)(() => {
    const events = [];
  ...
  const resolvedView = (0, import_element86.useMemo)(
    () => ({ ...view, perPage: perPage * SOURCE_COUNT }),
    [view, perPage]
  );
  const { data: shownData, paginationInfo } = (0, import_element86.useMemo)(
