 ...
 */
function gutenberg_block_core_navigation_get_layout_custom_property_declarations( $layout ) {
 ...
 */
function gutenberg_block_core_navigation_add_support_classes_to_container( $block_content, $block ) {
	...
	foreach ( $responsive_media_queries as $breakpoint => $media_query ) {
		...
		$styles[] = array(
			'declarations' => gutenberg_block_core_navigation_get_layout_custom_property_declarations(
...
add_filter( 'render_block', 'gutenberg_block_core_navigation_add_support_classes_to_container', 11, 2 );
