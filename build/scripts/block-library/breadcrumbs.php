...
function gutenberg_render_block_core_breadcrumbs( $attributes, $content, $block ) {
	...
	if ( is_search() ) {
		...
		$breadcrumb_items = gutenberg_block_core_breadcrumbs_maybe_add_paged( $breadcrumb_items );
	} elseif ( is_404() ) {
		// Handle 404 pages.
		$breadcrumb_items[] = sprintf(
			'<span aria-current="page">%s</span>',
 ...
 */
function gutenberg_block_core_breadcrumbs_maybe_add_paged( $breadcrumb_items ) {
