...
function gutenberg_render_block_core_breadcrumbs( $attributes, $content, $block ) {
	...
	if ( $is_home_or_front_page ) {
		...
		if ( ! $show_terms ) {
			$breadcrumb_items = array_merge( $breadcrumb_items, gutenberg_block_core_breadcrumbs_get_hierarchical_post_type_breadcrumbs( $post_id, $post_type ) );
		} else {
 ...
 */
function gutenberg_block_core_breadcrumbs_get_post_type_archive_item( $post_type ) {
 ...
 */
function gutenberg_block_core_breadcrumbs_get_hierarchical_post_type_breadcrumbs( $post_id, $post_type ) {
	$breadcrumb_items = array();

	$archive_item = gutenberg_block_core_breadcrumbs_get_post_type_archive_item( $post_type );
	if ( $archive_item ) {
