(function() {
"use strict";var wp;(wp||={}).richText=(()=>{var Ir=Object.create;var Tt=Object.defineProperty;var tn=Object.getOwnPropertyDescriptor;var en=Object.getOwnPropertyNames;var rn=Object.getPrototypeOf,nn=Object.prototype.hasOwnProperty;var W=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),jt=(e,t)=>{for(var r in t)Tt(e,r,{get:t[r],enumerable:!0})},oe=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of en(t))!nn.call(e,o)&&o!==r&&Tt(e,o,{get:()=>t[o],enumerable:!(n=tn(t,o))||n.enumerable});return e};var d=(e,t,r)=>(r=e!=null?Ir(rn(e)):{},oe(t||!e||!e.__esModule?Tt(r,"default",{value:e,enumerable:!0}):r,e)),on=e=>oe(Tt({},"__esModule",{value:!0}),e);var z=W((no,ie)=>{ie.exports=window.wp.data});var me=W((ho,fe)=>{fe.exports=window.wp.escapeHtml});var Oe=W((hi,Re)=>{Re.exports=window.wp.a11y});var _e=W((gi,Le)=>{Le.exports=window.wp.i18n});var He=W((Ti,ke)=>{ke.exports=window.wp.privateApis});var K=W((Ai,Ve)=>{Ve.exports=window.wp.element});var $=W((Ni,je)=>{je.exports=window.wp.compose});var Yt=W((Ci,Be)=>{Be.exports=window.wp.deprecated});var Dt=W((Ui,ar)=>{ar.exports=window.wp.keycodes});var Wr=W((Zs,qr)=>{qr.exports=window.wp.dom});var eo={};jt(eo,{RichTextData:()=>X,__experimentalRichText:()=>to,__unstableCreateElement:()=>G,__unstableToDom:()=>Jt,__unstableUseRichText:()=>Dr,applyFormat:()=>At,concat:()=>ye,create:()=>L,getActiveFormat:()=>ct,getActiveFormats:()=>Q,getActiveObject:()=>ve,getTextContent:()=>st,insert:()=>ft,insertObject:()=>Fe,isCollapsed:()=>et,isEmpty:()=>we,join:()=>Ee,privateApis:()=>re,registerFormatType:()=>xe,remove:()=>mt,removeFormat:()=>ut,replace:()=>Te,slice:()=>St,split:()=>Ae,store:()=>S,toHTMLString:()=>I,toggleFormat:()=>De,unregisterFormatType:()=>Me,useAnchor:()=>Jr,useAnchorRef:()=>Ur});var Ft=d(z(),1);var se=d(z(),1);function sn(e={},t){switch(t.type){case"ADD_FORMAT_TYPES":return{...e,...t.formatTypes.reduce((r,n)=>({...r,[n.name]:n}),{})};case"REMOVE_FORMAT_TYPES":return Object.fromEntries(Object.entries(e).filter(([r])=>!t.names.includes(r)))}return e}var ce=(0,se.combineReducers)({formatTypes:sn});var Kt={};jt(Kt,{getFormatType:()=>cn,getFormatTypeForBareElement:()=>an,getFormatTypeForClassName:()=>un,getFormatTypes:()=>Bt});var ae=d(z(),1),Bt=(0,ae.createSelector)(e=>Object.values(e.formatTypes),e=>[e.formatTypes]);function cn(e,t){return e.formatTypes[t]}function an(e,t){let r=Bt(e);return r.find(({className:n,tagName:o})=>n===null&&t===o)||r.find(({className:n,tagName:o})=>n===null&&o==="*")}function un(e,t){return Bt(e).find(({className:r})=>r===null?!1:` ${t} `.indexOf(` ${r} `)>=0)}var Ut={};jt(Ut,{addFormatTypes:()=>fn,removeFormatTypes:()=>mn});function fn(e){return{type:"ADD_FORMAT_TYPES",formatTypes:Array.isArray(e)?e:[e]}}function mn(e){return{type:"REMOVE_FORMAT_TYPES",names:Array.isArray(e)?e:[e]}}var ln="core/rich-text",S=(0,Ft.createReduxStore)(ln,{reducer:ce,selectors:Kt,actions:Ut});(0,Ft.register)(S);function nt(e,t){if(e===t)return!0;if(!e||!t||e.type!==t.type)return!1;let r=e.attributes,n=t.attributes;if((e.unregisteredAttributes||t.unregisteredAttributes)&&(r={...r,...e.unregisteredAttributes},n={...n,...t.unregisteredAttributes}),r===n)return!0;if(!r||!n)return!1;let o=Object.keys(r),i=Object.keys(n);if(o.length!==i.length)return!1;let c=o.length;for(let s=0;s<c;s++){let a=o[s];if(r[a]!==n[a])return!1}return!0}function H(e){let t=e.formats.slice();return t.forEach((r,n)=>{let o=t[n-1];if(o){let i=r.slice();i.forEach((c,s)=>{let a=o[s];nt(c,a)&&(i[s]=a)}),t[n]=i}}),{...e,formats:t}}function ue(e,t,r){return e=e.slice(),e[t]=r,e}function At(e,t,r=e.start,n=e.end){let{formats:o,activeFormats:i}=e,c=o.slice();if(r===n){let s=c[r]?.find(({type:a})=>a===t.type);if(s){let a=c[r].indexOf(s);for(;c[r]&&c[r][a]===s;)c[r]=ue(c[r],a,t),r--;for(n++;c[n]&&c[n][a]===s;)c[n]=ue(c[n],a,t),n++}}else{let s=1/0;for(let a=r;a<n;a++)if(c[a]){c[a]=c[a].filter(({type:f})=>f!==t.type);let u=c[a].length;u<s&&(s=u)}else c[a]=[],s=0;for(let a=r;a<n;a++)c[a].splice(s,0,t)}return H({...e,formats:c,activeFormats:[...i?.filter(({type:s})=>s!==t.type)||[],t]})}var Wt=d(z(),1);function G({implementation:e},t){return G.body||(G.body=e.createHTMLDocument("").body),G.body.innerHTML=t,G.body}var D="\uFFFC",gt="\uFEFF";var it=d(me(),1);function Q(e,t=[]){let{formats:r,start:n,end:o,activeFormats:i}=e;if(n===void 0)return t;if(n===o){if(i)return i;let u=r[n-1]||t,f=r[n]||t;return u.length<f.length?u:f}if(!r[n])return t;let c=r.slice(n,o),s=[...c[0]],a=c.length;for(;a--;){let u=c[a];if(!u)return t;let f=s.length;for(;f--;){let m=s[f];u.find(l=>nt(m,l))||s.splice(f,1)}if(s.length===0)return t}return s||t}var le=d(z(),1);function qt(e){return(0,le.select)(S).getFormatType(e)}function pe(e,t){if(t)return e;let r={};for(let n in e){let o=n;n.startsWith("data-disable-rich-text-")&&(o=n.slice(23)),r[o]=e[n]}return r}function Nt({type:e,tagName:t,attributes:r,unregisteredAttributes:n,object:o,boundaryClass:i,isEditableTree:c}){let s=qt(e),a={};if(i&&c&&(a["data-rich-text-format-boundary"]="true"),!s)return r&&(a={...r,...a}),{type:e,attributes:pe(a,c),object:o};a={...n,...a};for(let u in r){let f=s.attributes?s.attributes[u]:!1;f?a[f]=r[u]:a[u]=r[u]}return s.className&&(a.class?a.class=`${s.className} ${a.class}`:a.class=s.className),{type:t||s.tagName,object:s.object,attributes:pe(a,c)}}function pn(e,t,r){do if(e[r]!==t[r])return!1;while(r--);return!0}function Ct({value:e,preserveWhiteSpace:t,createEmpty:r,append:n,getLastChild:o,getParent:i,isText:c,getText:s,remove:a,appendText:u,onStartIndex:f,onEndIndex:m,isEditableTree:l,placeholder:v}){let{formats:A,replacements:b,text:E,start:y,end:w}=e,h=A.length+1,C=r(),x=Q(e),F=x[x.length-1],N,O;n(C,"");for(let T=0;T<h;T++){let g=E.charAt(T),_=l&&(!O||O===`
