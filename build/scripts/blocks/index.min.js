...
`)}var Fl=/^#[xX]([A-Fa-f0-9]+)$/,Hl=/^#([0-9]+)$/,Gl=/^([A-Za-z0-9]+)$/,Cf=(function(){function e(t){this.named=t}return e.prototype.parse=function(t){if(t){var r=t.match(Fl);if(r)return String.fromCharCode(parseInt(r[1],16));if(r=t.match(Hl),r)return String.fromCharCode(parseInt(r[1],10));if(r=t.match(Gl),r)return this.named[r[1]]}},e})(),Kl=/[\t\n\f ]/,Wl=/[A-Za-z]/,Yl=/\r\n?/g;function le(e){return Kl.test(e)}function Ri(e){return Wl.test(e)}function Zl(e){return e.replace(Yl,`
...
`,e=e.substring(d.length+1),c=!0),!c){let w=this.rules.other.nextBulletRegex(f),R=this.rules.other.hrRegex(f),Ye=this.rules.other.fencesBeginRegex(f),vn=this.rules.other.headingBeginRegex(f),ca=this.rules.other.htmlBeginRegex(f),ua=this.rules.other.blockquoteBeginRegex(f);for(;e;){let Jt=e.split(`
...
`)===-1)return(0,me.removeInvalidHTML)(Pe(l[0]),a,!1).replace(u,"")}return l}function ta(e){return(0,Js.default)("wp.blocks.getPhrasingContentSchema",{since:"5.6",alternative:"wp.dom.getPhrasingContentSchema"}),(0,ea.getPhrasingContentSchema)(e)}function kn({HTML:e=""}){if(e.indexOf("<!-- wp:")!==-1){let n=xe(e);if(!(n.length===1&&n[0].name==="core/freeform"))return n}let t=$t(e),r=jt();return t.map(n=>{if(typeof n!="string")return n;let o=[zt,It,Vt,Mt({raw:!0})];return n=G(n,o,r),n=oe(n,{raw:!0}),Pt(n,kn)}).flat().filter(Boolean)}var We=h(se(),1);function ra(){return(0,We.select)(m).getCategories()}function na(e){(0,We.dispatch)(m).setCategories(e)}function oa(e,t){(0,We.dispatch)(m).updateCategory(e,t)}var ia=h(Ce(),1);function yn(e=[],t=[]){return e.length===t.length&&t.every(([r,,n],o)=>{let i=e[o];return r===i.name&&yn(i.innerBlocks,n)})}var Fu=e=>e?.source==="html",Hu=e=>e?.source==="query";function sa(e,t){return t?Object.fromEntries(Object.entries(t).map(([r,n])=>[r,Gu(e[r],n)])):{}}function Gu(e,t){return Fu(e)&&Array.isArray(t)?(0,ia.renderToString)(t):Hu(e)&&t?t.map(r=>sa(e.query,r)):t}function Qt(e=[],t){return t?t.map(([r,n,o],i)=>{let s=e[i];if(s&&s.name===r){let p=Qt(s.innerBlocks,o);return{...s,innerBlocks:p}}let a=x(r),c=sa(a?.attributes??{},n),[l,u]=Ct(r,c);return S(l,u,Qt([],o))}):e}var Ku=Symbol("fields"),Wu=Symbol("form"),Yu=Symbol("editableRoot"),aa={};Qn(aa,{isContentBlock:Co,fieldsKey:Ku,formKey:Wu,editableRootKey:Yu,parseRawBlock:Dt});var la=h(L(),1);function Zu(e){return(0,la.default)("wp.blocks.withBlockContentContext",{since:"6.1"}),e}return ga(Xu);})();
