...
`,m}}),t.subParser("hashHTMLBlocks",function(n,i,a){"use strict";n=a.converter._dispatch("hashHTMLBlocks.before",n,i,a);var d=["pre","div","h1","h2","h3","h4","h5","h6","blockquote","table","dl","ol","ul","script","noscript","form","fieldset","iframe","math","style","section","header","footer","nav","article","aside","address","audio","canvas","figure","hgroup","output","video","p"],p=function(c,y,C,A){var M=c;return C.search(/\bmarkdown\b/)!==-1&&(M=C+a.converter.makeHtml(y)+A),`
...
`+t+`
<!-- /wp:${u} -->`:`<!-- wp:${u} ${o}/-->`}function ps(e,{isInnerBlocks:r=!1}={}){if(!e.isValid&&e.__unstableBlockSource)return we(e.__unstableBlockSource);let t=e.name,o=Ye(e);if(t===me()||!r&&t===re())return o;let u=z(t);if(!u)return o;let s=ls(u,e.attributes);return Vt(t,s,o)}function ha(e){e.length===1&&mr(e[0])&&(e=[]);let r=Dr(e);return e.length===1&&e[0].name===re()&&e[0].name==="core/freeform"&&(r=(0,da.removep)(r)),r}function Dr(e,r){return(Array.isArray(e)?e:[e]).map(o=>ps(o,r)).join(`
