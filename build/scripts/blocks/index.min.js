...
`?(this.line++,this.column=0):this.column++,t},e.prototype.consumeCharRef=function(){var t=this.input.indexOf(";",this.index);if(t!==-1){var r=this.input.slice(this.index,t),a=this.entityParser.parse(r);if(a){for(var o=r.length;o;)this.consume(),o--;return this.consume(),a}}},e.prototype.markTagStart=function(){this.delegate.tagOpen()},e.prototype.appendToTagName=function(t){this.tagNameBuffer+=t,this.delegate.appendToTagName(t)},e})(),go=(function(){function e(t,r){r===void 0&&(r={}),this.options=r,this.token=null,this.startLine=1,this.startColumn=0,this.tokens=[],this.tokenizer=new vs(this,t),this._currentAttribute=void 0}return e.prototype.tokenize=function(t){return this.tokens=[],this.tokenizer.tokenize(t),this.tokens},e.prototype.tokenizePart=function(t){return this.tokens=[],this.tokenizer.tokenizePart(t),this.tokens},e.prototype.tokenizeEOF=function(){return this.tokens=[],this.tokenizer.tokenizeEOF(),this.tokens[0]},e.prototype.reset=function(){this.token=null,this.startLine=1,this.startColumn=0},e.prototype.current=function(){var t=this.token;if(t===null)throw new Error("token was unexpectedly null");if(arguments.length===0)return t;for(var r=0;r<arguments.length;r++)if(t.type===arguments[r])return t;throw new Error("token type was unexpectedly "+t.type)},e.prototype.push=function(t){this.token=t,this.tokens.push(t)},e.prototype.currentAttribute=function(){return this._currentAttribute},e.prototype.addLocInfo=function(){this.options.loc&&(this.current().loc={start:{line:this.startLine,column:this.startColumn},end:{line:this.tokenizer.line,column:this.tokenizer.column}}),this.startLine=this.tokenizer.line,this.startColumn=this.tokenizer.column},e.prototype.beginData=function(){this.push({type:"Chars",chars:""})},e.prototype.appendToData=function(t){this.current("Chars").chars+=t},e.prototype.finishData=function(){this.addLocInfo()},e.prototype.beginComment=function(){this.push({type:"Comment",chars:""})},e.prototype.appendToCommentData=function(t){this.current("Comment").chars+=t},e.prototype.finishComment=function(){this.addLocInfo()},e.prototype.tagOpen=function(){},e.prototype.beginStartTag=function(){this.push({type:"StartTag",tagName:"",attributes:[],selfClosing:!1})},e.prototype.beginEndTag=function(){this.push({type:"EndTag",tagName:""})},e.prototype.finishTag=function(){this.addLocInfo()},e.prototype.markTagAsSelfClosing=function(){this.current("StartTag").selfClosing=!0},e.prototype.appendToTagName=function(t){this.current("StartTag","EndTag").tagName+=t},e.prototype.beginAttribute=function(){this._currentAttribute=["","",!1]},e.prototype.appendToAttributeName=function(t){this.currentAttribute()[0]+=t},e.prototype.beginAttributeValue=function(t){this.currentAttribute()[2]=t},e.prototype.appendToAttributeValue=function(t){this.currentAttribute()[1]+=t},e.prototype.finishAttributeValue=function(){this.current("StartTag").attributes.push(this._currentAttribute)},e.prototype.reportSyntaxError=function(t){this.current().syntaxError=t},e})();var Co=B(_o()),Bo=B(ee()),Ao=B(wo());function Ne(){function e(t){return(r,...a)=>t("Block validation: "+r,...a)}return{error:e(console.error),warning:e(console.warn),getItems(){return[]}}}function ko(){let e=[],t=Ne();return{error(...r){e.push({log:t.error,args:r})},warning(...r){e.push({log:t.warning,args:r})},getItems(){return e}}}var Es=e=>e,Ts=/[\t\n\r\v\f ]+/g,Cs=/^[\t\n\r\v\f ]*$/,Bs=/^url\s*\(['"\s]*(.*?)['"\s]*\)$/,So=["allowfullscreen","allowpaymentrequest","allowusermedia","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected","typemustmatch"],As=["autocapitalize","autocomplete","charset","contenteditable","crossorigin","decoding","dir","draggable","enctype","formenctype","formmethod","http-equiv","inputmode","kind","method","preload","scope","shape","spellcheck","translate","type","wrap"],Ss=[...So,...As],vo=[Es,Ds],Ns=/^[\da-z]+$/i,Ls=/^#\d+$/,Ps=/^#x[\da-f]+$/i;function Os(e){return Ns.test(e)||Ls.test(e)||Ps.test(e)}var Rs=class{parse(e){if(Os(e))return(0,Ao.decodeEntities)("&"+e+";")}};function $t(e){return e.trim().split(Ts)}function Ds(e){return $t(e).join(" ")}function Ms(e){return e.attributes.filter(t=>{let[r,a]=t;return a||r.indexOf("data-")===0||Ss.includes(r)})}function Eo(e,t,r=Ne()){let a=e.chars,o=t.chars;for(let s=0;s<vo.length;s++){let l=vo[s];if(a=l(a),o=l(o),a===o)return!0}return r.warning("Expected text `%s`, saw `%s`.",t.chars,e.chars),!1}function js(e){return parseFloat(e)===0?"0":e.indexOf(".")===0?"0"+e:e}function zs(e){return $t(e).map(js).join(" ").replace(Bs,"url($1)")}function qs(e){let t=e.replace(/;?\s*$/,"").split(";").map(r=>{let[a,...o]=r.split(":"),s=o.join(":");return[a.trim(),zs(s.trim())]});return Object.fromEntries(t)}var Is={class:(e,t)=>{let[r,a]=[e,t].map($t),o=r.filter(l=>!a.includes(l)),s=a.filter(l=>!r.includes(l));return o.length===0&&s.length===0},style:(e,t)=>(0,Co.default)(...[e,t].map(qs)),...Object.fromEntries(So.map(e=>[e,()=>!0]))};function Vs(e,t,r=Ne()){if(e.length!==t.length)return r.warning("Expected attributes %o, instead saw %o.",t,e),!1;let a={};for(let o=0;o<t.length;o++)a[t[o][0].toLowerCase()]=t[o][1];for(let o=0;o<e.length;o++){let[s,l]=e[o],h=s.toLowerCase();if(!a.hasOwnProperty(h))return r.warning("Encountered unexpected attribute `%s`.",s),!1;let _=a[h],b=Is[h];if(b){if(!b(l,_))return r.warning("Expected attribute `%s` of value `%s`, saw `%s`.",s,_,l),!1}else if(l!==_)return r.warning("Expected attribute `%s` of value `%s`, saw `%s`.",s,_,l),!1}return!0}var xs={StartTag:(e,t,r=Ne())=>e.tagName!==t.tagName&&e.tagName.toLowerCase()!==t.tagName.toLowerCase()?(r.warning("Expected tag name `%s`, instead saw `%s`.",t.tagName,e.tagName),!1):Vs(...[e,t].map(Ms),r),Chars:Eo,Comment:Eo};function Ze(e){let t;for(;t=e.shift();)if(t.type!=="Chars"||!Cs.test(t.chars))return t}function Hs(e,t=Ne()){try{return new go(new Rs).tokenize(e)}catch{t.warning("Malformed HTML detected: %s",e)}return null}function To(e,t){return e.selfClosing?!!(t&&t.tagName===e.tagName&&t.type==="EndTag"):!1}function Us(e,t,r=Ne()){if(e===t)return!0;let[a,o]=[e,t].map(h=>Hs(h,r));if(!a||!o)return!1;let s,l;for(;s=Ze(a);){if(l=Ze(o),!l)return r.warning("Expected end of content, instead saw %o.",s),!1;if(s.type!==l.type)return r.warning("Expected token of type `%s` (%o), instead saw `%s` (%o).",l.type,l,s.type,s),!1;let h=xs[s.type];if(h&&!h(s,l,r))return!1;To(s,o[0])?Ze(o):To(l,a[0])&&Ze(a)}return(l=Ze(o))?(r.warning("Expected %o, instead saw end of content.",l),!1):!0}function be(e,t=e.name){if(e.name===re()||e.name===me())return[!0,[]];let a=ko(),o=de(t),s;try{s=ge(o,e.attributes)}catch(h){return a.error(`Block validation failed because an error occurred while generating block content:

%s`,h.toString()),[!1,a.getItems()]}let l=Us(e.originalContent,s,a);return l||a.error(`Block validation failed for \`%s\` (%o).
...
`)===-1&&t.indexOf("<p>")!==0&&e.indexOf("<p>")===0&&(r="INLINE"),r==="INLINE"||r==="AUTO"&&!l&&iu(e,a))return Tu(e);let h=(0,Oe.getPhrasingContentSchema)("paste"),_=Yr("paste"),b=s.map(E=>{if(typeof E!="string")return E;let L=[nn,su,rn,$r,fu,en,Fr,Jt,_u,Kr,Gr(),pu,Eu],N={..._,...h};return E=le(E,L,_),E=(0,Oe.removeInvalidHTML)(E,N),E=Te(E),E=le(E,[an,on,wu],_),Cu(`Processed HTML piece:
...
`)===-1)return(0,Oe.removeInvalidHTML)(Xe(b[0]),h).replace(E,"")}return b}function Su(e){return(0,Bu.default)("wp.blocks.getPhrasingContentSchema",{since:"5.6",alternative:"wp.dom.getPhrasingContentSchema"}),(0,Au.getPhrasingContentSchema)(e)}function un({HTML:e=""}){if(e.indexOf("<!-- wp:")!==-1){let a=Ee(e);if(!(a.length===1&&a[0].name==="core/freeform"))return a}let t=Wr(e),r=Yr();return t.map(a=>{if(typeof a!="string")return a;let o=[$r,Fr,Kr,Gr({raw:!0})];return a=le(a,o,r),a=Te(a,{raw:!0}),Ur(a,un)}).flat().filter(Boolean)}var or=B(Be());function Nu(){return(0,or.select)(P).getCategories()}function Lu(e){(0,or.dispatch)(P).setCategories(e)}function Pu(e,t){(0,or.dispatch)(P).updateCategory(e,t)}var Ou=B(De());function sn(e=[],t=[]){return e.length===t.length&&t.every(([r,,a],o)=>{let s=e[o];return r===s.name&&sn(s.innerBlocks,a)})}var Cd=e=>e?.source==="html",Bd=e=>e?.source==="query";function Ru(e,t){return t?Object.fromEntries(Object.entries(t).map(([r,a])=>[r,Ad(e[r],a)])):{}}function Ad(e,t){return Cd(e)&&Array.isArray(t)?(0,Ou.renderToString)(t):Bd(e)&&t?t.map(r=>Ru(e.query,r)):t}function Jr(e=[],t){return t?t.map(([r,a,o],s)=>{let l=e[s];if(l&&l.name===r){let L=Jr(l.innerBlocks,o);return{...l,innerBlocks:L}}let h=M(r),_=Ru(h?.attributes??{},a),[b,E]=jr(r,_);return U(b,E,Jr([],o))}):e}var Sd=Symbol("fields"),Nd=Symbol("form"),Du={};Hn(Du,{isContentBlock:ga,fieldsKey:Sd,formKey:Nd});var Mu=B(ee());function Ld(e){return(0,Mu.default)("wp.blocks.withBlockContentContext",{since:"6.1"}),e}return Hu(Pd);})();
