...
`+r+`
<!-- /wp:${o} -->`:`<!-- wp:${o} ${a}/-->`}function ms(e,{isInnerBlocks:t=!1}={}){if(!e.isValid&&e.__unstableBlockSource)return we(e.__unstableBlockSource);let r=e.name,a=Xe(e);if(r===me()||!t&&r===ee())return a;let o=M(r);if(!o)return a;let s=fs(o,e.attributes);return Ft(r,s,a)}function bo(e){e.length===1&&hr(e[0])&&(e=[]);let t=Mr(e);return e.length===1&&e[0].name===ee()&&e[0].name==="core/freeform"&&(t=(0,co.removep)(t)),t}function Mr(e,t){return(Array.isArray(e)?e:[e]).map(a=>ms(a,t)).join(`
