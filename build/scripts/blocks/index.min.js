...
`)}var Ul=/^#[xX]([A-Fa-f0-9]+)$/,Fl=/^#([0-9]+)$/,Hl=/^([A-Za-z0-9]+)$/,Sf=(function(){function e(t){this.named=t}return e.prototype.parse=function(t){if(t){var r=t.match(Ul);if(r)return String.fromCharCode(parseInt(r[1],16));if(r=t.match(Fl),r)return String.fromCharCode(parseInt(r[1],10));if(r=t.match(Hl),r)return this.named[r[1]]}},e})(),Gl=/[\t\n\f ]/,Kl=/[A-Za-z]/,Wl=/\r\n?/g;function le(e){return Gl.test(e)}function Ri(e){return Kl.test(e)}function Yl(e){return e.replace(Wl,`
