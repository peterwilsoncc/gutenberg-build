...
`+r+`
<!-- /wp:${u} -->`:`<!-- wp:${u} ${a}/-->`}function fs(e,{isInnerBlocks:t=!1}={}){if(!e.isValid&&e.__unstableBlockSource)return we(e.__unstableBlockSource);let r=e.name,a=Ye(e);if(r===me()||!t&&r===ee())return a;let u=M(r);if(!u)return a;let s=cs(u,e.attributes);return Vt(r,s,a)}function mo(e){e.length===1&&mr(e[0])&&(e=[]);let t=Dr(e);return e.length===1&&e[0].name===ee()&&e[0].name==="core/freeform"&&(t=(0,uo.removep)(t)),t}function Dr(e,t){return(Array.isArray(e)?e:[e]).map(a=>fs(a,t)).join(`
