...
`,m}}),r.subParser("hashHTMLBlocks",function(n,i,o){"use strict";n=o.converter._dispatch("hashHTMLBlocks.before",n,i,o);var d=["pre","div","h1","h2","h3","h4","h5","h6","blockquote","table","dl","ol","ul","script","noscript","form","fieldset","iframe","math","style","section","header","footer","nav","article","aside","address","audio","canvas","figure","hgroup","output","video","p"],p=function(c,w,C,A){var R=c;return C.search(/\bmarkdown\b/)!==-1&&(R=C+o.converter.makeHtml(w)+A),`

\xA8K`+(o.gHtmlBlocks.push(R)-1)+`K

`};i.backslashEscapesHTMLTags&&(n=n.replace(/\\<(\/?[^>]+?)>/g,function(c,w){return"&lt;"+w+"&gt;"}));for(var m=0;m<d.length;++m)for(var f,g=new RegExp("^ {0,3}(<"+d[m]+"\\b[^>]*>)","im"),T="<"+d[m]+"\\b[^>]*>",k="</"+d[m]+">";(f=r.helper.regexIndexOf(n,g))!==-1;){var y=r.helper.splitAtIndex(n,f),v=r.helper.replaceRecursiveRegExp(y[1],p,T,k,"im");if(v===y[1])break;n=y[0].concat(v)}return n=n.replace(/(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,r.subParser("hashElement")(n,i,o)),n=r.helper.replaceRecursiveRegExp(n,function(c){return`
...
`)):n=n.replace(/  +\n/g,`<br />
`),n=o.converter._dispatch("spanGamut.after",n,i,o),n}),r.subParser("strikethrough",function(n,i,o){"use strict";function d(p){return i.simplifiedAutoLink&&(p=r.subParser("simplifiedAutoLinks")(p,i,o)),"<del>"+p+"</del>"}return i.strikethrough&&(n=o.converter._dispatch("strikethrough.before",n,i,o),n=n.replace(/(?:~){2}([\s\S]+?)(?:~){2}/g,function(p,m){return d(m)}),n=o.converter._dispatch("strikethrough.after",n,i,o)),n}),r.subParser("stripLinkDefinitions",function(n,i,o){"use strict";var d=/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?([^>\s]+)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n+|(?=¨0))/gm,p=/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?(data:.+?\/.+?;base64,[A-Za-z0-9+/=\n]+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n\n|(?=¨0)|(?=\n\[))/gm;n+="\xA80";var m=function(f,g,T,k,y,v,c){return g=g.toLowerCase(),T.match(/^data:.+?\/.+?;base64,/)?o.gUrls[g]=T.replace(/\s/g,""):o.gUrls[g]=r.subParser("encodeAmpsAndAngles")(T,i,o),v?v+c:(c&&(o.gTitles[g]=c.replace(/"|'/g,"&quot;")),i.parseImgDimensions&&k&&y&&(o.gDimensions[g]={width:k,height:y}),"")};return n=n.replace(p,m),n=n.replace(d,m),n=n.replace(/¨0/,""),n}),r.subParser("tables",function(n,i,o){"use strict";if(!i.tables)return n;var d=/^ {0,3}\|?.+\|.+\n {0,3}\|?[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:[-=]){2,}[\s\S]+?(?:\n\n|¨0)/gm,p=/^ {0,3}\|.+\|[ \t]*\n {0,3}\|[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*\n( {0,3}\|.+\|[ \t]*\n)*(?:\n|¨0)/gm;function m(y){return/^:[ \t]*--*$/.test(y)?' style="text-align:left;"':/^--*[ \t]*:[ \t]*$/.test(y)?' style="text-align:right;"':/^:[ \t]*--*[ \t]*:$/.test(y)?' style="text-align:center;"':""}function f(y,v){var c="";return y=y.trim(),(i.tablesHeaderId||i.tableHeaderId)&&(c=' id="'+y.replace(/ /g,"_").toLowerCase()+'"'),y=r.subParser("spanGamut")(y,i,o),"<th"+c+v+">"+y+`</th>
`}function g(y,v){var c=r.subParser("spanGamut")(y,i,o);return"<td"+v+">"+c+`</td>
...
`+r+`
<!-- /wp:${u} -->`:`<!-- wp:${u} ${a}/-->`}function fs(e,{isInnerBlocks:t=!1}={}){if(!e.isValid&&e.__unstableBlockSource)return ye(e.__unstableBlockSource);let r=e.name,a=Ye(e);if(r===me()||!t&&r===ee())return a;let u=M(r);if(!u)return a;let s=cs(u,e.attributes);return Vt(r,s,a)}function mo(e){e.length===1&&mr(e[0])&&(e=[]);let t=Dr(e);return e.length===1&&e[0].name===ee()&&e[0].name==="core/freeform"&&(t=(0,uo.removep)(t)),t}function Dr(e,t){return(Array.isArray(e)?e:[e]).map(a=>fs(a,t)).join(`

`)}var ps=/^#[xX]([A-Fa-f0-9]+)$/,ms=/^#([0-9]+)$/,hs=/^([A-Za-z0-9]+)$/,al=(function(){function e(t){this.named=t}return e.prototype.parse=function(t){if(t){var r=t.match(ps);if(r)return String.fromCharCode(parseInt(r[1],16));if(r=t.match(ms),r)return String.fromCharCode(parseInt(r[1],10));if(r=t.match(hs),r)return this.named[r[1]]}},e})(),gs=/[\t\n\f ]/,bs=/[A-Za-z]/,_s=/\r\n?/g;function Se(e){return gs.test(e)}function ho(e){return bs.test(e)}function ws(e){return e.replace(_s,`
`)}var ys=(function(){function e(t,r){this.delegate=t,this.entityParser=r,this.state="beforeData",this.line=-1,this.column=-1,this.input="",this.index=-1,this.tagNameBuffer="",this.states={beforeData:function(){var a=this.peek();if(a==="<")this.transitionTo("tagOpen"),this.markTagStart(),this.consume();else{if(a===`
...
`)===-1&&t.indexOf("<p>")!==0&&e.indexOf("<p>")===0&&(r="INLINE"),r==="INLINE"||r==="AUTO"&&!l&&iu(e,a))return Eu(e);let h=(0,Oe.getPhrasingContentSchema)("paste"),_=Wr("paste"),b=s.map(E=>{if(typeof E!="string")return E;let L=[tn,su,en,Fr,fu,Jt,Ur,Qt,_u,Gr,$r(),pu],N={..._,...h};return E=le(E,L,_),E=(0,Oe.removeInvalidHTML)(E,N),E=Te(E),E=le(E,[nn,an,yu],_),Tu(`Processed HTML piece:
