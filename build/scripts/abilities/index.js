...
(wp ||= {}).abilities = (() => {
  ...
  // packages/abilities/build-module/index.js
  var index_exports = {};
  __export(index_exports, {
    executeAbility: () => executeAbility,
    getAbilities: () => getAbilities3,
    getAbility: () => getAbility3,
    getAbilityCategories: () => getAbilityCategories3,
    getAbilityCategory: () => getAbilityCategory3,
    registerAbility: () => registerAbility2,
    registerAbilityCategory: () => registerAbilityCategory2,
    store: () => store,
    unregisterAbility: () => unregisterAbility2,
    unregisterAbilityCategory: () => unregisterAbilityCategory2,
