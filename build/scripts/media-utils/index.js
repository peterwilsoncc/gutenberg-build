...
(wp ||= {}).mediaUtils = (() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(import_components5.__experimentalHStack, { spacing: 3, justify: "flex-start", children: [
      mediaField && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
        ItemClickWrapper,
        {
          ...
          "aria-label": titleField ? (0, import_i18n12.sprintf)(
            // translators: %s is the item title.
            (0, import_i18n12.__)("Click item: %s"),
  ...
  function useIsHorizontalScrollEnd({
    ...
    const handleIsHorizontalScrollEnd = (0, import_compose2.useDebounce)(
  ...
  function GridItem({
    ...
    const id = getItemId(item);
    const instanceId = (0, import_compose3.useInstanceId)(GridItem);
  ...
  function GridGroup({
    ...
    const headerId = (0, import_compose5.useInstanceId)(
      GridGroup,
...
`
  ...
  function ListBox({ view, filter, onChangeView }) {
    const baseId = (0, import_compose6.useInstanceId)(ListBox, "dataviews-filter-list-box");
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)("div", { className: "dataviews-filters__search-widget-filter-combobox__wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
              ComboboxLabel,
              {
                render: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_components14.VisuallyHidden, { children: (0, import_i18n23.__)("Search items") }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(
            ComboboxList,
            {
              ...
              children: [
                ...
                !matches.length && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)("p", { children: (0, import_i18n23.__)("No results found") })
              ]
            }
          )
        ]
  ...
  function InputWidget({
    ...
    const handleChange = (0, import_compose7.useEvent)((updatedData) => {
  ...
  var DataViewsSearch = (0, import_element27.memo)(function Search({ label }) {
    ...
    const [search, setSearch, debouncedSearch] = (0, import_compose8.useDebouncedInput)(
      view.search
    );
  ...
  function DataviewsViewConfigDropdown() {
    ...
    const popoverId = (0, import_compose9.useInstanceId)(
  ...
  function DataViewsPicker({
    ...
    const resizeObserverRef = (0, import_compose10.useResizeObserver)(
    ...
    (0, import_element45.useEffect)(() => {
      ...
      const handleScroll = (0, import_compose10.throttle)((event) => {
        const target = event.target;
