...
(wp ||= {}).uploadMedia = (() => {
  ...
  // packages/upload-media/node_modules/uuid/dist/stringify.js
  var byteToHex = [];
  for (let i = 0; i < 256; ++i) {
  ...
  // packages/upload-media/node_modules/uuid/dist/rng.js
  var rnds8 = new Uint8Array(16);
  function rng() {
    return crypto.getRandomValues(rnds8);
  }

  // packages/upload-media/node_modules/uuid/dist/v4.js
