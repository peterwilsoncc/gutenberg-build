 ...
 */
function gutenberg_render_block_core_comments_pagination_next( $attributes, $content, $block ) {
...
function gutenberg_register_block_core_comments_pagination_next() {
	register_block_type_from_metadata(
		...
		array(
			'render_callback' => 'gutenberg_render_block_core_comments_pagination_next',
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_comments_pagination_next', 20 );
