...
function gutenberg_render_block_core_search( $attributes ) {
	...
	$color_classes       = gutenberg_get_color_classes_for_block_core_search( $attributes );
	$typography_classes  = gutenberg_get_typography_classes_for_block_core_search( $attributes );
	$is_button_inside    = ! empty( $attributes['buttonPosition'] ) &&
		'button-inside' === $attributes['buttonPosition'];
	// Border color classes need to be applied to the elements that have a border color.
	$border_color_classes = gutenberg_get_border_color_classes_for_block_core_search( $attributes );
 ...
 */
function gutenberg_apply_block_core_search_border_style( $attributes, $property, $side, &$wrapper_styles, &$button_styles, &$input_styles ) {
...
function gutenberg_apply_block_core_search_border_styles( $attributes, $property, &$wrapper_styles, &$button_styles, &$input_styles ) {
	...
	gutenberg_apply_block_core_search_border_style( $attributes, $property, 'bottom', $wrapper_styles, $button_styles, $input_styles );
	gutenberg_apply_block_core_search_border_style( $attributes, $property, 'left', $wrapper_styles, $button_styles, $input_styles );
}
...
function gutenberg_styles_for_block_core_search( $attributes ) {
	...
	$typography_styles = esc_attr( get_typography_gutenberg_styles_for_block_core_search( $attributes ) );
 ...
 */
function gutenberg_get_typography_classes_for_block_core_search( $attributes ) {
 ...
 */
function get_typography_gutenberg_styles_for_block_core_search( $attributes ) {
 ...
 */
function gutenberg_get_border_color_classes_for_block_core_search( $attributes ) {
 ...
 */
function gutenberg_get_color_classes_for_block_core_search( $attributes ) {
	$classnames = array();
