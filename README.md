...
* Branch: `release/22.6`
* Commit: [WordPress/Gutenberg@`ae22a41cd6c`](https://github.com/WordPress/gutenberg/commit/ae22a41cd6cbb27fc2acebfa6175c68d0adea3de), [Browse files](https://github.com/WordPress/gutenberg/tree/ae22a41cd6cbb27fc2acebfa6175c68d0adea3de)

> [!NOTE]
> This readme file has replaced the original version included in the upstream repository.
>
> The [original `README.md` file](https://github.com/WordPress/gutenberg/blob/ae22a41cd6cbb27fc2acebfa6175c68d0adea3de/README.md) file for this commit can be found in the upstream repository.
