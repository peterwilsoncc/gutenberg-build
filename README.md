...
* Branch: `trunk`
* Commit: [WordPress/Gutenberg@`f6e389d3a1c`](https://github.com/WordPress/gutenberg/commit/f6e389d3a1c767de69d13028f91f87ec672073d8), [Browse files](https://github.com/WordPress/gutenberg/tree/f6e389d3a1c767de69d13028f91f87ec672073d8)

> [!NOTE]
> This readme file has replaced the original version included in the upstream repository.
>
> The [original `README.md` file](https://github.com/WordPress/gutenberg/blob/f6e389d3a1c767de69d13028f91f87ec672073d8/README.md) file for this commit can be found in the upstream repository.
